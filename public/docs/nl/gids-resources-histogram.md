...
De concept-rij staat onderaan de tabel, precies waar de nieuwe resource ook komt te staan, en is meteen *volledig* bewerkbaar: type, max. eenheden, kalender, tarief, eenheid en ploeg zijn allemaal gewone besturingselementen. Vul ze in de volgorde in die jou uitkomt — kies gerust eerst het type en typ daarna pas de naam. Met **Tab** loop je door de rij zonder dat er al iets wordt opgeslagen.

De rij bestaat om één reden: een resource ontstaat pas zodra er een **naam** staat, zodat een knopdruk zonder invoer geen lege rij achterlaat. Zonder naam wegklikken of op **Escape** drukken laat dus niets achter — geen resource, geen stap in de ongedaan-maken-geschiedenis, en je project geldt niet als gewijzigd; ook niet als je onderweg een keuzelijst hebt verzet. Staat er wél een naam, dan wordt de rij vastgelegd zodra je hem verlaat (elders klikken, of met Tab voorbij de laatste kolom) of op **Enter** drukt — in één keer, met alles wat je hebt ingevuld, en als één stap die je met één keer ongedaan maken weer terugdraait. **Enter** opent er bovendien meteen een verse concept-rij onder, zodat je een hele lijst achter elkaar kunt intypen.
