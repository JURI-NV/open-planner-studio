...
| **Gantt Charts for Structure PPM** (bekend als **Structure.Gantt**) | **Tempo Software** (oorspronkelijk ALM Works; overgenomen door Tempo) | Gantt-uitbreiding *bovenop* de app **Structure**; los onbruikbaar | **6.540** (Structure zelf: **13.272**) |
| **WBS Gantt-Chart for Jira** | **Ricksoft, Inc.** (Tokio, Japan) | MS Project-achtige WBS + Gantt in Jira | **5.710** |
...
**Plafonds:** het veld `chargeElements.user.ceiling` in de commerce-payload staat op **20.000** voor Standard en Premium en **50.000** voor Enterprise. *Nuance (toegevoegd na verificatie):* de gepubliceerde jaarstaffels lopen feitelijk door tot **100.000 gebruikers** voor alle drie de plannen (Standard $3.013.000/jr, Premium $5.910.000/jr, Enterprise $9.078.000/jr bij 100.000). De `ceiling`-waarde is dus vermoedelijk de self-service-grens, niet een absolute productgrens — boven die grens loopt het via sales. Behandel "20.000/50.000" daarom als indicatief, niet als hard plafond.
...
**Edities:** sinds **24 juli 2026** (dus letterlijk vorige week) bestaat BigPicture voor Jira Cloud in twee plannen: **Standard** (PPM: portfolio, tijdlijn, resources/capaciteit, dependencies, risico's) en **Advanced** (+ Financials, OKR, Priorities-module met ICE/RICE/WSJF/Eisenhower/Balanced Scorecard, geavanceerde rapportage). Bestaande klanten blijven automatisch op Standard ("No features were removed from the Standard plan in favor of the Advanced plan"). De oude **BigPicture Enterprise**-editie wordt gemigreerd naar Advanced en is volgens Appfire "planned to be sunset in 2027"; Enterprise en Advanced hebben op dit moment featurepariteit. De hierboven getoonde prijzen zijn de gepubliceerde Marketplace-prijzen; **[SCHATTING]** de Advanced-editie wordt hoger geprijsd, maar Appfire had op 25-07-2026 nog geen aparte Advanced-prijstabel via de Marketplace-API gepubliceerd.
...
| 1.000 gebruikers, Structure + Gantt (**Data Center, 1.000-staffel**) | offerte | $20.036 + $5.520 | **$25.556 + Jira** | — |
| Onbeperkt aantal gebruikers, Structure + Gantt (**DC Unlimited-staffel**) | offerte | $138.319 + $46.776 | **$185.095 + Jira** | — |
...
- Marktplaats-apps: BigPicture 11.235 installs / 654.233 downloads · Structure 13.272 installs / 327.409 downloads · Structure.Gantt 6.540 / 96.423 downloads · WBS Gantt-Chart 5.710 / 67.834 downloads (Marketplace REST API, hergeverifieerd 25-07-2026; installcijfers schommelen dagelijks).
...
Adversariële fact-check, uitgevoerd 25-07-2026. Elke bewering hieronder is actief geprobeerd te **weerleggen** met een onafhankelijke ophaling van de primaire bron (rauwe commerce-payload van atlassian.com, Marketplace REST API, Confluence REST API van Appfire, Atlassian's publieke issue tracker, Tempo-documentatie). Oordeel per bewering: **bevestigd** / **gecorrigeerd** / **onzeker**.

### Prijzen en licentiemodel

| # | Bewering | Oordeel | Bevinding en bron |
|---|---|---|---|
| V1 | Headline atlassian.com: Standard **$7,91** en Premium **$14,54** per gebruiker/maand | **bevestigd** | Letterlijk in het schema.org-`Offer`-blok van de pagina: `"name":"Jira Standard","price":"7.91"` en `"name":"Jira Premium","price":"14.54"`; `AggregateOffer.highPrice = 14.54`. Onafhankelijk herhaald door SoftwareAdvice ("Starting price $7.91"). — https://www.atlassian.com/software/jira/pricing · https://www.softwareadvice.com/project-management/jira-profile/ |
| V2 | Jaarstaffels Jira Cloud: Standard **900 / 4.550 / 9.050 / 16.500 / 36.500**; Premium **1.850 / 9.150 / 18.300 / 32.000 / 62.500**; Enterprise **2.800 / 13.500 / 27.500 / 94.000** (bij 10 / 50 / 100 / 200 / 500 gebruikers) | **bevestigd** | Rauwe commerce-payload uitgelezen (`pricing-plan` "Jira, {Standard\|Premium\|Enterprise}, Annual (USD, Default, 15-10-2025)"). `flatAmount` in centen: Standard `{10:90000, 15:135000, 25:225000, 50:455000, 100:905000, 200:1650000, 300:2350000, 400:3000000, 500:3650000}`; Premium `{10:185000, …, 500:6250000}`; Enterprise `{10:280000, …, 500:9400000}`. Alle negen genoemde bedragen kloppen exact, inclusief de tussenstaffels 11–15 / 16–25 / 201–300 / 301–400. — https://www.atlassian.com/software/jira/pricing |
| V3 | Maandstaffels: Standard **9,05** / Premium **18,30** tot 100 gebruikers, aflopend tot 3,80 resp. 6,90 bij 20.000 | **bevestigd** | `"Jira, Standard, Monthly (USD…)"` tiers: `100→9.05, 250→7.65, 1000→6.40, 2500→5.80, 5000→5.40, 7500→5.10, 10000→4.80, 15000→4.15, 20000→3.80`; Premium: `18.30 / 13.70 / 9.55 / 9.25 / 8.90 / 8.20 / 7.85 / 7.20 / 6.90`. Identiek aan de tabel in §3.1. — idem |
| V4 | **Enterprise wordt alleen jaarlijks gefactureerd** | **bevestigd** | In de payload bestaan alleen `Jira, Standard, Monthly`, `Jira, Premium, Monthly`, en Annual-plannen voor alle drie; er is **geen** `Jira, Enterprise, Monthly`-plan. — idem |
| V5 | Plafonds: Standard/Premium **20.000**, Enterprise **50.000** gebruikers | **gecorrigeerd (genuanceerd)** | Weerleggingspoging deels geslaagd. `chargeElements.user.ceiling` is inderdaad 10 (Free) / 20.000 (Standard) / 20.000 (Premium) / 50.000 (Enterprise) — dat deel klopt. Maar de **jaarstaffels lopen door tot 100.000 gebruikers** in dezelfde payload (Standard $3.013.000, Premium $5.910.000, Enterprise $9.078.000), en de maandstaffels tot "unlimited". Bovendien noemt atlassian.com/licensing/cloud 10.000 als grens voor Standard/Premium — een derde, afwijkend getal. Tekst in §3.1 aangepast: 20.000/50.000 is de self-service-grens, geen hard productplafond. — https://www.atlassian.com/software/jira/pricing · https://www.atlassian.com/licensing/cloud |
| V6 | **Jira Free tot 10 gebruikers, zonder Plans** | **bevestigd** | Payload: `jira-software-free` → `chargeElements.user.ceiling: 10`, `pricingType: "FREE"`; schema.org-offer voor Free heeft `maxValue: 10, unitText: "users"`. Advanced Roadmaps staat in de featurelijst uitsluitend als "Advanced roadmaps (Premium)". — idem |
| V7 | **Advanced Roadmaps/Plans zit uitsluitend in Premium en Enterprise** | **bevestigd** | Atlassian-doc, letterlijk: *"This page refers to the advanced planning features that are only available as part of Jira Cloud Premium and Enterprise."* — https://support.atlassian.com/jira-software-cloud/docs/what-is-advanced-roadmaps/ |
| V8 | **Geen minimum-zetelaantal in de cloud** | **bevestigd** | Alle staffels hebben `floor: 0` voor de eerste tier (1–10). Geen minimumafname gedocumenteerd. — idem |
| V9 | Jira **Data Center vanaf ca. $44.000/jr** (derdepartijcijfer) | **bevestigd als derdepartijclaim, blijft SCHATTING** | SoftwareAdvice noemt letterlijk "Data Center plan starts at $44,000 per year". Atlassians eigen DC-prijspagina levert geen machineleesbare tabel (fetch gaf lege inhoud), dus het cijfer blijft onbevestigd bij de bron. De markering **[SCHATTING/derde partij]** in §3.1 is terecht en blijft staan. — https://www.softwareadvice.com/project-management/jira-profile/ |
| V10 | **BigPicture Cloud**: gratis tot 10 · 2.865 (50) · 5.730 (100) · 16.880 (500) · 24.780 (1.000) · 75.380 (10.000); DC 3.100 (50) · 17.000 (500) · Unlimited 159.600 | **bevestigd** | Marketplace REST-payload uitgelezen: cloud `{10:0.00, 25:1432.50, 50:2865, 100:5730, 200:10530, 500:16880, 1000:24780, 2000:36180, 5000:57880, 10000:75380}` (lastModified 2026-07-09); DC `{50:3100, 100:5800, 250:12100, 500:17000, 1000:27600, 2000:33350, unlimited:159600}` (lastModified 2026-07-15). Ook de maandtarieven kloppen: `100→$5.73, 250→$4.80, 1000→$1.58`. Alle in §3.2 genoemde bedragen exact. — https://marketplace.atlassian.com/rest/2/addons/eu.softwareplant.bigpicture/pricing/cloud/live |
| V11 | **Structure.Gantt vereist verplicht Structure**; gecombineerd $2.395 (50) en $16.585 (500); geen gratis tier | **bevestigd** | Structure.Gantt cloud `{10:100, 25:317.50, 50:635, 100:1270, 500:3860, 1000:6310, 2000:9710}`; Structure cloud `{10:100, 25:880, 50:1760, 100:3520, 500:12725, 1000:24025, 2000:34825}`. Sommen: 50 → 1.760+635 = **2.395** ✔; 100 → **4.790** ✔; 500 → 12.725+3.860 = **16.585** ✔; 1.000 → **30.335** ✔; laagste staffel 100+100 = **200**, dus geen gratis tier ✔. DC: Structure.Gantt unlimited **46.776**, Structure unlimited **138.319** ✔. De tandem-eis staat ook in de app-omschrijving ("leverages the power of Structure") en in een Marketplace-review. — https://marketplace.atlassian.com/rest/2/addons/com.almworks.structure.gantt/pricing/cloud/live · .../com.almworks.jira.structure/pricing/{cloud,datacenter}/live |
| V12 | **WBS Gantt-Chart**: gratis tot 10 · 660 (50) · 1.320 (100) · 3.845 (500); DC unlimited 33.855 | **bevestigd** | Cloud `{10:0.00, 25:330, 50:660, 100:1320, 200:2220, 500:3845, 1000:6195, 2000:9695}`; DC `{50:770, 100:1430, 250:2860, 500:4070, 1000:5940, 2000:6843, unlimited:33855}`. — https://marketplace.atlassian.com/rest/2/addons/jp.ricksoft.plugins.wbsgantt-for-jira/pricing/cloud/live |
| V13 | **BigTemplate** (nodig voor MS Project-import en export kritiek pad): gratis tot 10 · 1.195 (50) · 2.390 (100) | **bevestigd** | Cloud `{10:0.00, 25:597.50, 50:1195, 100:2390, 500:5825, 1000:8375}`; DC `{50:775, 100:1150, 500:3350, 1000:6100}`. De BigTemplate-afhankelijkheid staat expliciet in de BigPicture-doc: kritiek-padtaken "can be exported to XLSX format (requires BigTemplate)". — https://marketplace.atlassian.com/rest/2/addons/softwareplant.bigtemplate/pricing/cloud/live · Appfire SPM-doc 1918405060 |
| V14 | **Tier-matching-regel:** app-licentie moet de volledige Jira-tier evenaren (800 Jira-gebruikers + 5 planners → app voor 800) | **bevestigd** | Atlassian, letterlijk: *"The app will only function if its license matches or exceeds the tier of the host product – even if only some of your licensed users need to use the app."* Geen uitzondering voor deelgebruik; de enige uitzondering betreft meerdere hostproducten (dan geldt de hoogste tier). — https://www.atlassian.com/licensing/marketplace |
| V15 | Rekenvoorbeeld 50 gebruikers: Jira Premium + BigPicture = **$12.015/jr ($20,03 pgpm)** | **bevestigd** | 9.150 + 2.865 = 12.015; 12.015 / 50 / 12 = $20,025 → $20,03. Ook de overige rijen narekend: 10 gebr. → 1.850 ($15,42) ✔; 50 gebr. Structure-combi → 11.545 ($19,24) ✔; 50 gebr. WBS op Standard → 5.210 ($8,68) ✔; 500 gebr. BigPicture+BigTemplate → 62.500+16.880+5.825 = 85.205 ($14,20) ✔ |
| V16 | Rekenvoorbeeldrij "1.000 gebruikers, Structure + Gantt (DC, unlimited) = $185.095" | **gecorrigeerd** | Rekenfout in de framing: bij **1.000** Data-Center-gebruikers is de lijstprijs $20.036 + $5.520 = **$25.556/jr**, niet $185.095. Het bedrag $185.095 hoort bij de **Unlimited**-staffel (138.319 + 46.776). De rij in §3.6 is gesplitst in twee correcte rijen. — Marketplace REST API, DC-payloads |

### Functionaliteit en CPM-claims

| # | Bewering | Oordeel | Bevinding en bron |
|---|---|---|---|
| V17 | Advanced Roadmaps kent **alleen Finish-to-Start**, alle linktypes worden als "Blocks" behandeld; **geen lag/lead, geen SS/FF/SF** | **bevestigd** | Atlassian-doc bevestigt de behandeling als Blocks-type ("the first work item must end before the second one can begin") en noemt nergens lag/lead, SS, FF of SF. — https://support.atlassian.com/jira-software-cloud/docs/what-are-dependencies-in-advanced-roadmaps/ |
| V18 | Advanced Roadmaps heeft **geen kritiek pad**; open verzoek **JSWSERVER-24925, 139 stemmen, "Gathering Interest"**; JSWSERVER-25115 Milestones 282 stemmen; JSWSERVER-25222 PDF-export 412 stemmen | **bevestigd** | Live opgehaald via `jira.atlassian.com/rest/api/2/issue/{key}`: JSWSERVER-24925 "Highlight blockers on the critical path", status *Gathering Interest*, **139** stemmen; JSWSERVER-25115 "Milestones", *Gathering Interest*, **282**; JSWSERVER-25222 "Export plan as PDF", *Gathering Interest*, **412**; JSWSERVER-24924, *Gathering Interest*, **63**. Alle vier exact. — https://jira.atlassian.com/browse/JSWSERVER-24925 |
| V19 | De auto-scheduler is **greedy/rank-gebaseerd ("first-come, first-serve")**, negeert cyclische afhankelijkheden en herplant actieve sprints niet | **bevestigd** | Atlassian-doc: capaciteit wordt toegekend op *"first-come, first-serve basis"* met prioriteit op rank, schatting en hiërarchieniveau; cyclische afhankelijkheden worden genegeerd; de scheduler *"won't reschedule work items in the active sprint, even if it's overbooked"*. — https://support.atlassian.com/jira-software-cloud/docs/how-does-the-auto-scheduler-in-advanced-roadmaps-work/ |
| V20 | Schaalgrenzen Plans: **10.000 work items**, **±50 teams**, **100 Jira-spaces** | **bevestigd** | Doc: *"A single plan can load up to 10,000 work items"*, aanbeveling *"no more than 50 teams"* (daarboven onvindbaar in de Teams-tab), en *"only span 100 Jira spaces"*. — https://support.atlassian.com/jira-software-cloud/docs/limits-on-plan-size-in-advanced-roadmaps/ |
| V21 | BigPicture's kritieke pad is een **achterwaartse ketenheuristiek**, en **"The non-working days do not affect the critical path calculation."** | **bevestigd** | Dit was de scherpste weerleggingspoging: de gerenderde HTML-pagina gaf de citaten niet prijs. Via de Confluence REST API (`/rest/api/content/1918405060?expand=body.view`) staan ze wél letterlijk in de body: *"The path is calculated from the end (the last task(s) in the project)"*, *"works backward, looking for strong links connecting tasks"*, *"The most direct path (without a time gap between tasks) is highlighted"*, *"A gap between tasks is allowed only if an ASAP link has the lag time added"* en *"The non-working days do not affect the critical path calculation."* Beide citaten in §2.3 en §5.3 zijn correct geciteerd. — https://appfire.atlassian.net/wiki/spaces/SPM/pages/1918405060 |
| V22 | BigPicture kent **geen total float / free float** (0 zoekresultaten in space SPM) | **bevestigd** | Confluence-zoek-API opnieuw uitgevoerd: `cql=space=SPM and text~"total float"` → **totalSize 0**; `text~"free float"` → **totalSize 0**. — https://appfire.atlassian.net/wiki/rest/api/search |
| V23 | BigPicture-lag telt in **kalenderdagen**, negatieve lag (overlap) mogelijk | **bevestigd** | Appfire-doc letterlijk: *"The working and non-working days are both included in the Lag time calculation"* en *"If … the Lag time is a negative value then the tasks will 'overlap'."* — https://appfire.atlassian.net/wiki/spaces/SPM/pages/1918406747 |
| V24 | Structure.Gantt heeft **vier afhankelijkheidstypen + lead/lag**, een **`Gantt Critical Path`-veld**, maar **geen float-, early/late- of constraint-velden** | **bevestigd** | Tempo-doc noemt FS/SS/FF/SF plus configureerbare lead/lag-tijden. De volledige veldenlijst bevat `Gantt Critical Path` ("Critical if the item is part of the critical path") en géén total float, free float, early start, late finish of constraint-veld. — https://help.tempo.io/gantt/latest/dependencies · https://help.tempo.io/gantt/latest/list-of-gantt-fields-available-in-structure |
| V25 | Structure.Gantt-levelling **schrijft niets terug naar Jira**, kan "several seconds to dozens of minutes" duren, één operatie tegelijk, en gebruikt **geen speling** | **bevestigd** | Tempo-doc: *"Resource leveling delays items in the Gantt chart only. It DOES NOT reschedule work items in Jira."*; *"may take several seconds to dozens of minutes to complete"*; *"Only one leveling operation can be run per structure at a given time."* Het algoritme noemt leveling priority, dependencies, starttijd en taakduur — slack/float/kritiek pad komen er niet in voor. — https://help.tempo.io/gantt/latest/resource-leveling |
| V26 | WBS Gantt-Chart claimt 4 afhankelijkheidstypen, kritiek pad, baselines, mijlpalen, MS Project-/Excel-import-export en **"up to 10.000 issues"** | **bevestigd (als leverancierclaim)** | Ricksoft-productpagina, letterlijk: *"Set issue dependencies (Start-Start, Start-End, End-Start, End-End)"*, *"a clear critical path highlighted in red"*, baseline-claim, *"Quickly set milestones"*, *"exporting the chart to Excel or MS Project and seamlessly import data from MS Project"*, en *"Enjoy the fastest load times … for up to 10,000 issues"*. Onafhankelijke bevestiging van de prestatieclaim ontbreekt — blijft leverancierclaim. — https://www.ricksoft-inc.com/products/wbs-gantt-chart-for-jira/ |
| V27 | Er is **geen Primavera-P6-ondersteuning** in de hele Marketplace (0 zoekresultaten) | **bevestigd** | Marketplace REST-zoekopdracht `?text=Primavera%20P6` → `count: 0`, lege `addons`-array. — https://marketplace.atlassian.com/rest/2/addons?text=Primavera%20P6 |

### Gebruikersaantallen, marktpositie en overige

| # | Bewering | Oordeel | Bevinding en bron |
|---|---|---|---|
| V28 | Marketplace-installs: BigPicture **11.235**, Structure **13.291**, Structure.Gantt **6.540**, WBS Gantt-Chart **5.718** | **gedeeltelijk gecorrigeerd** | Hergemeten via `/rest/2/addons/{key}?withVersion=true` → `distribution.totalInstalls`: BigPicture **11.235** ✔, Structure.Gantt **6.540** ✔, Structure **13.272** (was 13.291, −19), WBS Gantt-Chart **5.710** (was 5.718, −8). Downloads exact bevestigd: 654.233 / 96.423 / 327.409 / 67.834. Cijfers in §1.2 en §7.1 bijgewerkt; de afwijking is dagkoersruis, geen materiële fout. — https://marketplace.atlassian.com/rest/2/addons/com.almworks.jira.structure |
| V29 | Reviewscores apps: BigPicture **3,91/504**, Structure **4,55/408**, Structure.Gantt **4,20/61**, WBS **3,47/159** | **bevestigd** | API-waarden: 3,9087/504 · 4,5502/408 · 4,2008/61 · 3,4748/159. Alle vier afgerond correct. — Marketplace REST API `_embedded.reviews` |
| V30 | Appversies: BigPicture **8.7.0** (release 20-07-2026), Structure.Gantt **7.52.0** | **bevestigd** | API: BigPicture 8.7.0, releasedatum **2026-07-20** ✔; Structure.Gantt 7.52.0, releasedatum 2026-07-24 ✔ (Structure zelf eveneens 7.52.0). WBS Gantt-Chart staat op 3.9.0 (2026-07-13). — Marketplace REST API |
| V31 | Atlassian **FY2025: $5,2 mrd omzet (+20%)**, cloud $3,45 mrd, FCF $1,415 mrd, **51.978 klanten >$10k cloud-ARR (+13%)**, FY2026-guidance cloud ~21% / DC ~12,5% / Marketplace ~10% | **bevestigd** | Persbericht Q4/FY2025 bevestigt alle zes cijfers letterlijk, inclusief cloudomzet $3,447 mrd, FCF-marge 27% en de drie guidance-percentages (totaal ~18%). — https://investors.atlassian.com/news/news-details/2025/Atlassian-Announces-Fourth-Quarter-and-Fiscal-Year-2025-Results/default.aspx |
| V32 | **300.000+ klanten** en **12.000+ Atlassians** | **bevestigd** | atlassian.com/company toont letterlijk "300,000+ customers" en "12,000+ Atlassians". — https://www.atlassian.com/company |
| V33 | Jira-reviewscore **4,4/5 op 15.426 reviews** (SoftwareAdvice) | **bevestigd** | SoftwareAdvice-profiel: 4,4/5, 15.426 reviews. Ook het schema.org-blok op atlassian.com noemt `ratingValue: 4.4`. — https://www.softwareadvice.com/project-management/jira-profile/ |
| V34 | BigPicture gesplitst in **Standard en Advanced sinds 24-07-2026**; Financials/OKR/Priorities alleen in Advanced | **bevestigd (met aanvulling)** | Appfire-aankondigingspagina bevestigt de datum **24 juli 2026** en de moduleverdeling: Standard = Overview/Gantt/Scope/Resources/Board/Risks/Goals/Teams/Calendar/Reports; Advanced = + Financials, OKR, Priorities, Advanced reporting. Aanvulling verwerkt in §3.2: bestaande klanten houden Standard ("No features were removed from the Standard plan"), en BigPicture Enterprise is *"planned to be sunset in 2027"*. — https://appfire.atlassian.net/wiki/spaces/SPM/pages/3482747495 |
| V35 | Appfire adverteert "Trusted by 20.000+ teams" tegenover 11.235 gemeten installs | **onzeker** | De marketingclaim was op 25-07-2026 niet terug te vinden in de Marketplace-API-samenvatting (die luidt nu: *"Connect strategy to delivery in Jira…"*). Het gemeten installcijfer (11.235) is wél bevestigd. De tegenstelling die §1.2 schetst kon niet worden gereproduceerd — mogelijk is de listing-tekst herschreven. Behandel het citaat als niet-verifieerbaar. — https://marketplace.atlassian.com/rest/2/addons/eu.softwareplant.bigpicture |
| V36 | BigPicture praktisch werkbaar bij ~2.000–10.000 taken/box; Structure.Gantt ~5.000–20.000 | **onzeker (blijft SCHATTING)** | Niet falsifieerbaar met publieke bronnen; alleen de kwalitatieve waarschuwing dat *"tens of thousands of tasks in a single box can reduce the app's performance"* is gedocumenteerd. De **[SCHATTING]**-markering in §2.3 en §2.6 is terecht en blijft staan. |

**Samenvattend:** 36 beweringen getoetst, waarvan 31 bevestigd op de primaire bron, 3 gecorrigeerd (installcijfers Structure/WBS; de DC-rekenvoorbeeldrij; de plafond-nuance) en 2 als onzeker gemarkeerd. Het prijsblok is het sterkste deel van het profiel: alle 27 gecontroleerde Jira-Cloud-staffelbedragen en alle gecontroleerde Marketplace-app-prijzen kwamen exact uit de rauwe payloads. De inhoudelijke CPM-kritiek (geen float, alleen FS in Advanced Roadmaps, kalenderdagen-lag, niet-werkdagen buiten de kritieke-padberekening, levelling die niet naar Jira terugschrijft) is volledig herleidbaar tot letterlijke leveranciersdocumentatie en houdt stand.

*Verificatie uitgevoerd 25-07-2026. Waar de gerenderde webpagina onvolledig laadde (Confluence, Atlassian-prijspagina), is de onderliggende REST-payload respectievelijk de rauwe HTML-bron uitgelezen om citaatvervalsing uit te sluiten.*
