...
**Clarity 16.4.2**, algemeen beschikbaar in het voorjaar/de zomer van 2026 (bronnen noemen 11 mei 2026 voor de GA-aankondiging en 12 juni 2026 voor de release zelf — de discrepantie is niet opgelost). Belangrijkste nieuws: uitbreiding van de AI-assistent **Vaia** met native ondersteuning voor Anthropic-modellen, een nieuwe **MCP-server** waarmee externe AI-assistenten (Claude Desktop, Cursor) met Clarity kunnen praten (eerst alleen urenregistratie-workflows), 15+ rapportageverbeteringen en High Contrast Mode. **Jaspersoft wordt verwijderd in 16.4.3** (sept. 2026 voor SaaS) — een substantiële migratie voor iedereen met eigen rapporten. `[SECUNDAIR]`
...
- **Schaal:** PeerSpot-reviewers melden implementaties van **50 tot 200.000+ gebruikers**. `[SECUNDAIR]`
...
**Deployment:** SaaS (door Broadcom gehost) en on-premise. Databases: **Oracle, Microsoft SQL Server en PostgreSQL**. `[SECUNDAIR]` Webgebaseerd; geen native desktop-client (behalve de MSP/OWB-connector) en beperkte mobiele functionaliteit.
...
Broadcom publiceert **geen lijstprijzen** voor Clarity. Er is **geen gratis tier**; SelectHub meldt een proefversie *"upon request"*. Verkoop loopt via Broadcom-accountmanagers en partners (Rego Consulting, itdesign, Winmill, Tricise e.a.), met onderhandelde meerjarige contracten. Alle onderstaande bedragen zijn dus **derdenbronnen**, met de bijbehorende onzekerheid.

### 3.2 Licentietypen

Clarity kent drie gebruikersklassen: `[HARD — Broadcom KB / partner itdesign]`

| Type | Wie | Wat |
|---|---|---|
| **Full Function User** | Projectmanagers, PMO, resourcemanagers | Volledige functionaliteit |
| **Restricted User** | Teamleden | Beperkt: taken bijwerken, urenregistratie |
| **View Only User** | Stakeholders, management | Alleen lezen; ideeën/requirements indienen |
...
- **Geen gepubliceerd minimum aantal zetels**, maar de dealstructuur (accountverkoop, enterprise-onderhandeling) maakt Clarity **de facto ontoegankelijk onder ±50–100 gebruikers**.
...
4. **Bewezen schaal op organisatieniveau.** Implementaties van 50 tot **200.000+ gebruikers** worden door klanten gemeld, met 99,9% uptime en algemene stabiliteit. Weinig PPM-producten hebben dit trackrecord. `[SECUNDAIR]`
...
2. **Prijs wordt breed als te hoog ervaren, en verlengingen zijn een risico.** **85%** van de SelectHub-reviewers noemt het aanbod *"too expensive and prohibitive to upgrades"*. PeerSpot-gebruikers geven prijs-kwaliteit een **3–4 op 10**. Een reviewer meldt dat de overgang naar het abonnementsmodel het jaarlijkse onderhoudsbedrag **verdubbelde**. Organisaties beperken bewust het aantal Clarity-licenties omdat ze duurder zijn dan Jira. `[SECUNDAIR]`
...
- **Gartner Magic Quadrant for Strategic Portfolio Management (augustus 2025): Leader.** Broadcom's eigen aankondiging spreekt van het **tweede opeenvolgende jaar** als Leader in deze MQ; sommige partnerbronnen claimen het **vijfde** opeenvolgende jaar (waarschijnlijk inclusief voorgangers van de MQ onder andere namen). **Deze discrepantie is niet opgelost** — behandel "5e jaar" met voorzichtigheid. Planview is in dezelfde MQ eveneens Leader en claimt de positie *"highest and furthest"* op beide assen. `[SECUNDAIR]`
- **PeerSpot:** rang **3** in Project Portfolio Management met **9,6% mindshare**, gemiddelde score **8,0**, **143 reviews**, **91% aanbeveling**. Ter vergelijking: Smartsheet 4,6% mindshare; Primavera P6 Enterprise staat op PeerSpot op rang 35 met 0,7% mindshare (dat zegt vooral iets over PeerSpot's IT-georiënteerde publiek, niet over P6's echte marktpositie in de bouw). `[SECUNDAIR]`
...
16. Broadcom Community — *General Availability Announcement for Clarity Release 16.4.2*: <https://community.broadcom.com/discussion/general-availability-announcement-for-clarity-release-1642>
...
20. Capterra — Clarity / CA PPM reviews (4,2/5 overall; 3,4/5 ease of use; 12 reviews): <https://www.capterra.com/p/145502/CA-PPM/reviews/>
21. SelectHub — Clarity PPM (prijs USD 60/gebruiker/maand; 88% UI-kritiek; 85% te duur): <https://www.selecthub.com/ppm-software/clarity-ppm/>
