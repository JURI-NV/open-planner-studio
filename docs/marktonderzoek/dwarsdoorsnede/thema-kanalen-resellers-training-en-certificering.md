...
| **Bentley Systems** (SYNCHRO) | FY2025 | **94 %** | **6 %** | — | 10-K FY2025, "supplemental data of our revenues" **[H]** |
| **Bentley Systems** | FY2024 | 93 % | 7 % | — | idem **[H]** |
| **Bentley Systems** | FY2023 | 92 % | 8 % | — | idem **[H]** |
...
**Bevinding 1 — Oracle verkoopt niet zelf aan de Amerikaanse overheid.** In de top-100 contracten met trefwoord "Primavera" sinds 2019 ($61,9 mln totaal) komt Oracle Corporation **niet één keer** voor als contractant. De grootste ontvangers:
...
Dit zijn de meest concrete Primavera-prijzen die ik in dit onderzoek heb kunnen vaststellen. De twee zetelprijzen liggen binnen 4 % van elkaar en zijn beide van dezelfde koper in dezelfde maand, dus ze bevestigen elkaar maar zijn niet onafhankelijk. De onderhoudsprijs (~$471/jaar) impliceert bij het gebruikelijke Oracle-percentage van 22 % een onderliggende licentiewaarde van ~$2.140 **[S]**, wat suggereert dat de $3.880-bundel bestaat uit een licentie van ruwweg $3.300–3.400 plus eerstejaars support — hoger dan de historische lijstprijs. Ik markeer dat expliciet als afleiding.
...
|---|---|---|
| Oracle Primavera P6 EPPM | RPC UK Limited | **£165 – £439** p/gebruiker/maand |
| Oracle Primavera P6 EPPM Cloud | Laminar Group Ltd | £176 – £220 p/licentie/maand |
| Primavera P6 EPPM | (niet vastgesteld) | £168,75 p/gebruiker/maand |
| Oracle Primavera Cloud – Schedule, Resource and Risk Management | Hyde Park Solutions | £72 p/gebruiker/maand |
| Oracle Primavera Cloud (OPC) | Hyde Park Solutions | **£8 – £176** p/licentie/maand |
...
**Dit is een opmerkelijk klein getal.** De volledige wereldwijde populatie planningsspecialisten met het toonaangevende vakinhoudelijke planningskeurmerk bedraagt **1.806 actieve personen**. Tel de scheduling-technicus (CST, 126) erbij en je komt op 1.932. Voor een beroepsgroep die wereldwijd projecten van honderden miljarden plant, is dat verwaarloosbaar.
...
|---|---|---|---|---|
| Plan Academy | Primavera P6 Professional Foundations (v23) | **US$ 1.049** | zelfstudie online, eenmalig | https://www.planacademy.com/courses/ |
...
- **IFC 4.3 is een ISO-norm (ISO 16739-1) en staat in toenemende mate in Europese aanbestedingseisen.** OPS is de enige planner die IFC als *native* formaat gebruikt in plaats van als import-/exportkoppeling. Waar een aanbesteding "openBIM" of "IFC-conforme leveringsspecificatie" eist, is dat een structureel voordeel dat geen enkele reseller kan wegconcurreren.
...
**Implicatie voor de roadmap:** de kritische functionaliteit is niet feature-pariteit met P6, maar **migratie en interoperabiliteit**. Concreet: robuuste import van XER- en P6-XML-bestanden, en MS Project-uitwisseling. De GitHub-verkenning laat zien hoe leeg dat terrein is: de best gewaardeerde open XER-tool op GitHub heeft **39 sterren** (`djouallah/xer-reader`, een Excel-VBA-macro), gevolgd door `JaiLaff/XER-Splitter` met 32 en `jjCode01/js_xer_analyzer` met 11 **[H]**. Er is geen serieus open ecosysteem rond het dominante bestandsformaat van deze markt. Dat is tegelijk een waarschuwing (het is kennelijk moeilijk of onaantrekkelijk werk) en een kans (wie het wél goed doet, staat alleen).
