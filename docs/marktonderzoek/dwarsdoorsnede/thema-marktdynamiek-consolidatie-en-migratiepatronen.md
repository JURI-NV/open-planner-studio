...
**De SaaS-transitie is bij de Europese spelers feitelijk klaar en dat verwijdert een groeimotor.** Nemetschek's licentie-omzet is ingestort van €234,8 mln (2021) naar €55,9 mln (2025) — min 76% — terwijl de totale omzet met 75% groeide naar €1.191,2 **mln** (≈ €1,19 mrd; *gecorrigeerd — in de oorspronkelijke tekst stond hier abusievelijk "€1.191,2 mrd", een eenheidsfout van factor 1.000*); wederkerende omzet is nu 92,2% van de groep **[HARD]**. Eleco's eeuwigdurende licenties zijn nog **1%** van de omzet (£545k van £38,8 mln) **[HARD]**. Beide bedrijven zeggen het zelf: Nemetschek noemt de transformatie "zum Großteil abgeschlossen" en heeft ARR als stuurgetal laten vallen **[HARD]**. Het optische groei-effect van perpetual-naar-abonnement is opgebruikt. Wie daarna nog wil groeien moet dat doen met prijs, met AI, of met overnames.
...
**De onderkant van de markt wordt afgesnoept tegen prijzen die tot ruim twaalf keer lager liggen** (*bijgesteld bij verificatie: de bovengrens klopt — monday.com Standard $144/jr tegen InEight Schedule NOW $1.800/jr is 12,5×, en tegen monday.com Pro $228/jr is het 7,9×. De ondergrens "anderhalf keer" is uit de prijstabel in 5.4 niet af te leiden en is geschrapt*). monday.com levert Gantt- en tijdlijnweergaven vanaf **$12 per seat per maand** en afhankelijkheden vanaf **$19** **[HARD]**. Een volwaardige CPM-planner van InEight kost **$1.800 per gebruiker per jaar** **[HARD]**; Microsoft Project Professional 2024 kost **$1.129,99** eenmalig **[HARD]**. Tegelijk is die work-managementgolf zelf aan het uitrazen: Asana's omzetgroei zakte van +44,6% (FY2023) naar **+9,2%** (boekjaar t/m 31 januari 2026) **[AFGELEID op HARD]**, en Smartsheet is van de beurs gehaald door Blackstone en Vista (delisting-notificatie bij de SEC op 22 januari 2025) **[HARD]**.
...
|---|---|---|---|
| **EcoSys** (→ *Octave Sequence*) | Octave Intelligence plc | Afsplitsing van Hexagon **geëffectueerd 22 mei 2026**; pro-rata-uitkering van 1 Octave-aandeel per 10 Hexagon-aandelen (per aandelenklasse: Class A op Class A, Class B op Class B); notering Nasdaq Global Select (**OCTV**) + Zweedse depositary receipts op Nasdaq Stockholm (**OCTV SDB**) | [HARD] — Octave 10-Q per 31-03-2026 (SEC, CIK 0002083632). *Gecorrigeerd/genuanceerd: de 10-Q dateert de Distribution op 22-05-2026 en zegt dat de notering "following the Distribution" plaatsvond; de specifieke noteringsdatum **28 mei 2026** en het predicaat **"belastingvrij"** heb ik niet in de filing teruggevonden — beide als onbevestigd behandelen.* |
...
| Financiering bij afsplitsing | $500 mln revolver (5 jr) + termijnlening **$350 mln + €150 mln** (4 jr), bij closing volledig getrokken, plus ~$120 mln en ~€25 mln onder de revolver; **$625 mln overgemaakt aan Hexagon** (*gecorrigeerd: "$500 mln+ termijnlening" was een afronding; de 10-Q specificeert $350 mln + €150 mln*) |
...
| **InEight Schedule NOW** | **$1.800** | **Volledige CPM, baseline, risicoregisters + Monte Carlo, AI-kennisbank** — maar expliciet het *instap*-abonnement "for individuals or small teams just getting started"; de enterpriseprijs is niet gepubliceerd |
...
**[AFGELEID]** De factor tussen "een Gantt met afhankelijkheden" ($228) en "een echte CPM-planner" ($1.800) is **bijna acht** (7,9×) (*gecorrigeerd: hier stond "ruim acht"; 1.800/228 = 7,89, dus net onder acht. Tegenover monday.com Standard ($144) is de factor wél 12,5×*). Dat is de prijsruimte waarin de work-managementtools de onderkant afsnoepen: voor de aannemer die alleen een tijdlijn met afhankelijkheden nodig heeft, is $228 volstrekt voldoende en $1.800 niet te rechtvaardigen.
...
Ik heb Oracle's **Lifetime Support Policy: Oracle Applications**, ingangsdatum **2 juli 2026** (98 pagina's), volledig uitgelezen. De sectie "Oracle Primavera Releases" beslaat **vier** pagina's (gedrukte p. 66–69; *gecorrigeerd: er stond drie*), gevolgd door "Oracle Skire Releases" met Primavera Unifier op p. 70. De relevante regels, **hertoetst door de PDF opnieuw op te halen en met `pypdf` uit te lezen** **[HARD]**:
...
Identieke reeks voor **P6 Professional** (25.x: GA dec 2025, Premier dec 2030, Extended "Not Available", Sustaining "Indefinite" — regel voor regel geverifieerd). Ook **Primavera Analytics 25.x** (dec 2025 → dec 2030) en **Primavera Unifier 25.x** (dec 2025 → dec 2030) lopen door. Oracle heeft dus in **december 2025 een nieuwe on-premises release uitgebracht met support tot eind 2030**.
...
**c) InEight Schedule — de expliciete P6-uitdager in kapitaalprojecten.** InEight positioneert Schedule met "full CPM functionality, AI-driven planning, collaborative markup, and integrated risk analysis" **[VENDOR]** en, uniek in dit segment, met een **gepubliceerde prijs van $1.800 per gebruiker per jaar** **[HARD]**. **Belangrijke nuance (toegevoegd bij verificatie):** die $1.800 is de prijs van **InEight Schedule NOW**, het zelfbedieningsinstapabonnement dat de leverancier zelf omschrijft als bedoeld voor *"individuals or small teams just getting started with InEight"*. Het is **niet** de prijs van de enterprise-uitrol van InEight Schedule waarmee P6 in kapitaalprojecten daadwerkelijk wordt uitgedaagd; die prijs is niet gepubliceerd. De vergelijking met P6 op prijsniveau is dus niet appels-met-appels. **[AFGELEID]** Een gepubliceerde prijs tegenover een leverancier die er geen publiceert, is zelf een verkoopargument. Dat is geen toeval.
...
| **Procore** | Bruto-omzetretentie 95% — jaarlijks valt 5% van de basis weg vóór uitbreiding. Groei van +31,9% naar +14,8% in twee jaar (*gecorrigeerd, zie 3.2*). Nieuwe CEO en CFO, aandeleninkoop, "durable and profitable growth": de omslag van groei- naar rendementsverhaal. | 10-K en Q1-2026-persbericht 05-05-2026 **[HARD]** |
...
**Aanvulling bij verificatie (versterkt deze bevinding):** `TotalFloat` op `IfcWorkSchedule` is geërfd van `IfcWorkControl` en is een *schema*-attribuut. Het veel sterkere argument staat één niveau lager, in **`IfcTaskTime`** — nieuw in IFC4, afgeleid van `IfcScheduleTimeControl` — dat per taak **`EarlyStart`, `EarlyFinish`, `LateStart`, `LateFinish`, `FreeFloat`, `TotalFloat` én `IsCritical`** bevat **[HARD]**. Dat is niet "een zweem van CPM" maar de volledige uitvoerset van een CPM-berekening, genormeerd per activiteit. Gecontroleerd is ook dat **geen** van de betrokken `IfcWorkControl`-attributen in IFC4/IFC4.3 als DEPRECATED is gemarkeerd; de IFC4-wijzigingen zijn typewijzigingen (`IfcTimeMeasure` → `IfcDuration`, `IfcDateTime`) plus de toevoeging van `PredefinedType` en de `CorrectPredefinedType`-regel.
...
**Adversariële fact-check, uitgevoerd 25 juli 2026.** Werkwijze: van elke bewering is geprobeerd haar te **weerleggen** met een onafhankelijke primaire bron — normteksten en contractdocumenten zijn woord-voor-woord in de originele PDF nagelezen (opgehaald en met `pypdf` uitgelezen, niet via secundaire samenvattingen), financiële reeksen zijn opnieuw opgehaald uit de SEC XBRL-`companyconcept`-API, en alle doorgerekende percentages zijn opnieuw berekend. `WebSearch` was in deze sessie niet beschikbaar (budget 200/200 verbruikt); alle controles zijn daarom directe `WebFetch`-ophalingen op primaire bronnen plus lokale PDF-tekstextractie.

**Uitkomst in één regel: de harde kern van het rapport houdt stand.** Alle normteksten, contractclausules, lifecycle-data en gepubliceerde prijzen bleken letterlijk juist — inclusief de meest contra-intuïtieve claim van het stuk (dat Oracle on-prem P6 gewoon doorbouwt tot 2030). Wat sneuvelde zijn vier rekenkundige/eenheidsfouten en één positioneringsfout in een prijsvergelijking. Geen enkele van de vijf kernconclusies kantelt daardoor.

### Falsifieerbare beweringen, één voor één

| # | Bewering | Oordeel | Bron |
|---|---|---|---|
| 1 | **Oracle P6 EPPM en P6 Professional 25.x: GA dec 2025, Premier Support tot dec 2030, Extended Support "Not Available", Sustaining "Indefinite"** — en dus géén aangekondigde end-of-life voor on-prem P6 | **bevestigd** — regel voor regel letterlijk teruggevonden in de originele normtekst (gedrukte p. 66–69), inclusief het feit dat Extended Support voor **elke** Primavera-release zonder uitzondering "Not Available" is. Ook Primavera Analytics 25.x en Unifier 25.x lopen tot dec 2030. Dit is de kernbewering van sectie 6 en ze is niet te weerleggen | https://www.oracle.com/us/support/library/lifetime-support-applications-069216.pdf (ingangsdatum 02-07-2026, 98 pp.) |
| 2 | **Oracle-lock-inclausules**: *Matching Service Levels* (geen subset van een license set te ondersteunen; beëindiging via termination letter), *Pricing Following Reduction of Licenses* (herprijzing op lijstprijs minus standaardkorting, met bodem op het eerder betaalde bedrag), *Reinstatement* 150% | **bevestigd** — alle drie de citaten woordelijk juist, inclusief "150% of the last annual technical support fee you paid". Document telt inderdaad 31 pagina's met ingangsdatum 10-July-2026. De afgeleide conclusie ("krimp loont niet") volgt direct uit de contracttekst | https://www.oracle.com/contracts/docs/057419.pdf |
| 3 | **Microsoft Project Server 2019: Extended End Date 14 juli 2026**; opvolger is Project Server Subscription Edition (start 02-11-2021, Modern Lifecycle) | **bevestigd** — lifecycle-database geeft exact `2026-07-14`, mainstream `2024-01-09`, start `2018-10-22`. Fixed Lifecycle Policy | https://learn.microsoft.com/en-us/lifecycle/products/project-server-2019 |
| 4 | **IFC-normclaim**: `IfcWorkSchedule` heeft CreationDate, StartTime, FinishTime, Duration, **TotalFloat**, Purpose, Creators, PredefinedType; nieuw in **IFC2.0**; PredefinedType toegevoegd in IFC4 | **bevestigd** — schemadocumentatie zegt letterlijk "New entity in IFC2.0"; changelog bevestigt PredefinedType + `CorrectPredefinedType`-where-rule als IFC4-toevoegingen. **Aanvullend geverifieerd en in 12.1 B toegevoegd:** `IfcTaskTime` (nieuw in IFC4) draagt `EarlyStart`, `EarlyFinish`, `LateStart`, `LateFinish`, `FreeFloat`, `TotalFloat` én `IsCritical` — een sterker argument dan het rapport zelf maakte. Getoetst en **weerlegd**: er is géén DEPRECATED-markering op de betrokken `IfcWorkControl`-attributen | https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcWorkSchedule.htm · https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcTaskTime.htm · https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/IfcWorkControl.htm |
| 5 | **Octave Intelligence plc**: afsplitsing van Hexagon geëffectueerd 22-05-2026, $625 mln aan Hexagon, Q1-2026-omzet $386,5 mln (Q1-2025 $382,8 mln), abonnementen $279,2/licenties $35,1/diensten $72,2 mln, SaaS $84,7 mln +25%, 1-op-10-uitkering | **gecorrigeerd (grotendeels bevestigd)** — entiteit bestaat (SEC CIK 0002083632, 10-Q ingediend 04-06-2026), Distribution 22-05-2026, $625 mln, alle omzetregels exact juist, SaaS $84,7 mln tegen $67,8 mln = +24,9%. **Twee correcties:** (a) de kredietfaciliteit is $500 mln revolver + termijnlening van **$350 mln + €150 mln** (niet "$500 mln+"); (b) de noteringsdatum **28 mei 2026** en het predicaat **"belastingvrij"** staan niet in de filing — als onbevestigd gemarkeerd | https://www.sec.gov/Archives/edgar/data/2083632/000162828026040622/octv-20260331.htm |
| 6 | **Procore-omzetreeks en groeivertraging**: $400,3 / $514,8 / $720,2 / $950,0 / $1.151,7 / $1.322,5 mln (2020–2025); "daling van +28,6% naar +14,8%" | **gecorrigeerd** — de omzetreeks is tot op de duizend euro juist ($400.291k / $514.821k / $720.203k / $950.010k / $1.151.708k / $1.322.509k). Maar **+28,6% is een rekenfout**: 950,010/720,203 = **+31,9%**. Tussenliggend: +21,2% (2023→2024), +14,8% (2024→2025). Gecorrigeerd op beide plaatsen (3.2 en 11.2); de conclusie wordt er sterker van, niet zwakker | https://data.sec.gov/api/xbrl/companyconcept/CIK0001611052/us-gaap/RevenueFromContractWithCustomerExcludingAssessedTax.json |
| 7 | **Asana-groeivertraging**: $378,4 → $547,2 → $652,5 → $723,9 → $790,8 mln; +44,6% → +9,2% | **bevestigd** — alle vijf boekjaren exact ($378.437k / $547.212k / $652.504k / $723.876k / $790.806k), en alle vier de groeipercentages nagerekend: +44,6%, +19,2%, +10,9%, +9,2% | https://data.sec.gov/api/xbrl/companyconcept/CIK0001477720/us-gaap/RevenueFromContractWithCustomerExcludingAssessedTax.json |
| 8 | **Trimble-omzetkrimp**: $3.798,7 (2023) → $3.683,3 (2024) → $3.587,3 mln (2025), −5,6% over twee jaar | **bevestigd** — alle drie de jaren exact; herberekend −5,57%, dus "−5,6%" is correct afgerond | https://data.sec.gov/api/xbrl/companyconcept/CIK0000864749/us-gaap/RevenueFromContractWithCustomerExcludingAssessedTax.json |
| 9 | **monday.com-prijzen**: Free (2 seats) / Basic $9 / Standard $12 / Pro $19 per seat/maand bij jaarbetaling; Gantt vanaf Standard, afhankelijkheden vanaf Pro | **bevestigd** — alle vier de bedragen en beide functiedrempels kloppen exact met de live prijspagina, inclusief de formulering dat afhankelijkheden via "advanced columns" in Pro zitten | https://monday.com/pricing |
| 10 | **InEight NOW-prijzen**: Schedule $199/mnd of $1.800/jr; Estimate $260/mnd of $2.388/jr; Document $73/mnd of $624/jr; Compliance $55/mnd of $444/jr | **gecorrigeerd (bedragen bevestigd, duiding fout)** — alle acht bedragen kloppen; de maandprijzen zijn de *month-to-month*-tarieven, de jaartarieven komen neer op $150/$199/$52/$37 per maand (nagerekend, sluit exact). **Correctie op de duiding:** het rapport gebruikte de $1.800 in 6.2(c) als prijsanker voor "de expliciete P6-uitdager in kapitaalprojecten", maar de leverancier positioneert Schedule NOW expliciet *"for individuals or small teams just getting started"*. De enterprise-InEight-Schedule-prijs is **niet** gepubliceerd. Nuance toegevoegd in 5.4 en 6.2 | https://ineight.com/now/ |
| 11 | **Bluebeam**: Basics $260 / Core $330 / Complete $440 / Max $590 per gebruiker per jaar; geen perpetual meer; Revu 20 End of Support 31-07-2026, End of Life 31-12-2026 | **bevestigd** — alle vier de prijzen, het ontbreken van een eeuwigdurende optie én beide EOL-data letterlijk teruggevonden. De afgeleide rekensom (50 gebruikers = $13.000–29.500/jaar) is nagerekend en klopt | https://www.bluebeam.com/pricing/ |
| 12 | **Microsoft Project desktop**: Standard 2024 $679,99 en Professional 2024 $1.129,99 eenmalig; géén gepubliceerde prijs voor Project Server SE ("find a partner") | **bevestigd** — beide bedragen exact; de negatieve waarneming over Project Server SE en over Planner & Project Plan 3/5 is eveneens bevestigd (geen prijs op de vergelijkingspagina). Afgeleide $226/jaar over vijf jaar nagerekend: $1.129,99/5 = $226,00 | https://www.microsoft.com/en-us/microsoft-365/project/compare-microsoft-project-management-software |
| 13 | **MPXJ**: LGPL, één onderhouder (Jon Iles), leest XER/PMXML/MPP/MSPDI/Asta/P3/SureTrak e.a., schrijft MPX/MSPDI/PMXML/XER/Planner/SDEF, praat met Project Server, Microsoft Planner, P6 Web Services en Oracle Primavera Cloud; beschikbaar voor Java/.NET/Ruby/Python | **bevestigd** — alle onderdelen letterlijk juist, inclusief de vier server-/cloudkoppelingen en de schrijfformatenlijst. Licentie is inderdaad LGPL, dus compatibel met OPS' LGPL-3.0. *Kleine kanttekening:* ALICE Technologies staat vermeld als sponsor van MPXJ — dat versterkt de these in 9.2 en 11.1/K1 eerder dan dat het haar ondermijnt | https://www.mpxj.org/ |
| 14 | **Eleco 2025**: omzet £38,816 mln, wederkerend £31,313 mln (81%), diensten £6,958 mln (18%), eeuwigdurende licenties £545k (1%), ARR £34,281 mln (+29%), brutomarge 89,6%, NRR 110% (v.j. 109%), R&D £5,8 mln waarvan £3,5 mln geactiveerd, "post our SaaS financial transition", ruim tachtig ontwikkelaars, schuldenvrij | **bevestigd** — de volledige jaarrekening lokaal uitgelezen (120 pp.): omzettabel, ARR-tabel, NRR-passage, R&D-splitsing en het citaat *"This performance is post our SaaS financial transition"* alle letterlijk teruggevonden. Brutomarge herberekend uit brutowinst £34.782k/£38.816k = 89,6% ✓; ARR-groei 34.281/26.590 = +28,9% ✓ | https://ir.eleco.com/wp-content/uploads/2026/05/5770_Eleco-plc-Annual-Report-2025_Hyperlink.pdf |
| 15 | **Eleco's ISO 27001 als "verkoopvoorwaarde"** (sectie 12.2, punt 5) | **gecorrigeerd** — de certificering staat er wél (Elecosoft UK, BestOutcome, Pemac hercertificeerd), maar in de **cyberveiligheids- en governanceparagraaf**, niet als aanbestedings- of verkoopeis. Dat was interpretatie die als citaat werd gepresenteerd; herlabeld naar [AFGELEID] | idem |
| 16 | **Bentley Q1 2026**: omzet $424,2 mln (+14,5%), abonnementen $392,5 mln (+14,7%), ARR $1.494,5 mln tegen $1.319,3 mln, ARR-groei constante valuta 11,5%, NRR 109% tegen 110% | **bevestigd** — alle zes de cijfers exact, inclusief de daling van de netto-retentie van 110% naar 109%. Afgeleide "abonnementen 93% van Q1-omzet" nagerekend: 392,5/424,2 = 92,5% ✓ | https://investors.bentley.com/news-releases/news-release-details/bentley-systems-announces-first-quarter-2026-results |
| 17 | **Autodesk-verbouwing**: TD Synnex 39% → 33% → 14% van de netto-omzet over FY2024/25/26; personeel ~15.300 → ~14.300; Restructuring January 2026 Plan | **bevestigd** — alle drie de kanaalpercentages, beide personeelscijfers en het bestaan van het januari-2026-herstructureringsplan teruggevonden in het 10-K | https://www.sec.gov/Archives/edgar/data/769397/000076939726000015/adsk-20260131.htm |
| 18 | **Smartsheet delisting**: Form 25-NSE bij de SEC op 22 januari 2025 | **bevestigd** voor de delisting (accession 0000876661-25-000046, filing date 22-01-2025). **Onzeker** blijft — zoals het rapport zelf al aangaf — dat de kopers Blackstone en Vista waren voor $8,4 mrd; dat blijft [GEHEUGEN] en is in deze controle niet bevestigd | https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001366561&type=25 |
| 19 | **Open-source-CPM-leegte**: beste GitHub-treffer op `critical path method scheduling` heeft 43 sterren (alfonsodipace, MIT, laatste push 2019), daarna 10, 7, 5, 5 | **bevestigd** — de GitHub-zoek-API opnieuw bevraagd en de exacte reeks 43 / 10 / 7 / 5 / 5 gereproduceerd, met dezelfde toprepo, licentie (MIT) en laatste push (27-06-2019). De strategische conclusie in 12.1 A staat dus op geverifieerde grond | https://api.github.com/search/repositories?q=critical+path+method+scheduling&sort=stars |
| 20 | **Nemetschek vijfjaarstabel** (omzet 681,5 → 1.191,2 mln; licenties 234,8 → 55,9 mln; ARR 456,5 → 1.199,2 mln; EBITDA-marge 32,6% → 31,2%) en de afgeleide percentages −76,2% / 34,5% → 4,7% / +551% / +74,8% | **onzeker (rekenwerk bevestigd, brongetallen niet)** — alle vijf afgeleide percentages zijn herberekend en kloppen exact op de gepresenteerde invoer (−76,2%; 34,5%→4,7%; +550,5%≈+551%; +74,8%). De **brongetallen zelf** heb ik niet onafhankelijk kunnen bevestigen: het Geschäftsbericht-PDF gaf geen bruikbare tekstlaag terug en de IR-pagina's leverden 404 of alleen een documentindex. Ook het citaat "zum Großteil abgeschlossen" en het schrappen van ARR als stuurgetal blijven onbevestigd. Behandel sectie 4.1 als **niet-geverifieerd**, ook al is ze intern consistent | https://ir.nemetschek.com/en/financial-reports (index; onderliggende PDF niet uitleesbaar) |
| 21 | **Eenheidsfout**: "de totale omzet met 75% groeide naar €1.191,2 **mrd**" (sectie 1) | **gecorrigeerd** — factor 1.000 te hoog; moet €1.191,2 **mln** (≈ €1,19 mrd) zijn, zoals sectie 3.1 het wél correct schrijft | interne consistentiecontrole tegen 3.1 en 4.1 |
| 22 | **"De factor tussen $228 en $1.800 is ruim acht"** (sectie 5.4) | **gecorrigeerd** — 1.800/228 = **7,89**, dus *bijna* acht, niet ruim acht. Tegenover monday.com Standard ($144) is de factor wél 12,5× | herberekening |
| 23 | **"prijzen die anderhalf tot twaalf keer lager liggen"** (sectie 1) | **gecorrigeerd** — de bovengrens klopt (12,5×), maar de ondergrens "anderhalf" is uit geen enkele regel van de prijstabel in 5.4 af te leiden en is geschrapt | herberekening tegen tabel 5.4 |
| 24 | Overige doorgerekende schattingen: Trimble AECO-marge 34,2% ($512,1/$1.498,6 mln); Autodesk AECO 2,4× Bentley en ~2,4× Trimble AECO; Octave SaaS 22% van Q1-omzet en +1% omzetgroei; Eleco-koers "ruim een kwart" onder de 52-weekstop; MS Project $226/jaar over vijf jaar; Bluebeam 50 gebruikers $13.000–29.500 | **bevestigd** — alle zes herberekend: 34,17%; 2,39× en 2,39×; 21,9% en +0,97%; −25,6%; $226,00; $13.000–29.500. Kanttekening bij "ruim twee keer Trimble AECO": 2,39× is nauwkeuriger omschreven als "bijna tweeënhalf keer" | herberekening op de [HARD]-invoer |

### Wat de fact-check níét heeft kunnen doen

- **`WebSearch` was niet beschikbaar** (sessiebudget 200/200 verbruikt). Daarmee blijft precies dezelfde blinde vlek staan die het rapport zelf in 0.1 en sectie 10 benoemt: vakpers, gebruikersfora, aanbestedingsdata en analistenrapporten. De elf M&A-feiten uit sectie 2.3 (Primavera 2008, Aconex ~$1,2 mrd, Textura ~$663 mln, Vico 2012, TILOS 2018, Synchro 2018, Bluebeam 2014, RIB ~€1,4 mrd, Deltek ~$2,8 mrd, Smartsheet $8,4 mrd, EcoSys 2017) **blijven daardoor allemaal [GEHEUGEN]** en zijn in deze controle noch bevestigd noch weerlegd. Het rapport labelt ze correct; die labels moeten blijven staan.
- **Nemetschek** (zie #20) — de enige [HARD]-gelabelde tabel in het rapport die ik niet aan de bron heb kunnen toetsen.
- **Onzekerheid #7 uit sectie 10 (ISO 16739-1-editie)** blijft staan: `iso.org` is niet benaderd en de gelijkstelling "IFC 4.3.2 ≡ ISO IFC 4.3" leunt nog steeds op de buildingSMART-documentatiesite zelf. De *inhoudelijke* claims over `IfcWorkSchedule` en `IfcTaskTime` zijn wel direct in de schemadocumentatie geverifieerd (#4); alleen de ISO-nummering en editiedatum niet.
- **Oracle's prijsopaciteit** (sectie 5.2) is niet opnieuw getoetst — de bewering is een *negatieve* waarneming (nul Primavera-treffers in twee prijslijsten) en die is per definitie moeilijk te weerleggen zonder de PDF's opnieuw te tellen. De contractuele helft van sectie 5.2, die het zwaardere argument draagt, is wél volledig geverifieerd (#2).

### Slotoordeel

Van de 24 getoetste beweringen zijn er **16 bevestigd**, **6 gecorrigeerd** en **2 als onzeker gemarkeerd**. De correcties zijn zonder uitzondering rekenkundig of definitorisch — er is geen bewering gevonden die inhoudelijk het tegendeel bleek van wat het rapport beweert. Opvallend is dat de vier beweringen met het hoogste risico op nazeggerij — de Oracle-lifecycle-tabel, de Oracle-contractclausules, de Microsoft-EOL-datum en de IFC-normattributen — alle vier in de **originele normtekst** zijn nagelezen en alle vier letterlijk juist bleken. Dat is precies omgekeerd aan het gebruikelijke patroon, waarin normclaims het eerst sneuvelen.

De zwakste plek van het rapport is niet wat erin staat maar wat het rapport zelf al als zwak markeert: sectie 2.3 ([GEHEUGEN]), sectie 3.3 (Oracle C&E-omvang, factor twee bandbreedte) en sectie 6.2 (migratiebestemmingen zonder klantdata). Daar is met deze controle niets aan verbeterd — die blijven staan als expliciete hypothesen.

*Verificatie uitgevoerd 25 juli 2026. Alle bron-URL's op die datum opgehaald.*
