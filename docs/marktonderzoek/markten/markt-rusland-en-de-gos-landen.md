...
**Wisselkoers.** Roebelbedragen zijn primair; USD-omrekeningen zijn indicatief. Waar een bron zelf omrekent (bijv. Strategy Partners: 6 mld RUB ≈ $81 mln, impliciet ~74 RUB/USD) neem ik hun conversie over en noem ik dat. Waar ik zelf omreken gebruik ik **90 RUB/USD** als werkkoers en markeer ik dat als schatting. De roebel is sinds 2022 extreem volatiel geweest (van ~60 tot ~110 RUB/USD), waardoor USD-uitgedrukte marktomvang jaar-op-jaar sterk kan lijken te fluctueren zonder dat het reële volume verandert. Dat is een structureel meetprobleem in deze regio en de belangrijkste reden om roebels als basiseenheid te nemen.
...
2. **Maar de substitutie is oppervlakkiger dan de cijfers suggereren.** Microsoft Project bleef in 2024 nog steeds marktleider in Rusland, met een aandeel dat halveerde van 80% (2022) naar 43% (2024). ([TAdviser/Korus Consulting](https://korusconsulting.ru/upload/generated_pdf/rossiyskiy-rynok-sistem-upravleniya-proektami.pdf)) 53% van de ondervraagde grote Russische bedrijven was medio 2025 nog niet overgestapt op een Russisch systeem: 28% draait nog op buitenlandse software, 25% heeft überhaupt nog geen systeem. ([Naumen](https://www.naumen.ru/events/news/7454/))

3. **Oracle Primavera P6 is niet vervangen — het is bevroren.** Het segment "branchespecifieke oplossingen" is het minst ontwikkelde deel van de Russische softwaremarkt (≤9%, ~600 mln RUB in 2024) precies omdat er geen volwaardige Primavera-vervanger bestaat. [SECUNDAIR] ([IT-World](https://www.it-world.ru/it-news/c8cyg8jnfns4kk0sckoc8gwskkcco4o.html), Naumen-onderzoek) Grote opdrachtgevers draaien door op legacy-licenties in de wetenschap dat er geen updates meer komen.
...
5. **Rusland dwingt substitutie ook van binnenuit af.** Presidentieel decreet nr. 166 verbiedt buitenlandse software op kritieke informatie-infrastructuur vanaf 1 januari 2025; decreet 250 scherpt dat aan per 1 januari 2026. Aanbestedingsregime PP 1875 (23-12-2024) geeft registersoftware voorrang onder 44-FZ/223-FZ.
...
| Bouwspecifieke management-/ERP-software | 5,6 mld RUB | **6,4 mld RUB** (≈ $81 mln) | — (2027: >8 mld RUB / >$100 mln) | [Strategy Partners × Minstroj, aug. 2025](https://strategy.ru/media/uploads/2025/08/SP_Обзор_российского_ПО_по_управлению_строительными_проектами_август.pdf) |
...
- CAGR 2020–2024: **46% per jaar** ([Naumen](https://www.naumen.ru/events/news/7454/))
- Aandeel Russische leveranciers: **25% (2020) → 73% (2024)**
- Prognose 2025: markt ~+10%, Russische ontwikkelaars ≥1 mld RUB omzet (+24% t.o.v. 2024)
- Segment "branchespecifieke oplossingen": **≤9% van de markt, ~600 mln RUB in 2024** — expliciet toegeschreven aan het ontbreken van een volwaardige Oracle Primavera-vervanger [SECUNDAIR] ([IT-World](https://www.it-world.ru/it-news/c8cyg8jnfns4kk0sckoc8gwskkcco4o.html))
...
**Kazachstan.** Geen publiek beschikbare cijfers specifiek voor projectplanningsoftware. Macrocontext uit secundaire bronnen: de IT-dienstenmarkt zou in 2025 op ~2,9 biljoen tenge liggen (vanaf ~1,7 biljoen in 2024), de softwaremarkt op ~$3,6 mld met ~13,5% groei, en de ICT-beroepsbevolking overschreed 200.000 personen. **[SECUNDAIR, lage betrouwbaarheid]** — deze cijfers komen uit persoverzichten die ik niet tot een primaire statistiekbron heb kunnen herleiden; behandel ze als ordegrootte, niet als feit. Wat wel hard is: Kazachstan heeft **geen noemenswaardige inheemse planningssoftware**. Zoekwerk in het Russisch naar Kazachse eigen ontwikkelingen levert vooral implementatiepartners van westerse producten op (o.a. Conteq, dat Microsoft Project Online implementeert bij bouwbedrijven) en trainingsaanbieders voor Primavera P6 in Almaty en Astana (plan-fact.kz, pkplus.kz, CiscoTrain, STEX).
...
**Redenering, ondergrens.** Naumen's segment "branchespecifieke oplossingen" = ~600 mln RUB (2024) en wordt expliciet gekoppeld aan het Primavera-gat. Dat is echter alleen licentie-omzet van Russische leveranciers in dat segment; het telt legacy-buitenlandse licenties, trainingen en implementatieconsultancy niet mee.
...
- **PMSOFT** (grootste consultancy in dit domein, 30+ jaar actief) claimt **10.000+ gebruikers** van zijn oplossingen, **80.000 opgeleide specialisten** cumulatief, en **450+ projecten**. ([pmsoft.ru](https://www.pmsoft.ru/))
- **Spider Project** meldt "duizenden installaties" en werking in 37 landen. ([spiderproject.pro](https://www.spiderproject.pro/en/))
- **Vacaturemarkt**: op Russische jobboards staan op enig moment slechts enkele tientallen expliciete "специалист по календарно-сетевому планированию"-vacatures (DreamJob toonde er 8), met salarissen van **95.000–120.000 RUB/maand** voor een specialist in Moskou en tot **201.000 RUB/maand** voor een leidende specialist in Jamalo-Nenetsië. Werkgevers zijn o.a. de engineeringdivisie van Rosatom en RTI-Stroj.
...
| Presidentieel decreet **nr. 250** | — | Aanscherping per **1 januari 2026**, met direct verbod en concrete sancties voor buitenlandse informatiebeveiligingsmiddelen op КИИ. |
...
Wit-Rusland valt onder dezelfde EU- en VS-verboden als Rusland, maar koos een andere route: **wet nr. 241-З**, ondertekend **3 januari 2023** en in werking tien dagen na publicatie (6 januari 2023), staat het gebruik toe van digitale content uit "onvriendelijke landen" **zonder toestemming van de rechthebbende** — software, films, muziek, uitzendingen — en de invoer van goederen zonder toestemming van de rechthebbende.
...
| Grote bedrijven zónder PM-systeem | — | **25% (medio 2025)** |
| Illegaal gebruikte engineeringsoftware | 65% (2023) | **70% (2024)** [SECUNDAIR] |
...
Technische ondersteuning gedurende het eerste jaar is inbegrepen in de licentieprijs. ([spiderproject.ru/ru/pricelist](https://www.spiderproject.ru/ru/pricelist/) — site was tijdens onderzoek intermitterend onbereikbaar (HTTP 503); prijsgegevens komen daarom van reseller iesoft.ru en de internationale site.)
...
- **Interoperabiliteit:** volledige ondersteuning van Primavera P6- en MS Project-formaten; import/export **XER** en XLSX; open API
...
**Rekenvoorbeeld:** 10 gebruikers × 4.500 RUB × 12 = **540.000 RUB per jaar**. Vergelijk: 10 Spider Project Desktop-licenties = 1.550.000 RUB eenmalig (terugverdiend na ~2,9 jaar t.o.v. ADVANTA-SaaS). Dat is het kernverschil tussen de twee businessmodellen in deze markt.
...
- **Illegaal gebruik van engineeringsoftware steeg van 65% (2023) naar 70% (2024)** onder Russische ingenieurs die met westerse tools werken. De trigger: Autodesk blokkeerde in het voorjaar van 2024 AutoCAD-functionaliteit in Rusland, óók in gekraakte versies. [SECUNDAIR]
- **28%** van de bedrijven gebruikt ongelicentieerde buitenlandse software omdat er geen Russisch alternatief is; bijna **22%** ziet geen probleem in ongelicentieerde oplossingen. [SECUNDAIR]
...
| **PM.planner (PMSOFT)** | Enige expliciete P6-functievervanger; resultaten komen overeen met P6; getest op 150.000 activiteiten; XER-import/export; Astra Linux + PostgreSQL; registernrs. 26896/18887; open API; achter de grootste consultancy in het domein | Jong product met beperkte referentiebasis; prijs niet openbaar (drempel voor mkb); afhankelijk van consultancy-implementatie; leverancier heeft eigen Oracle-erfenis te managen |
...
1. **Het gat zit in de CPM-motor, niet in de PPM-schil.** Rusland heeft tientallen nieuwe PPM- en bouwplatformen gekregen, maar het segment "branchespecifieke oplossingen" blijft steken op 9% / 600 mln RUB juist omdat een volwaardige Primavera-vervanger ontbreekt. Alleen PM.planner en Spider Project spelen serieus in die klasse.

2. **Datamigratie is het aankoopcriterium, niet functionaliteit.** Het TAdviser-onderzoek zegt het letterlijk: mechanismen om data uit buitenlandse systemen over te zetten worden "een zwaarwegend argument bij de keuze". XER-, .mpp- en Excel-import zijn geen nice-to-have.
