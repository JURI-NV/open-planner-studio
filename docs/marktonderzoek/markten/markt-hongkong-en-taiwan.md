...
| | Hongkong | Taiwan |
|---|---|---|
| Bouwproductie (referentiejaar) | HK$286,6 mrd (2025) ≈ **US$36,5 mrd** | NT$754,3 mrd (2024, herzien) ≈ **US$23 mrd** (enge definitie) / US$77,8 mrd (brede definitie) |
| Bouwspecifieke Gantt/CPM-software (licenties+SaaS) | **US$5–8 mln/jr** | **US$4–6 mln/jr** (echte CPM-engines) |
| Incl. lokale PMIS/工程管理系統 met planningsmodule | n.v.t. (nauwelijks lokale pakketten) | **US$12–30 mln/jr** totaal |
| Incl. training + implementatieconsultancy | **US$7–12 mln/jr** | **US$18–45 mln/jr** |
| Totale PM-softwaremarkt (alle sectoren, incl. generieke SaaS) | **US$30–55 mln/jr** | **US$45–75 mln/jr** |
| Toegewijde planners (orde van grootte) | **1.300–1.700** | **300–800** (echte CPM-gebruikers) |
| Gelegenheidsgebruikers van planningstools | 5.000–10.000 | 5.000–15.000 |
...
- **Enge definitie (bouwwerken):** GlobalData's *Taiwan Construction Industry Databook 2024* (okt. 2024) raamde de sector op **TWD 784 miljard in 2024** (+4,0%), met een verwachte CAGR van 3,4% t/m 2028 (<https://www.businesswire.com/news/home/20241023420868/en/Taiwan-Construction-Industry-Databook-2024-Market-Size-Forecast-by-Value-and-Volume-Area-and-Units-2019-2028---ResearchAndMarkets.com>). Dat is ≈ US$24,2 miljard bij 32,35. **[GECORRIGEERD]** Dat was een *prognose*; GlobalData's opvolgrapport van april 2025 herziet de werkelijke waarde over 2024 naar **TWD 754,3 miljard** (≈ **US$23,3 mrd**), met TWD 922,6 mrd in 2029 (<https://www.globenewswire.com/news-release/2025/04/11/3059942/28124/en/Taiwan-Construction-Industry-Report-2025-Construction-Sector-is-Projected-to-Expand-from-its-2024-Value-of-TWD-754-3-Billion-to-TWD-922-6-Billion-by-2029.html>). Gebruik 754,3 als anker.
...
**Publieke werken.** Taiwan investeerde in **2024** NT$739,2 miljard (US$22,59 mrd) in publieke infrastructuur — destijds het hoogste bedrag in bijna 17 jaar (<https://www.taiwannews.com.tw/news/6042392>, gepubliceerd 21-02-2025). **[GECORRIGEERD — dit cijfer is achterhaald]** De NDC meldde in maart 2026 dat de regering **NT$800 miljard (US$26,2 mrd)** aan publieke infrastructuur besteedt in 2026 (<https://www.taiwannews.com.tw/news/6324105>). Het jaarlijkse anker groeit dus met ~4–5%/jaar; gebruik NT$800 mrd voor lopende ramingen. In 2025 werden 160 PPP-contracten getekend voor NT$380,7 miljard, ver boven het doel van NT$149,8 mrd (<https://www.mof.gov.tw/eng/singlehtml/f48d641f159a4866b1d31c0916fbcc71>). Het "Trillion NT Dollar Investment National Development Plan" loopt van 2025 tot 2028 (<https://english.ey.gov.tw/News3/9E5540D592A5FECD/aec5f2a0-6b7c-4ca1-8bf5-82116a08c0ab>), na het Forward-looking Infrastructure Development Program (2017-2025).
...
|---|---|---|---|
| P6 Professional/EPPM bij aannemers, Engineers, opdrachtgevers | ~825 seats (55% van 1.500 kernplanners) | US$1.470 | US$1,21 mln |
...
| **Subtotaal licenties + SaaS** | | | **US$5,2–7,7 mln** |
| Training + implementatie/consultancy gekoppeld aan de tools (30–60% van licentiespend) | | | **US$1,6–4,6 mln** |
| **Totaal HK bouwplanningsoftware + directe diensten** | | | **US$6,8–12,3 mln/jaar** (afgerond **US$7–12 mln**) |

> **[REKENCORRECTIE 25-07-2026]** De eerdere versie noemde een subtotaal van US$5,2–7,2 mln en een totaal van US$8–11 mln. De bovengrens telde niet op: 1,21 + 0,45 + 0,09 + 0,15 + 1,0 + 0,3 (4D, bovengrens 0,45) + 1,5 (risico) + 3,0 (enterprise) = **US$7,7 mln**, niet 7,2. En de ondergrens van het totaal kan per definitie niet boven subtotaal + minimale diensten (5,2 + 1,6 = 6,8) liggen. De marge is dus breder — en onzekerder — dan eerst gepresenteerd.
...
| Lokale PMIS/工程管理系統 met planningsmodule (孟華 ezteamwork/ePM, E-PMIS, 中程資訊, 高益, 鈞陽, J Project Master) — organisatielicenties | 800–2.000 betalende organisaties × NT$50k–300k/jr | — | US$1,2–18,5 mln (**zeer breed**) |
| Projectgebonden PMIS-uitrollen op publieke werken (0,05–0,1% van projectwaarde op de kopende subset van NT$800 mrd) | — | — | US$5–12 mln |
| 4D/BIM + AI-scheduling (nog embryonaal) | — | — | US$0,5–1,5 mln |
| **Subtotaal** | | | **US$10,4–36,7 mln** (werkbereik **US$12–30 mln**) |
| Training + implementatie (in Taiwan structureel een groter aandeel: lokale pakketten worden met maatwerk verkocht, 50–80%) | | | **US$6–24 mln** |
| **Totaal TW bouwplanningsoftware + directe diensten** | | | **US$18–45 mln/jaar** |

> **[REKENCORRECTIE 25-07-2026]** De eerdere versie noemde subtotaal US$12–25 mln en totaal US$18–40 mln. Twee fouten: (1) de PMIS-rij stond op US$3–12 mln, maar 800–2.000 organisaties × NT$50.000–300.000 geeft NT$40 mln–600 mln = **US$1,2–18,5 mln** — de opgegeven bandbreedte volgde niet uit de eigen aannames; (2) de bovengrens van het subtotaal telde op tot **US$30,2 mln** (0,7 + 2,0 + 2,0 + 12 + 12 + 1,5) bij de oude PMIS-rij, niet 25. Het volumeanker onder de projectgebonden rij is bovendien geactualiseerd van NT$739 mrd (2024) naar NT$800 mrd (2026). Conclusie: de Taiwanese raming is aanzienlijk onzekerder dan de oude ±2× marge suggereerde; behandel het als **orde van grootte US$10–35 mln licenties, US$18–45 mln inclusief diensten**.

**Kruiscontrole via de wereldmarkt.** De wereldwijde markt voor projectmanagementsoftware bedroeg volgens The Business Research Company **US$9,14 mrd in 2025**, groeiend naar US$10,51 mrd in 2026 (CAGR 14,9%) (<https://www.thebusinessresearchcompany.com/report/project-management-software-global-market-report>) — een eerdere versie van deze notitie noemde US$7,98 mrd (2024) → US$9,22 mrd (2025) zonder bron-URL; het 2025-cijfer klopt binnen 1%, de 2024-waarde is niet te verifiëren in de huidige editie. Een Chineestalige raming zet 2025 op ruim US$7,24 mrd met US$18,9 mrd in 2035 (CAGR ~10,7%) (<https://www.researchnester.com/tw/reports/project-management-software-market/4176>). Hongkong is ongeveer 0,35–0,45% van het wereld-BBP en heeft bovengemiddelde SaaS-adoptie → **US$30–55 mln** totale PM-softwaremarkt over alle sectoren. Taiwan is ~0,7% van het wereld-BBP maar heeft lagere SaaS-adoptie in het MKB en veel lokale substituten → **US$45–75 mln**. In beide gevallen is de bouwspecifieke Gantt/CPM-hoek dus **10–25% van de totale PM-softwaremarkt** — hoger in Hongkong (contractueel afgedwongen) dan in Taiwan.
...
- ~~Een Hongkongs werkencontract verwijst naar General Specification Section 6-I-B met "Provision of Primavera P6 Programming Software to the Engineer".~~ **[WEERLEGD 25-07-2026]** Dat document hoort bij het ADB-gefinancierde Davao Public Transport Modernization Project (CP01) in de **Filipijnen**, niet bij een Hongkongs contract (<https://groups.google.com/g/dptmp-cpd/c/z5JcLNTW4dE>). Deze bewijsregel vervalt.
...
| 4 | **Oracle Primavera P6** | Dure niche; per stuk aanbesteed | 交通部鐵道局, 高公局/捷運局-achtige bureaus, 中興工程顧問/台灣世曦-klasse consultants, petrochemie- en energie-EPC, ITER-achtige internationale programma's | NT$298.000 **底價** (2021) voor 2 seats ⇒ ~NT$149.000/seat ≈ US$4.600 — reserveprijs, geen gunningsprijs; 5 jaar oud |
...
**Bewijs voor de rangorde:**
- Concreet Taiwanees overheidstender: 交通部鐵道局, zaaknr. 110GY010, *"Primavera P6 PPM專業專案管理軟體2套"*, **底價 NT$298.000, gepubliceerd 15-06-2021** (<https://www.taiwanbuying.com.tw/ShowCCDetailOri.ASP?RecNo=4127119>). Twee licenties voor een heel spoorwegbureau illustreert de schaal. **[CAVEAT]** Het is de *reserveprijs*, niet de gunningsprijs (die staat achter een login), en het datapunt is uit 2021 — geen actueel prijsanker.
...
**De NEC-adoptie is compleet en verplicht in de praktijk.** De Development Bureau propageert sinds 2009 een "collaborative partnership"-benadering met NEC; per november 2024 hadden **meer dan 680 openbare werkencontracten met een totale waarde van meer dan HK$450 miljard** de NEC-vorm aangenomen (in juni 2024 stond de teller nog op 570 contracten / HK$380 mrd) (<https://www.nechk.gov.hk/>, <https://www.devb.gov.hk/en/publications_and_press_releases/publications/standard_contract_documents/practice_notes_nec_engineering_construction_contract/index.html>). Bevestigd in de DEVB-persverklaring van 28-11-2024: *"more than 680 public works contract, with a total value of over HK$450 billion, have adopted the NEC form"* (<https://www.info.gov.hk/gia/general/202411/28/P2024112700447p.htm>). Aanvullend gevonden bij de verificatie: NEC is sinds **2016 de standaardvorm voor overheidsprojecten boven HK$1 miljard**, en het NEC-aandeel in nieuwe publieke werken steeg van 22% (2017) naar 47% (2022), met >90% van de grote publieke werken in dat jaar op NEC-basis.

**Wat NEC contractueel doet met het programma:**
- De aannemer moet een programma ter acceptatie indienen; **zolang dat niet is gebeurd mag de Project Manager een kwart van de Price for Work Done to Date inhouden** — NEC4 **clausule 50.5** (NEC3: 50.3), en alléén als er geen programma in Contract Data deel 2 is geïdentificeerd; de retentie wordt vrijgegeven zodra het programma is ingediend en geaccepteerd (<https://www.pinsentmasons.com/out-law/analysis/time-and-programming-under-nec-in-hong-kong-sar>, <https://www.neccontract.com/support/faqs/retaining-monies-when-programme-not-accepted>).
...
**Het praktische gevolg voor softwarekeuze [AFGEZWAKT NA VERIFICATIE]:** er is *geen* Hongkong-brede wettelijke verplichting die P6 bij naam noemt. De DEVB-Scope schrijft wél software, sjablonen en rapportagestructuur voor, maar de enige verifieerbare bron daarvoor (NEC Planning Solutions) is **merkneutraal**: *"DEVB-standard Scope documents prescribe more than UK Scopes usually do: software, templates, reporting structure"* — zonder enige productnaam. De eerder aangehaalde clausule die de aannemer zou verplichten P6-licenties en -hardware aan de Engineer te leveren, hoort bij een **Filipijns** ADB-project en is hier geschrapt. Dat P6 in Hongkong moeilijk te verdringen is, blijft aannemelijk op grond van vacature-eisen, resellerkanaal en Engineer-praktijk — maar de bewering "contractueel afgedwongen bij naam" is **niet bewezen** en moet als open vraag worden behandeld tot een echte DEVB/MTR/AAHK-Scope is ingezien.
...
- **Float-eigendom — dit is de scherpste bepaling.** §1.6.2 opent met *"浮時屬於整個計畫所有"* (de float behoort aan het gehele project) en biedt daarna twee aanvinkopties: float wordt gezamenlijk beheerd na overeenstemming, óf **float is eigendom van de opdrachtgever** (*"業主擁有，但施工廠商得就工期影響提出說明與計算送工程司/監造廠商審查後由業主就核給"*) waarbij de aannemer impact moet onderbouwen ter beoordeling. En expliciet: *"(未勾選時為第二項)"* — **wordt niets aangevinkt, dan geldt automatisch optie twee: de opdrachtgever bezit de float.** [Verbatim geverifieerd uit de normtekst, 25-07-2026.] Ook wordt "float suppression" verboden: *"施工廠商不可濫用「浮時抑制技巧」"* (kunstmatige datumbeperkingen, opgerekte duren, niet-gecontracteerd werk).
...
| Sanctie bij niet-indienen | ¼ van de Price for Work Done to Date ingehouden (NEC4 **cl. 50.5**) | vervanging werfleider / opschorting 估驗款 |
...
2. **Taiwan is wél te winnen op prijs — maar alleen met Traditioneel Chinees en 01103-rapportages.** De markt bestaat uit 20.206 firma's waarvan het overgrote deel Excel gebruikt omdat P6 in de orde van NT$149.000/seat kost (afgeleid uit een 底價 van 2021) en MS Project NT$45.990 lijstprijs (retail lager, ~NT$44.800). Een tool die 桿狀圖 + 網圖 + 總浮時 + 價值曲線 + 電子檔 conform hoofdstuk 01103 produceert, in het Traditioneel Chinees, voor een fractie van die prijs, valt in een gat dat geen enkele bestaande speler bezet: de lokale PMIS-pakketten hebben geen CPM-hart, en de CPM-tools hebben geen 01103-rapportage.
...
- ~~Contractueel "Provision of Primavera P6 Programming Software to the Engineer", General Specification Section 6-I-B~~ — **WEERLEGD: dit is het Davao Public Transport Modernization Project (ADB, Filipijnen), geen Hongkongs contract**: <https://groups.google.com/g/dptmp-cpd/c/z5JcLNTW4dE>
...
**Uitgevoerd:** 25 juli 2026, adversariële fact-check. Opzet: van elke bewering is geprobeerd haar te *weerleggen* met onafhankelijke bronnen — andere dan de oorspronkelijk genoemde — plus narekenen van alle afleidingen. Beoordeeld: 16 falsifieerbare beweringen.

| # | Bewering | Oordeel | Bron |
|---|---|---|---|
| 1 | HK bouwproductie 2025 = HK$286,6 mrd; publiek HK$130,1 mrd (+10,2%), privaat HK$70,7 mrd (−16,9%), off-site HK$85,7 mrd (−1,9%) | **bevestigd** | Primaire bron letterlijk bevestigd én onafhankelijk kruisgecontroleerd met de Q1-2026-uitgave: Q1 2026 = HK$72,7 mrd (+2,9% j-o-j) ⇒ Q1 2025 ≈ HK$70,6 mrd, wat overeenkomt met de gerapporteerde HK$70,5 mrd; ook de sectorsplits lopen door (privaat −15,9%, publiek +17,8%). Componenten tellen op: 130,1+70,7+85,7 = 286,5. <https://www.info.gov.hk/gia/general/202606/11/P2026061100218.htm> |
| 2 | HK kapitaalwerkenuitgaven FY2025-26 = HK$119,8 mrd (61,9 gebouwen + 57,9 infra) | **bevestigd** | Onafhankelijk teruggevonden in het LegCo-antwoord van de Secretary for Development (9 juli 2025), incl. de detaillering consultancy 2,7% (~HK$3,2 mrd) en resident site staff 5,7% (~HK$6,8 mrd). <https://www.info.gov.hk/gia/general/202507/09/P2025070900640.htm> |
| 3 | NEC: >680 openbare werkencontracten, >HK$450 mrd | **bevestigd (en versterkt)** | Letterlijk in de DEVB-persverklaring van 28-11-2024. Aanvullend gevonden: NEC standaard voor overheidsprojecten >HK$1 mrd sinds 2016; aandeel 22% (2017) → 47% (2022). <https://www.info.gov.hk/gia/general/202411/28/P2024112700447p.htm>, <https://www.neccontract.com/news/nec-builds-on-its-first-10-years-in-hong-kong> |
| 4 | "Zolang het programma niet is ingediend mag de PM ¼ van de betaling inhouden" onder NEC clausule 31.2 | **gecorrigeerd** | De sanctie bestaat, maar staat in **clausule 50.5** (NEC4; 50.3 in NEC3), niet in 31.2 — en geldt alleen als er géén programma in Contract Data deel 2 is geïdentificeerd; de retentie vervalt bij acceptatie. Tekst in §1, §4.1 en §4.3 aangepast. <https://www.neccontract.com/support/faqs/retaining-monies-when-programme-not-accepted>, <https://www.fenwickelliott.com/research-insight/newsletters/insight/94> |
| 5 | Hongkongse contracten verplichten de aannemer P6-licenties en hardware aan de Engineer te leveren (General Specification Section 6-I-B) | **WEERLEGD** | De aangehaalde bron is géén Hongkongs document. Het is briefwisseling van de General Consultant van het **Davao Public Transport Modernization Project (CP01)**, een ADB-project in de **Filipijnen** ("DPTMP-GC-CP01-100-LTR-CT-000003 … Sub-Clause 110.1, Part II – Requirements, Section 6-I-B"). De enige verifieerbare uitspraak over HK-Scopes is merkneutraal: *"DEVB-standard Scope documents prescribe more than UK Scopes usually do: software, templates, reporting structure"* — zonder productnaam. De stelling "P6 contractueel bij naam afgedwongen in HK" is geschrapt; de zwakkere stelling (praktijk/Scope-druk) blijft staan. <https://groups.google.com/g/dptmp-cpd/c/z5JcLNTW4dE>, <https://www.necplanningsolutions.co.uk/post/hong-kong-nec4-ecc-programme-compliance> |
| 6 | Primavera P6 Professional ~US$3.500–3.520 perpetual + 22% support ⇒ effectief ~US$1.470/jaar | **bevestigd** | Meerdere onafhankelijke prijsbronnen bevestigen US$3.500 perpetual en 22% jaarlijkse maintenance. Narekening: 3.520/5 + 0,22 × 3.520 = 704 + 774 = **US$1.478/jaar** — de gebruikte US$1.470 klopt. <https://www.itqlick.com/primavera-p6/pricing>, <https://www.taradigm.com/how-much-does-primavera-p6-cost/> |
| 7 | MS Project Hongkong: HK$5.499 (Standard 2024) / HK$10.899 (Professional 2024) | **bevestigd** | Letterlijk op Microsofts eigen zh-hk-prijspagina teruggevonden. Narekening: HK$10.899 / 7,842082 = US$1.390; /5 jaar = US$278 ≈ de gebruikte US$280. <https://www.microsoft.com/zh-hk/microsoft-365/project/microsoft-project-enterprise-plans-and-pricing> |
| 8 | MS Project Taiwan: NT$27.290 (Standard) / NT$45.990 (Professional) | **onzeker** | Orde van grootte klopt, maar de *feitelijke* Taiwanese marktprijzen liggen lager en lopen uiteen: PChome NT$44.778 (Professional), Yahoo NT$27.300 (Standard), reseller 緯謙 NT$23.392 incl. btw (Standard). De genoemde bedragen zijn Microsoft-lijstprijzen, geen transactieprijzen; het effect op de raming (US$285/jaar geamortiseerd) is klein maar de prijs is niet één getal. <https://biggo.com.tw/s/microsoft+project>, <https://www.wiadvance.com/plan-article/microsoft-project-pricing/> |
| 9 | Asta Powerproject £880/jaar single user; >100.000 gebruikers wereldwijd; reseller-indicatie US$2.000/gebruiker/jaar | **bevestigd** | £880/jaar single-user subscription bevestigd; Elecosoft claimt zelf *"used by more than 100,000 professionals worldwide"*; ITQlick bevestigt onafhankelijk het US$2.000/gebruiker/jaar-punt. Narekening: £880 / 0,750545 = **US$1.172** — de gebruikte US$1.170 klopt. <https://elecosoft.com/us/products/asta/asta-powerproject/>, <https://www.itqlick.com/compare/asta-powerproject/microsoft-project> |
| 10 | Taiwan-norm 01103: geldt boven NT$1 mrd; eist WBS + 要徑法, 網圖 met 總浮時/要徑/relatietypes/lags, 價值曲線, elektronische bestanden, "施工廠商須有使用電腦排程軟體之人員"; float valt bij niet-aanvinken toe aan de opdrachtgever | **bevestigd (verbatim)** | Sterkste bevinding van deze check. De normtekst is uitgepakt en woordelijk gelezen. Kop: *"第 01103 章 進度管理 (適用於 10 億元以上及分開招標工程)"*. §1.5.1(1) letterlijk: *"施工廠商須有使用電腦排程軟體之人員"*. §1.6.2 letterlijk: *"浮時屬於整個計畫所有"* + twee aanvinkopties + *"(未勾選時為第二項)"*. §2.2.2 eist in het netwerk *"總浮時、要徑、關係形式及延時"*. Alle definities (WBS/桿狀圖/網圖/要徑法/總浮時/價值曲線) staan in §1.4. Merkneutraal: geen enkele productnaam in de hele tekst. Eén nuance toegevoegd: §1.6.2 begint met "float behoort aan het gehele project". <https://www.nlma.gov.tw/uploads/files/fb54d0531f35519de3dd4154b34346a6.pdf> |
| 11 | Taiwanese aanbesteding 交通部鐵道局 110GY010: NT$298.000 voor 2 P6-seats ⇒ ~NT$149.000/seat | **bevestigd met caveat** | De post bestaat en het bedrag klopt, maar twee kwalificaties ontbraken: het is de **底價 (reserveprijs)**, niet de gunningsprijs (die zit achter een login), en de zaak is **gepubliceerd op 15-06-2021** (ROC-jaar 110). Als *actueel* prijsanker voor 2026 is het datapunt vijf jaar oud. Toegevoegd in §1, §3.2 en §4.2. <https://www.taiwanbuying.com.tw/ShowCCDetailOri.ASP?RecNo=4127119> |
| 12 | Taiwan publieke infrastructuurinvestering NT$739,2 mrd (US$22,59 mrd), hoogste in bijna 17 jaar | **gecorrigeerd** | Het cijfer klopt maar betreft **2024**, gerapporteerd op 21-02-2025 — in het rapport stond geen jaartal. Het is inmiddels achterhaald: de NDC meldde op 19-03-2026 dat Taiwan **NT$800 mrd (US$26,2 mrd)** aan publieke infrastructuur besteedt in 2026. Het volumeanker in de Taiwanese bottom-up-tabel is hierop aangepast. <https://www.taiwannews.com.tw/news/6324105> |
| 13 | Taiwanese bouwsector 2024 = TWD 784 mrd (GlobalData) | **gecorrigeerd** | TWD 784 mrd was een **prognose** uit de databook van oktober 2024. GlobalData's opvolgrapport van april 2025 herziet de werkelijke waarde over 2024 naar **TWD 754,3 mrd** (−3,8%), met TWD 922,6 mrd in 2029. Samenvattingstabel en §2.2 aangepast. <https://www.globenewswire.com/news-release/2025/04/11/3059942/28124/en/Taiwan-Construction-Industry-Report-2025-Construction-Sector-is-Projected-to-Expand-from-its-2024-Value-of-TWD-754-3-Billion-to-TWD-922-6-Billion-by-2029.html> |
| 14 | Wisselkoersen 25-07-2026: USD 1 = HKD 7,8421 / TWD 32,3518 | **bevestigd** | Onafhankelijk opnieuw opgehaald bij twee aanbieders: er-api (25-07-2026 00:02 UTC) geeft HKD **7,842082**, TWD **32,35177**, GBP **0,750545**; Frankfurter (24-07-2026) geeft HKD **7,8426**. Afwijking <0,01%. <https://open.er-api.com/v6/latest/USD>, <https://api.frankfurter.dev/v1/latest?from=USD&to=HKD,GBP> |
| 15 | Hongkong wordt onder de EAR sinds 23-12-2020 behandeld als China, Country Group D:1 | **bevestigd, aangevuld** | De datum en de behandeling kloppen (BIS-regel onder EO 13936). Aanvulling: Hongkong valt onder Country Groups **D:1, D:3, D:4 én D:5**, niet alleen D:1, en stond voorheen in A:6 en B. Tekst in §4.1 aangevuld. Het afgeleide verkoopargument in §6.4 blijft interpretatie, geen feit. <https://sanctionsnews.bakermckenzie.com/commerce-department-removes-hong-kong-as-a-separate-destination-under-the-export-administration-regulations/>, <https://www.bis.gov/licensing/country-guidance/hong-kong-export-controls> |
| 16 | Wereldmarkt PM-software US$7,98 mrd (2024) → US$9,22 mrd (2025) volgens The Business Research Company; gebruikt als kruiscontrole voor HK US$30–55 mln en TW US$45–75 mln | **onzeker** | Het cijfer had géén bron-URL. De huidige TBRC-editie noemt **US$9,14 mrd voor 2025** → US$10,51 mrd in 2026 (CAGR 14,9%) — het 2025-cijfer klopt binnen 1%, het 2024-cijfer is in de actuele editie niet terug te vinden. De kruiscontrole zelf blijft een BBP-aandeel-benadering (HK ~0,4%, TW ~0,7% van het wereld-BBP) en is geen meting; de uitkomstbereiken zijn niet aangepast maar blijven als schatting gemarkeerd. <https://www.thebusinessresearchcompany.com/report/project-management-software-global-market-report> |

### Rekenfouten gevonden in de eigen bottom-up (§2.3)

Alle regels zijn narekend. Vier fouten en drie interne tegenstrijdigheden, alle gecorrigeerd in de tekst:

1. **HK-subtotaal bovengrens telde niet op.** 1,25 + 0,45 + 0,09 + 0,15 + 1,0 + 0,3 + 1,5 + 3,0 = **US$7,74 mln**, niet de gepresenteerde US$7,2 mln. → gecorrigeerd naar 5,2–7,7.
2. **HK-totaal was smaller dan zijn eigen componenten.** Subtotaal 5,2–7,7 plus diensten à 30–60% (1,6–4,6) geeft **US$6,8–12,3 mln**, niet US$8–11 mln. → gecorrigeerd.
3. **Taiwanese PMIS-regel volgde niet uit haar eigen aannames.** 800–2.000 organisaties × NT$50.000–300.000 = NT$40–600 mln = **US$1,2–18,5 mln**, terwijl de tabel US$3–12 mln toonde. → gecorrigeerd, met expliciete waarschuwing dat de spreiding ruim 15× is.
4. **Taiwan-subtotaal bovengrens telde niet op.** Met de oorspronkelijke regels: 0,7 + 2,0 + 2,0 + 12 + 12 + 1,5 = **US$30,2 mln**, niet US$25 mln. → gecorrigeerd.
5. **Percentage/seat-mismatch:** "55% van 1.500 kernplanners" = 825 seats, niet de gebruikte 850. → gecorrigeerd (effect US$0,04 mln).
6. **§1-samenvattingstabel weersprak §2.3 op drie punten:** Taiwan-diensten US$16–32 mln vs. US$18–40 mln; Taiwanese planners 500–1.500 vs. 300–800; Taiwanese gelegenheidsgebruikers 10.000–20.000 vs. 5.000–15.000. → §1 gelijkgetrokken met §2.3.

### Beweringen die niet te weerleggen én niet te bevestigen waren

- **De vacature-gebaseerde plannerschatting (HK 700–1.000 P6-gebruikers).** De rekensom klopt intern (15–20 gelijktijdige vacatures × 6 rondes/jaar ÷ 12,5% verloop = 720–960), maar berust op drie niet-verifieerbare aannames: dat de tellingen op JobsDB/CTgoodjobs/Indeed elkaar niet grotendeels overlappen, dat de gemiddelde vacatureduur ~2 maanden is, en dat het verloop 10–15% bedraagt. Geen van drieën is onderbouwd. Blijft **[SCHATTING]**, nu expliciet als zwakste schakel in de HK-raming.
- **Marktleiderschap P6 in Hongkong en MS Project/Excel in Taiwan.** Ondersteund door vacature-eisen, resellerkanaal en Chineestalige vergelijkingsartikelen — maar er bestaat geen marktaandeelmeting voor beide markten. Nu de contractuele merkverplichting is weerlegd (rij 5), rust de HK-claim uitsluitend op indirect bewijs. Behandel "de facto standaard" als plausibele interpretatie, niet als gemeten feit.
- **Piraterij-/informele-licentiecijfers, en de bewering dat Taiwanese halfgeleiderklanten cloud-planningstools mijden.** Beide waren al als schatting gemarkeerd; er is opnieuw geen publieke bron gevonden. Ongewijzigd **[SCHATTING]**.

### Eindoordeel

De **feitelijke ankers zijn robuust**: HK-bouwstatistiek, HK-kapitaalwerken, NEC-volume, de Taiwanese norm 01103 (verbatim geverifieerd), de internationale lijstprijzen en de wisselkoersen kwamen allemaal ongeschonden uit een gerichte weerleggingspoging. Twee anker*jaren* waren verouderd (Taiwanese publieke infrastructuur, Taiwanese bouwproductie) en zijn bijgewerkt.

De **redenering is op twee plaatsen zwakker dan gepresenteerd**. Ten eerste is het scherpste bewijsstuk voor de kernthese over Hongkong — "de contractvorm dwingt P6 bij naam af" — een verkeerd geattribueerd Filipijns document; die these moet worden teruggebracht tot "de Scope dwingt software-, sjabloon- en rapportage-eisen af, merkneutraal". Ten tweede bevatte de bottom-up-raming vier optel-/afleidingsfouten die de bovengrenzen systematisch te laag en de ondergrenzen te hoog lieten uitkomen, waardoor de marges **smaller** oogden dan de aannames rechtvaardigen. Na correctie: HK **US$7–12 mln/jaar**, Taiwan **US$18–45 mln/jaar** voor bouwplanningsoftware inclusief directe diensten — en dat blijft een orde-van-grootte, geen meting.
