...
1. **Oracle Primavera P6 is de facto monopolist in het planningsdeel.** Het Amerikaanse ministerie van Energie noemt Primavera P6 expliciet in zijn lijst van EVM-softwaretools ([DOE Office of Project Management](https://www.energy.gov/projectmanagement/earned-value-management-evm-software-tools)) [A]; het DOE-laboratorium INL constateert onomwonden dat het buiten de scope van zijn eigen optimalisatieproject valt om planningstools te bouwen "as plant owners already rely on tools such as Primavera P6" ([INL/RPT-24-80380, §3](https://lwrs.inl.gov/content/uploads/11/2024/10/OutageOptimization.pdf)) [A]; en Oracle Primavera P6 staat op de DOE-lijst van EVM-softwaretools [A].

   > **[GECORRIGEERD na verificatie — 25-07-2026]** De oorspronkelijke versie van deze bevinding stelde dat "Amerikaanse federale bouwspecificaties (UFGS 01 32 01.00 10 / USACE) P6 en het XER-formaat contractueel voorschrijven". **Dat is onjuist.** De geldende tekst van [UFGS 01 32 01.00 10 (USACE/NAVFAC/AFCEC, aug. 2023, Change 1 aug. 2024)](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf) zegt letterlijk: §2.1.1 "The Government uses Primavera P6" (default van de *opdrachtgever*), en §2.1.2.2 **"Other Than Primavera"**: "If the Contractor chooses software other than Primavera P6, that is compliant with this specification, provide for the Government's use two licenses, two computers, and training for two Government employees in the use of the software." De ontwerpersnotitie bij de spec stelt zelfs expliciet: *"Use of proprietary systems will not be specified."* Wat wél verplicht is, is de **SDEF-activiteitencoderingsstructuur** uit ER 1-1-11 ("This exact structure is mandatory.", §3.3.7) — een open, gepubliceerd vastebreedte-formaat. XER wordt alleen genoemd als vóórbeeld ("in the format of the scheduling software (e.g. .xer)", §3.5.1) en is alleen verplicht *indien* de aannemer P6 kiest (§2.1.2.1). Het kopje "PRIMAVERA P6 MANDATORY REQUIREMENTS" (§3.12) betreft **P6-instellingen** die gelden als P6 gebruikt wordt, geen verplichting om P6 te gebruiken. Bovendien: UFGS is een **DoD**-bouwspecificatie (militaire bouw/civil works), geen energiesector-inkoopdocument — het als bewijs voor deze sector opvoeren is een categoriefout. Zie §7.4 en de Verificatie-sectie.
...
4. **Segmentomvang [SCHATTING — HERZIEN 25-07-2026]:** circa **1,05–1,75 miljard USD per jaar (2025)**, middenwaarde **≈ 1,4 mld USD**, aan software plus direct gerelateerde implementatie/support voor planning en projectbeheersing in energie, nutsbedrijven en nucleair wereldwijd; groei circa 8–12% per jaar, gedreven door netinvesteringen (>400 mld USD/jaar) en de nucleaire heropleving (79 reactoren in aanbouw). *De oorspronkelijke opgave was 1,25–1,75 mld met middenwaarde 1,5 mld; die volgde niet uit de eigen berekening en berustte deels op een te hoge capexbasis in Component D en op een ongeldige top-downkruiscontrole. De top-downcontrole wijst na correctie eerder naar 1,0–1,2 mld.* Volledige redenering én de correcties in **§6.2**.
...
| ENTSO-E-projecten grensoverschrijdend/offshore tot 2050 | ~~**> €800 mld**~~ **[ONBEVESTIGD — waarschijnlijk te hoog]** | Niet reproduceerbaar. Wat wél te verifiëren viel: ENTSO-E's Offshore Network Development Plans noemen "**a total investment of upward of 400 billion euros**" voor offshore transmissie-assets, en TYNDP 2024 noemt **€13 mld/jaar** voor grensoverschrijdende net- en opslagcapaciteit tot 2050 (≈ €340 mld cumulatief). Behandel €800 mld als **onbevestigd**; gebruik €400 mld (offshore) als het verdedigbare cijfer ([ENTSO-E-synthese](https://lite.duckduckgo.com/lite/?q=ENTSO-E+TYNDP+2024+projects+total+investment+billion+euros+offshore+network+development+plan+value)) [B] |
...
> **[VERIFICATIE-KANTTEKENINGEN bij deze drie getallen, 25-07-2026]**
> - ENTSO-E **40 leden uit 36 landen**: primair bevestigd, letterlijk "40 Members from 36 countries are part of ENTSO-E" ([ENTSO-E](https://www.entsoe.eu/about/inside-entsoe/members/)) [A].
> - EU DSO Entity **~800–850**: bevestigd, maar dit is het **ledental van de EU DSO Entity**, niet het totale aantal DSO's in de EU. Dat laatste ligt hoger (in EU-materiaal circuleert de orde van ~2.000–2.400 DSO's, overwegend zeer klein). Voor de seat-berekening in §6.2 is dat gunstig noch ongunstig — de operatieve aanname daar is "1.000 organisaties groot genoeg voor een echte stack", niet het totaal.
> - EIA **~3.200**: **niet primair bevestigd.** De onafhankelijke controle leverde alleen een Statista-formulering op ("around 3,000 electric utility companies") die niet rechtstreeks aan EIA is toe te schrijven, en geen EIA-brondocument met 3.200. Behandel als **onzeker [C]**, orde van grootte ~3.000.
...
10.000–18.000 activiteiten in 2–3 weken kalendertijd ([INL](https://lwrs.inl.gov/content/uploads/11/2024/10/OutageOptimization.pdf)) [A] betekent een activiteitsdichtheid van ruwweg **475–1.300 activiteiten per dag** (10.000/21 dagen ≈ 476 aan de ondergrens; 18.000/14 dagen ≈ 1.286 aan de bovengrens). *[GECORRIGEERD: het rapport gaf eerder 500–900/dag; dat komt uit het delen van beide uitersten door ~20 dagen en onderschat de bovengrens met circa 40%. Het argument wordt door de correctie sterker, niet zwakker.]* Ter vergelijking: een grote kantoorbouwplanning heeft doorgaans enkele duizenden activiteiten over jaren. Dit stelt harde eisen aan rekenprestaties van de CPM-solver, aan renderen van de Gantt bij tienduizenden balken, en aan filtering/lay-outbeheer.
...
- **[GECORRIGEERD 25-07-2026 — primaire bron gelezen]** Amerikaanse federale bouwspecificatie **UFGS 01 32 01.00 10 "Project Schedule"** (USACE/NAVFAC/AFCEC, 08/23 Chg 1 08/24) verplicht **niet** Primavera P6. Verplicht is (a) **CPM met Precedence Diagram Method** (§3.1), (b) de **SDEF-activiteitencoderingsstructuur** uit **ER 1-1-11** — "Use the activity coding structure defined in the Standard Data Exchange Format (SDEF) in ER 1-1-11. **This exact structure is mandatory.**" (§3.3.7), en (c) cost-loaded activiteiten als betalingsgrondslag (§3.2). Software is vrij: §2.1.2.2 "Other Than Primavera" staat andere pakketten toe, mits de aannemer de opdrachtgever twee licenties, twee stand-alone computers en training voor twee medewerkers levert. Alleen *als* P6 wordt gekozen geldt de xer-export (§2.1.2.1) en de instellingenlijst van §3.12 — waaronder wél, letterlijk bevestigd: "**Activity Codes must be Project Level, not Global or EPS level**", "Calendars must be Project Level, not Global or Resource level", duration type "Fixed Duration & Units", percent complete "Physical", kritieke pad via "**Longest Path**", voortgang via "**Retained Logic**" ([UFGS 01 32 01.00 10, PDF](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf)) [A]. Let op dat dit een **DoD**-spec is en dus hooguit analoog bewijs voor de energiesector.
...
**[SCHATTING — REKENFOUT GECORRIGEERD 25-07-2026]** De oorspronkelijke zin luidde: "verdient zich terug als het één outagedag per *decennium* bespaart voor een team van 300 planners". Dat klopt niet, en wel met een factor 10. Nareken: 300 planners × 4.000 USD = **1,2 mln USD per jaar**, dus 12 mln USD per decennium; één bespaarde outagedag levert **1,2 mln USD** op ([INL](https://lwrs.inl.gov/content/uploads/11/2024/10/OutageOptimization.pdf)) [A]. De juiste formulering is dus: **de jaarlijkse licentie-uitgave van een 300-koppig plannersteam is exact gelijk aan één outagedag** — het verdient zich terug bij één bespaarde outagedag **per jaar**, niet per decennium. De strekking (zeer gunstige verhouding) blijft overeind; de marge is alleen 10× kleiner dan beweerd. De vervolgzin "feitelijk is de terugverdientijd in deze sector *uren*" is een onbewezen retorische claim en is als zodanig gemarkeerd. Dit is de reden dat prijsdruk op de scheduler zelf vrijwel afwezig is — en dat "gratis" als argument hier nauwelijks werkt.
...
|---|---|---|---|---|
| **1** | **Primavera P6 (EPPM + Professional)** | Oracle | De facto standaard. Owner-baseline, contractuele leveringsformaat (XER), outageplanning, T&D-portfolio | [DOE EVM-toolslijst noemt Oracle Primavera P6](https://www.energy.gov/projectmanagement/earned-value-management-evm-software-tools) [A]; [INL: "plant owners already rely on tools such as Primavera P6"](https://lwrs.inl.gov/content/uploads/11/2024/10/OutageOptimization.pdf) [A]; ~~UFGS/USACE-verplichting~~ **geschrapt: UFGS verplicht P6 niet** (zie §3.4/§7.4) |
...
> **[GECORRIGEERD 25-07-2026 — de capexbasis is te hoog gekozen]** De 1,5 biljoen USD is afgeleid van de IEA-post "2,2 biljoen USD schone energie". Die post is echter géén opwek-bouwcapex: de IEA omschrijft hem als "renewables, nuclear, **grids**, storage, low-emissions fuels, **efficiency and electrification**" — dus inclusief netten (die hier al als Component C zijn geteld), nucleair (Component B) én eindgebruik/efficiëntie/elektrificatie (warmtepompen, EV's, gebouwschil), die geen CPM-projectplanning bij een energiebedrijf voortbrengen ([IEA WEI 2025-synthese](https://lite.duckduckgo.com/lite/?q=IEA+World+Energy+Investment+2025+renewable+power+generation+investment+billion+solar+wind+battery+storage+2025)) [B]. De werkelijk relevante bouwcapex voor Component D is de opwek- en opslagcapex: zon-PV ≈ **450 mld USD** (2025), batterijopslag ≈ **66 mld USD**, plus wind, waterkracht, thermische opwek en waterstof — samen realistisch **0,8–1,0 biljoen USD**, niet 1,5 biljoen. Er zit dus zowel een **dubbeltelling** met Component B en C in als een insluiting van niet-relevante eindgebruikcapex.
>
> Herberekend bij 0,9 biljoen USD × 0,01–0,03% = **90–270 mln USD/jaar**. Merk bovendien op dat de oorspronkelijke bandbreedte al intern inconsistent was: 1,5 biljoen × 0,01–0,03% geeft 150–450 mln, niet de geboekte 200–400 mln.
>
> **Gecorrigeerde Component D ≈ 90–270 mln USD/jaar** (was 200–400). Dit verlaagt het software-subtotaal met circa 110–130 mln USD aan de ondergrens en 130 mln aan de bovengrens.
...
> **[ONZEKER — de percentageregel en het bedrag sluiten niet op elkaar aan]** Als "de schedulinglaag" A+D is (630–975 mln oorspronkelijk), geeft 20–30% **126–293 mln**, niet de geboekte 100–180 mln. Als het alleen de *zuivere scheduler*-omzet betreft, is die in dit model veel kleiner (Component A bevat maar 15 mln scheduler) en zou E in de orde van tientallen miljoenen liggen. De grondslag van de 20–30% is dus niet gedefinieerd en het geboekte bedrag is niet uit de regel af te leiden. Het bedrag is niet gecorrigeerd (er is geen betere basis), maar moet als **zwak onderbouwd** worden gelezen — het is de op één na slechtst onderbouwde component na D.
...
**[NAGEREKEND 25-07-2026]** De optelling zelf klopt: 120+100+210+200+100 = 730 en 200+115+260+400+180 = 1.155; × 0,7 = 511 resp. 809; totalen 1.241 resp. 1.964. **Maar de eindschatting die hieronder volgde, kwam niet uit deze tabel.**

**Gecorrigeerde tabel met de herziene Component D (90–270 i.p.v. 200–400):**

| Component | Ondergrens (mln USD/jaar) | Bovengrens (mln USD/jaar) |
|---|---|---|
| A. Nucleaire bedrijfsvoering | 120 | 200 |
| B. Nucleaire nieuwbouw + ontmanteling | 100 | 115 |
| C. Netten (T&D) | 210 | 260 |
| D. Opwek, hernieuwbaar, opslag **[gecorrigeerd]** | **90** | **270** |
| E. Kwaliteits-, risico-, 4D-, compliancelagen **[zwak onderbouwd]** | 100 | 180 |
| **Totaal software** | **620** | **1.025** |
| Directe dienstverlening (× 0,7) | 434 | 718 |
| **Totaal segment** | **≈ 1,05 mld** | **≈ 1,74 mld** |

**Eindschatting [SCHATTING — GECORRIGEERD]:**

> **[GECORRIGEERD]** De oorspronkelijke eindschatting luidde "**circa 1,25–1,75 miljard USD**, middenwaarde ≈ 1,5 miljard". Twee problemen: (1) die bandbreedte volgde **niet** uit de eigen tabel, die 1,24–1,97 mld gaf — de bovengrens was zonder motivering met 0,22 mld (11%) verlaagd, en de middenwaarde van 1,24–1,97 is 1,61 mld, niet 1,50; (2) Component D was te hoog (zie hierboven).
>
> Na correctie van beide: **het segment is wereldwijd circa 1,05–1,75 miljard USD per jaar in 2025**, waarvan ongeveer **0,62–1,03 miljard USD zuivere software** (was: 0,75–1,15) en de rest directe implementatie, configuratie, integratie en training.
>
> Middenwaarde: **≈ 1,4 miljard USD (2025)** — met de nadrukkelijke kanttekening dat de top-downcontrole hieronder eerder naar de **onderkant** van dit bereik wijst dan naar het midden.

**Kruiscontrole tegen de top-down cijfers — [GECORRIGEERD 25-07-2026, de oorspronkelijke controle was ongeldig]:**

De oorspronkelijke tekst stelde: "de totale PPM-**software**markt is 5,7 mld USD (2024); 0,9 mld zou circa **16%** zijn; dat is plausibel." Daar zitten twee fouten in die elkaar niet opheffen.

1. **Noemerfout.** De 5,7 mld USD van Grand View Research is de **totale PPM-markt inclusief diensten**, niet software alleen. Dat blijkt uit het rapport zélf: §6.1 hierboven noteert "Softwareaandeel binnen PPM > 67% van de omzet (rest = diensten)". De PPM-**software**markt is dus ≈ 5,7 × 0,67 ≈ **3,8 mld USD**. Het aandeel wordt daarmee 0,9 / 3,8 ≈ **24%**, niet 16%. Dat is buiten elk geloofwaardig bereik voor één sector in een markt waarin IT, financiële dienstverlening, telecom, farma, overheid en de bredere bouw allemaal grote afnemers zijn.
2. **Tellerfout (in tegengestelde richting).** De teller bevat posten die per definitie **niet** in de PPM-marktafbakening vallen: Component A bestaat voor 105–185 mln USD uit **EAM/werkbeheer** (Asset Suite, Maximo, eSOMS) en STO-orkestratie. Analisten tellen die in de EAM-markt, niet in PPM. Netto voor PPM-vergelijkbare omzet blijft ruwweg 0,45–0,85 mld over → **12–22% van de PPM-softwaremarkt**. Nog steeds hoog.

**Conclusie van de kruiscontrole (omgekeerd t.o.v. het origineel):** de top-downcontrole **bevestigt de bottom-upraming niet — hij zet er druk op**. Zij is alleen houdbaar als men aanneemt dat (a) energie/nutsbedrijven/nucleair werkelijk ~1 op de 5 dollars in projectplanningssoftware wereldwijd uitgeeft, en (b) een aanzienlijk deel van de geraamde omzet buiten de PPM-marktdefinitie valt en dus niet dubbel geteld wordt. Beide zijn verdedigbaar maar geen van beide is aangetoond. **Behandel de middenwaarde van 1,4 mld USD als een bovengrensachtige indicatie; een raming rond 1,0–1,2 mld USD is met de beschikbare data even goed te verdedigen.**

Als tweede anker: de "Shutdown & Turnaround Optimization Software"-markt is 1,42 mld USD (2024) → 3,44 mld USD (2033), CAGR 10,2%, over **alle** industrieën, met olie & gas als grootste segment en power generation als deelsegment ([Growth Market Reports](https://growthmarketreports.com/report/shutdown-and-turnaround-optimization-software-market), primair geverifieerd 25-07-2026; regio's 540 + 420 + 300 + 90 + 70 = 1.420 mln, intern consistent) [C]. Dit anker is bevestigd, maar het overlapt maar gedeeltelijk met Component A en kan de raming niet dragen.
...
|---|---|---|
| **SDEF** (Standard Data Exchange Format, ER 1-1-11 App. A) | **Het enige echt verplichte formaat/structuur in UFGS 01 32 01.00 10**: "This exact structure is mandatory" (§3.3.7). Open, gepubliceerd, vastebreedte-ASCII — leverancieronafhankelijk | [UFGS 01 32 01.00 10](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf) [A] |
| **Primavera XER** | **[GECORRIGEERD]** *niet* verplicht in UFGS 01 32 01.00 10 — daar alleen genoemd als voorbeeldformaat ("e.g. .xer", §3.5.1) en verplicht louter indien de aannemer zelf P6 kiest (§2.1.2.1). Wél breed als de facto contractuele eis bij private owners en EPC's, maar dat is niet met een primaire bron in deze sector aangetoond | [UFGS 01 32 01.00 10](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf) [A]; de-facto-claim = [S], onbevestigd |
...
USACE-specifieke P6-configuratie-eisen die worden afgedwongen **wanneer P6 wordt gebruikt** (§3.12, letterlijk geverifieerd): activity codes Project Level (niet Global/EPS), kalenders Project Level (niet Global/Resource), duration type "Fixed Duration & Units", percent complete "Physical", admin preferences op 8,0 uur/dag – 40 uur/week – 172 uur/maand – 2000 uur/jaar, kritieke activiteiten via "Longest Path", progressie via "Retained Logic" ([UFGS 01 32 01.00 10](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf)) [A]. De eerder gerapporteerde "**.xer-backuptemplate van de opdrachtgever**" staat **niet** in deze spec en is als claim ingetrokken.

> **Strategische consequentie van deze correctie (belangrijk).** De US-federale poort is niet "P6 of niets", maar "CPM/PDM + SDEF-codering + cost loading + twee licenties voor de opdrachtgever". SDEF is een **open, gepubliceerd formaat**. Voor een open-source planner betekent dit dat de zwaarst gereglementeerde Amerikaanse bouwspecificatie feitelijk een **gedocumenteerd, implementeerbaar toelatingspad** biedt in plaats van een leveranciersslot. Dat is een wezenlijk gunstiger uitgangspunt dan het oorspronkelijke rapport schetste — en het versterkt §9.6 (DCMA-14 is rekenwerk) eerder dan dat het dat tegenspreekt.
...
- **Contractueel geaccepteerd.** XER is de facto de lingua franca; wie P6 gebruikt, hoeft over het leveringsformaat zelden te onderhandelen. **[GECORRIGEERD]** De eerdere formulering "de USACE-specificatie schrijft het letterlijk voor" is onjuist — UFGS 01 32 01.00 10 staat expliciet niet-Primavera-software toe (§2.1.2.2) en verplicht alleen de SDEF-coderingsstructuur ([UFGS](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf)) [A]. Het voordeel is dus *gewoonterecht en ecosysteem*, geen juridisch monopolie.
...
**Uitgevoerd:** 25 juli 2026 door een adversariële fact-checker (aparte subagent), met als opdracht de belangrijkste falsifieerbare beweringen actief te **weerleggen**, niet te bevestigen.

**Methode en beperking.** Het WebSearch-budget van de sessie was uitgeput (200/200), net als bij het oorspronkelijke onderzoek. Alle controles zijn daarom via WebFetch gedaan: waar mogelijk **rechtstreeks op de primaire bron** (dat lukte voor WNA, ENTSO-E, DOE, Growth Market Reports, AKIM en — belangrijk — de volledige UFGS-specificatie en het INL-rapport, beide als PDF opgehaald en lokaal met `pypdf` naar tekst geconverteerd zodat letterlijke passages gecontroleerd konden worden), en anders via `lite.duckduckgo.com`. `grandviewresearch.com`, `iea.org` en `eurelectric.org` gaven 403 en zijn via secundaire wegen gedekt.

**Uitkomst in één zin:** de *feitelijke, brongebonden* cijfers in dit rapport zijn opvallend solide — vrijwel alles wat aan een primaire bron is gehangen, is letterlijk teruggevonden. De *eigen redenering* is dat niet: de belangrijkste marktbewering (P6 contractueel verplicht) is weerlegd, en de segmentraming bevat een te hoge capexbasis, een ongeldige top-downcontrole en een rekenfout van een factor 10 in het terugverdienargument.

### Oordeel per bewering

| # | Bewering | Oordeel | Bron |
|---|---|---|---|
| 1 | **UFGS 01 32 01.00 10 / USACE schrijft Primavera P6 en het XER-formaat contractueel voor** (§1 bevinding 1, §3.4, §4.1, §7.4, §8.1) | **GECORRIGEERD — weerlegd** | Volledige spec opgehaald en gelezen. §2.1.2.2 **"Other Than Primavera"** staat andere software expliciet toe; ontwerpersnotitie: *"Use of proprietary systems will not be specified."* Verplicht is de **SDEF**-coderingsstructuur uit ER 1-1-11 ("This exact structure is mandatory", §3.3.7) — een open formaat. XER staat er als voorbeeld ("e.g. .xer") en geldt alleen als de aannemer zelf P6 kiest. "PRIMAVERA P6 MANDATORY REQUIREMENTS" (§3.12) zijn P6-*instellingen*, geen gebruiksplicht. Bovendien is UFGS een **DoD**-spec, geen energiesector-document. → [UFGS 01 32 01.00 10, aug. 2023 Chg 1 08/24](https://www.wbdg.org/FFC/DOD/UFGS/UFGS%2001%2032%2001.00%2010.pdf) |
| 1b | Deelclaims bij het bovenstaande: activity codes Project Level (niet Global/EPS), kalenders Project Level | **BEVESTIGD** (letterlijk) — maar alleen van toepassing wanneer P6 wordt gebruikt | idem, §3.12 a/b |
| 1c | "Opdrachtgever levert een .xer-backuptemplate" | **WEERLEGD** — staat niet in de spec; claim ingetrokken | idem |
| 2 | **Segmentomvang 1,25–1,75 mld USD, middenwaarde 1,5 mld** | **GECORRIGEERD → 1,05–1,75 mld, middenwaarde ≈1,4 mld** | Nagerekend. De optelling zelf klopt (730/1.155 → ×0,7 → 1,24/1,97 mld), maar de gepubliceerde bandbreedte volgde er niet uit: de bovengrens was zonder motivering met 11% verlaagd en de middenwaarde van 1,24–1,97 is 1,61, niet 1,50. Plus de correctie op Component D (#3). |
| 3 | **Component D: 1,5 biljoen USD relevante bouwcapex × 0,01–0,03% = 200–400 mln** | **GECORRIGEERD → 90–270 mln** | De 1,5 biljoen is afgeleid van de IEA-post "2,2 biljoen schone energie", die volgens de IEA "renewables, nuclear, **grids**, storage, low-emissions fuels, **efficiency and electrification**" omvat — dus inclusief netten (al geteld als Component C), nucleair (Component B) én eindgebruik/efficiëntie/EV's die geen CPM-planning voortbrengen. **Dubbeltelling + niet-relevante capex.** Reële opwek-/opslagcapex ≈ 0,8–1,0 biljoen (zon-PV ≈ 450 mld, batterijopslag ≈ 66 mld in 2025). Bijkomend: 1,5 biljoen × 0,01–0,03% geeft 150–450, niet de geboekte 200–400. → [IEA WEI 2025-synthese](https://lite.duckduckgo.com/lite/?q=IEA+World+Energy+Investment+2025+renewable+power+generation+investment+billion+solar+wind+battery+storage+2025) |
| 4 | **Top-downcontrole: 0,9 mld = "circa 16% van de wereldwijde PPM-softwaremarkt", plausibel** | **GECORRIGEERD — de controle was ongeldig** | Grand View's 5,7 mld is de **totale** PPM-markt inclusief diensten; het rapport noteert zelf in §6.1 dat software >67% is. PPM-**software** ≈ 3,8 mld → aandeel **24%**, niet 16%. Tegelijk bevat de teller 105–185 mln aan **EAM/werkbeheer** (Asset Suite, Maximo, eSOMS) dat niet in de PPM-afbakening valt. Netto 12–22%. De kruiscontrole **steunt de raming niet, maar zet er druk op** — een raming van 1,0–1,2 mld is even goed verdedigbaar. |
| 5 | **PPM-markt 5,7 mld (2024) → 12,3 mld (2030), CAGR 14,2% (Grand View Research)** | **BEVESTIGD** (cijfer als zodanig) | Letterlijk teruggevonden: "The global project portfolio management market size was estimated at USD 5.7 billion in 2024". Kanttekening: concurrerende ramingen lopen sterk uiteen (Strategic Market Research 5,9→10,8 mld @10,6%; GII 5,3→7,9 mld @6,9%) — Grand View is de **meest optimistische** van de drie, wat het als anker verzwakt. → [synthese](https://lite.duckduckgo.com/lite/?q=project+portfolio+management+market+size+2024+2030+grand+view+research+CAGR) |
| 6 | **Shutdown & Turnaround Optimization Software 1,42 mld (2024) → 3,44 mld (2033), CAGR 10,2%; NA 540 / EU 420 (9,7%) / APAC 300 (12,4%) / LATAM 90 / MEA 70 mln** | **BEVESTIGD** — primair, alle cijfers exact; regio's tellen op tot 1.420 mln (intern consistent); olie & gas is inderdaad het grootste segment, power generation een deelsegment | [Growth Market Reports](https://growthmarketreports.com/report/shutdown-and-turnaround-optimization-software-market) |
| 7 | **OMS-markt (2,45 mld, CAGR 16,1%) terecht uitgesloten omdat OMS in de nutssector storingsherstel betekent, niet outageplanning** | **BEVESTIGD — en dit is een correcte, prijzenswaardige methodologische keuze** | Primair gecontroleerd: het rapport definieert OMS via "Fault Location, Outage Prediction, Restoration Management, Customer Communication" — distributienet-storingsafhandeling, geen onderhouds-/turnaroundplanning. Meetellen zou inderdaad een terminologische fout zijn geweest. → [Growth Market Reports, OMS](https://growthmarketreports.com/report/outage-management-system-software-market) |
| 8 | **440 operabele reactoren in 31 landen, 403.265 MWe, 79 in aanbouw (WNA, 20-07-2026)** | **BEVESTIGD** — primair, alle vier cijfers exact, inclusief de updatedatum; aanbouwcapaciteit aanvullend 86.728 MWe | [World Nuclear Association](https://world-nuclear.org/information-library/current-and-future-generation/nuclear-power-in-the-world-today) |
| 9 | **Nucleaire outage kost ≈1,2 mln USD/dag; 10.000–18.000 activiteiten; 2–3 weken; 18/24 maanden; ~300 activiteiten na de geplande einddatum; duren "in hours and minutes"; "plant owners already rely on tools such as Primavera P6"; export via Ctrl+A/Ctrl+C naar Excel** | **BEVESTIGD** — alle acht letterlijk, uit de PDF-tekst zelf ("about 1.2M$/day of lost revenue"; "10,000–18,000 activities"; "typically 2–3 in the United States"; "about 300 activities were performed after the planned outage end date"; "typically in hours and minutes"; "select all the contents (Ctrl + A), and then copy (Ctrl + C)") | [INL/RPT-24-80380](https://lwrs.inl.gov/content/uploads/11/2024/10/OutageOptimization.pdf) |
| 10 | **"Een licentiebudget van 4.000 USD per planner verdient zich terug als het één outagedag per decennium bespaart voor een team van 300 planners"** (§3.5) | **GECORRIGEERD — rekenfout, factor 10** | 300 × 4.000 = 1,2 mln USD **per jaar** = 12 mln per decennium; één outagedag = 1,2 mln. Terugverdienpunt is dus één outagedag **per jaar**, niet per decennium. Strekking blijft geldig, marge is 10× kleiner. |
| 11 | **Netinvestering 390 mld USD (2024) → >400 mld (2025); totale energie-investering 3,3 biljoen; nucleair ≈75 mld (IEA)** | **BEVESTIGD** (via secundair; iea.org gaf 403) — "Grid investment reached a new high of USD 390 billion globally in 2024", "set to surpass USD 400 billion for the first time in 2025", "USD 3.3 trillion, a 2% rise in real terms", nucleair "projected to reach USD 75 billion in 2025" | [IEA WEI 2025-synthese](https://lite.duckduckgo.com/lite/?q=IEA+World+Energy+Investment+2025+grid+investment+400+billion+nuclear+75+billion) |
| 12 | **Eurelectric: EU-distributienet van €33 mld naar €67 mld per jaar, 2025–2050** | **BEVESTIGD** — "distribution grid investments should increase from an average €33 billion to €67 billion per year from 2025 to 2050" | [Eurelectric "Grids for Speed"-synthese](https://lite.duckduckgo.com/lite/?q=Eurelectric+Grids+for+Speed+33+billion+67+billion+distribution+grid+investment+annually) |
| 13 | **ENTSO-E: >€800 mld aan grensoverschrijdende en offshore projecten tot 2050** | **ONZEKER — niet reproduceerbaar, vermoedelijk te hoog** | Verifieerbaar is: ONDP "a total investment of upward of **400 billion euros**" voor offshore transmissie-assets, en TYNDP 2024 **€13 mld/jaar** voor grensoverschrijdende net-/opslagcapaciteit tot 2050 (≈€340 mld cumulatief). Geen bron gevonden voor €800 mld. → [synthese](https://lite.duckduckgo.com/lite/?q=ENTSO-E+TYNDP+2024+projects+total+investment+billion+euros+offshore+network+development+plan+value) |
| 14 | **ENTSO-E heeft 40 TSO-leden uit 36 landen** | **BEVESTIGD** — primair, letterlijk "40 Members from 36 countries are part of ENTSO-E" | [ENTSO-E](https://www.entsoe.eu/about/inside-entsoe/members/) |
| 15 | **EU DSO Entity vertegenwoordigt ~800–850 DSO's, 250 mln aansluitingen, 27 lidstaten** | **BEVESTIGD, met afbakeningskanttekening** — het is het **ledental van de EU DSO Entity**, niet het totale aantal DSO's in de EU (dat ligt in de orde van 2.000–2.400, overwegend zeer klein). Als populatiebasis in §6.2 dus een ondergrens | [lobbyfacts-synthese](https://lite.duckduckgo.com/lite/?q=how+many+distribution+system+operators+DSOs+in+Europe+EU+DSO+Entity+members+2400) |
| 16 | **EIA: ruim 3.200 Amerikaanse elektriciteitsbedrijven** | **ONZEKER** — niet aan een EIA-brondocument te koppelen; enige onafhankelijke vondst is Statista ("around 3,000 electric utility companies"). Orde van grootte klopt, het precieze getal niet verifieerbaar. Verlaagd naar [C] | idem |
| 17 | **Oracle-listprijzen: P6 Professional 3.880, P6 EPPM 4.240, Primavera Risk Analysis 10.450, Progress Reporter 1.460 USD** | **BEVESTIGD dat de bron dit zegt; ONZEKER als marktfeit** | Prijslijst primair opgehaald en exact zo teruggevonden — maar het is een **ongedateerde resellerpagina**, geen Oracle-document, en Oracle verkoopt P6 inmiddels overwegend als abonnement. Het rapport waarschuwde hier zelf al voor; die waarschuwing blijft terecht en zwaarwegend. Deze prijzen dragen via de 3.000 USD/seat-aanname de hele bottom-up — dat is een reëel fundamentrisico. → [AKIM Engineering](https://www.akimeng.com/oracle-primavera-price-list.html) |
| 18 | **DOE noemt Primavera P6 (en Safran) op zijn lijst van EVM-softwaretools; acht leveranciers** | **BEVESTIGD** — primair, alle acht exact zoals in §4.4 opgesomd. **Nuance:** de pagina zegt dat deze leveranciers "have added some capacity to support contractors reporting EVMS data to the Department" — het is een lijst van leveranciers die DOE-metriektests inbouwen, **geen goedkeurings- of erkenningslijst**. Formuleringen als "DOE-erkend" (§11) zijn daarmee iets te sterk | [DOE Office of Project Management](https://www.energy.gov/projectmanagement/earned-value-management-evm-software-tools) |
| 19 | **Activiteitsdichtheid ≈500–900 activiteiten per dag** (§3.1) | **GECORRIGEERD → 475–1.300/dag** | 10.000/21 ≈ 476; 18.000/14 ≈ 1.286. De oorspronkelijke bandbreedte deelde beide uitersten door ~20 dagen en onderschatte de bovengrens met ~40%. Correctie versterkt het argument. |
| 20 | **Component E = 20–30% bovenop de schedulinglaag = 100–180 mln** | **ONZEKER — intern inconsistent** | 20–30% van A+D (630–975) geeft 126–293 mln, niet 100–180. De grondslag waarover het percentage wordt genomen is nergens gedefinieerd. Bedrag niet gecorrigeerd (geen betere basis), wel als zwak onderbouwd gemarkeerd. |
| 21 | **Component A: 200 sites × 25 seats × 3.000 USD = 15 mln; ×6–12 voor EAM/STO = 120–200 mln** | **BEVESTIGD als rekensom, ONZEKER als aanname** | 200 × 25 × 3.000 = 15 mln ✓. De site-aanname is redelijk: 440 reactoren / ~200 sites ≈ 2,2 per site, consistent met de eigen voorbeelden (VS 94/54 ≈ 1,7; Frankrijk 57/18 ≈ 3,2). Kleine slordigheid: 15 × 6–12 = 90–180, plus 15 scheduler = **105–195**, geboekt als 120–200 (licht naar boven afgerond). De factor 6–12 zelf is een ongetoetste gok. |

### Wat dit betekent voor het rapport als geheel

1. **De empirische kern is betrouwbaar.** Elk cijfer dat aan een primaire bron hing (WNA, INL, ENTSO-E, DOE, Growth Market Reports, IEA, Eurelectric) is letterlijk teruggevonden — inclusief de moeilijk te controleren INL-passages. Dat is beter dan gebruikelijk.
2. **De strategische hoofdconclusie moet worden bijgesteld, en wel gunstig.** P6 is *gewoonterecht en ecosysteem*, geen juridisch verplichting. De zwaarst gereglementeerde Amerikaanse bouwspec biedt een **open, gedocumenteerd toelatingspad** (CPM/PDM + SDEF + cost loading). Voor een open-source planner is dat een wezenlijk beter uitgangspunt dan §1 oorspronkelijk schetste — en het maakt **SDEF-ondersteuning** een concreet, afgebakend en hoogwaardig implementatiedoel dat het rapport nergens noemde.
3. **De segmentraming moet met meer nederigheid worden gepresenteerd.** Na correctie: 1,05–1,75 mld USD, middenwaarde ≈1,4 mld, met een top-downcontrole die naar 1,0–1,2 mld wijst. De raming hangt bovendien via de 3.000 USD/seat-aanname aan één ongedateerde resellerprijslijst.
4. **Onveranderd overeind:** de betalingsbereidheidsanalyse (§5.7), de terminologische OMS-valkuil (§2.4 — een correcte en waardevolle vondst), het integratiegat rond P6-export (§9.1), en de DCMA-14-checklijst als implementeerbare poort.
