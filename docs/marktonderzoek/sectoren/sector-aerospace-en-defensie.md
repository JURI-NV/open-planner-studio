...
4. **Betalingsbereidheid: extreem hoog, maar volledig compliance-gedreven.** Uit federale inkoopdata: **USD 11.049 per Acumen Fuse Risk-seat per jaar** (afgeleid: USD 55.244 voor 5 licenties, Department of Commerce, 2025-02-06, [USAspending](https://www.usaspending.gov/)). Oracle's laatste openbare eeuwigdurende lijstprijs voor **Primavera Earned Value Management** was **USD 10.000 per application user** plus USD 2.200 support/jaar (Oracle C&E Global Price List, 10-11-2016).
5. **De diensten zijn 3–10× de licentie.** Eén enkele EVM-ondersteuningsopdracht aan Booz Allen Hamilton was **USD 12.435.775** (DoD, 2020-06-12), terwijl Deltek's *grootste* directe federale software-opdracht in tien jaar **USD 1.826.060** was (DoD, 2018). Totale directe federale prime-opdrachten aan Deltek 2015–2026: **USD 12,4 miljoen over 203 opdrachten** (eigen aggregatie via USAspending-API).
6. **Segmentomvang (schatting):** de wereldwijde markt voor *planning + EVM-software* toewijsbaar aan aerospace & defensie bedraagt in 2026 naar schatting **USD 0,6–1,0 miljard per jaar** aan licenties/abonnementen, waarvan **USD 0,25–0,45 miljard** puur schedulingtooling. Inclusief implementatie, training en planningsdiensten komt de "planningseconomie" van de sector uit op naar schatting **USD 3–5 miljard per jaar**. Groeirichting: **stijgend, 8–12% per jaar**, gedreven door Europese herbewapening en Amerikaanse recapitalisatieprogramma's.
...
1. **De alternatieve kosten zijn catastrofaal.** Bij afgekeurd EVMS voorziet DFARS 252.234-7002 in **betalingsinhouding** ([acquisition.gov](https://www.acquisition.gov/dfars/252.234-7002-earned-value-management-system.)). Op een contract van USD 500 miljoen is een inhouding van enkele procenten al een veelvoud van elke denkbare licentiepost.
...
Mix van: MS Project (~USD 200–380/jaar geamortiseerd), P6 (~USD 1.500–2.600/jaar), Cobra (~USD 8.000–17.600/jaar), Acumen (~USD 11.000/jaar), Empower (~USD 3.000–5.000/jaar), plus niches. Gewogen naar volume (veel MS Project, weinig Acumen): **USD 2.500 – 4.000 per seat per jaar** *(schatting)*.
...
> **Segmentomvang planning + EVM-software voor aerospace & defensie: USD 0,6 – 1,0 miljard per jaar in 2026** (midden ≈ **USD 0,8 mrd ≈ EUR 0,74 mrd** bij EUR/USD ≈ 1,08 *(wisselkoers als aanname; geen bron geverifieerd)*), **waarvan USD 0,25 – 0,45 miljard puur schedulingtooling** (de rest is kosten-/EV-engines en analytics).
...
**Stijgend, naar schatting 8–12% per jaar** *(schatting, gebaseerd op onderstaande signalen)*:
...
> **Bronbeperking:** de AACE Recommended-Practices-catalogus met RP-nummers kon in dit onderzoek niet worden opgehaald ([web.aacei.org/resources/recommended-practices](https://web.aacei.org/resources/recommended-practices) toont de RP-nummers niet). Het nummer 29R-03 is niet primair geverifieerd in deze sessie.
