...
> **[GECORRIGEERD — fact-check 25-07-2026]** De IIR-reeks $30→55→135→125 mrd is **gecombineerde capital- én maintenance-besteding** in raffinage, niet turnaround-besteding. Dezelfde IIR-publicatie volgt wereldwijd $383,7 mrd aan actieve/voorgestelde *capital*-projecten tegenover slechts **$21,6 mrd aan maintenance-gerelateerde projecten** — de reeks is dus overwegend nieuwbouw/revamp en is **geen proxy voor een turnaround-golf**. De richting (opwaarts) blijft, de causale koppeling naar STO-planningsbudget is zwakker dan hierboven gesuggereerd. Zie §Verificatie, punt 4.
...
**Consequentie voor softwarebudget:** een STO-suite van $150.000 per jaar is het equivalent van **1,2 tot 3,6 uur productieverlies** (bij $3M/dag resp. $1M/dag). **[GECORRIGEERD]** — de oorspronkelijke tekst zei "circa 1,5 uur"; dat geldt alleen aan de bovenkant van de vertragingsbandbreedte ($2,4M/dag). Bij de ondergrens van de eigen bron ($1M/dag) is het 3,6 uur. Dat is de kern van waarom betalingsbereidheid in deze sector zo hoog is en waarom prijsonderhandeling niet over de licentieprijs gaat maar over aantoonbare dagenreductie.
...
| 3 | **Safran Project / Safran Planner** | Serieuze nummer 3, geconcentreerd in Noorse/Britse offshore olie & gas. ~~Enige aanbieder met planning + scheduling + EVM + risico in één model.~~ **[GECORRIGEERD: marketingclaim, geen feit — zie noot onder de tabel]** | [Safran](https://www.safran.com/en-gb/project-management-scheduling-software); klanten o.a. **Aker BP, Aibel, ABB, Cofely Fabricom** |
...
> **[GECORRIGEERD — Safran "enige aanbieder"]** De claim *"the only provider of a unified project planning, scheduling, earned value management (EVM) and risk management solution"* (ook herhaald in §5.3 en §6.2) is **Safrans eigen marketingtekst**, geciteerd via [Emerald Associates](https://www.emerald-associates.com/software/safran/about-safran.html) — een Safran/Primavera-**reseller**, dus geen onafhankelijke bron (de pagina gaf bij hercontrole bovendien HTTP 403). De claim is falsifieerbaar en waarschijnlijk onjuist: **Deltek** biedt Open Plan (planning/scheduling) + Cobra (EVM) + Acumen Risk/Fuse (risico en schemadiagnostiek) als één portfolio ([Deltek Acumen](https://www.deltek.com/en/products/project-and-portfolio-management/acumen)), en **Oracle** verkoopt P6 + Primavera Earned Value Management + Primavera Risk Analysis (§3.1). Het verdedigbare deel van de claim is "één gedeeld **datamodel**" in plaats van een productbundel — schrijf dat op, niet "de enige aanbieder".
...
| **Webalo** (jan 2026) | Frontline worker apps | via zoekresultaat; bevestigd genoemd in [Prometheus' eigen Actenum-aankondiging](https://www.prometheusgroup.com/resources/posts/prometheus-group-acquires-actenum) |
| **Tamarack** (datum onbekend) | Data-driven procurement en supply chain | **[TOEGEVOEGD bij fact-check]** genoemd in dezelfde [Actenum-aankondiging](https://www.prometheusgroup.com/resources/posts/prometheus-group-acquires-actenum) — de lijst hierboven was dus onvolledig (7+, niet 6) |
...
> **[GECORRIGEERD — fact-check 25-07-2026]** Deze bronnen spreken elkaar met een **factor 10** tegen. GetLatka geeft **$18,6 mln omzet (2021)** en een **$1,5 mrd waardering in 2025** (plus $1 mrd in 2019) — niet $210–241 mln omzet en niet $4 mrd in juni 2024 ([getlatka](https://getlatka.com/companies/prometheus-group)). Kona Equity gaf HTTP 403 bij hercontrole en kon niet worden geverifieerd. Alleen het personeelsaantal is consistent (~1,1k in 2026 volgens GetLatka vs. de genoemde 1.194). **Conclusie: elke uitspraak over Prometheus' omzet of waardering in dit rapport is onbetrouwbaar**, en de kruisvalidatie in §4.2 stap 5 die op $210–241 mln leunt, is daarmee zwak onderbouwd. Zie §Verificatie, punt 7.
...
> **[BEVESTIGD — fact-check 25-07-2026]** Alle bedragen hierboven zijn op 25-07-2026 letterlijk teruggevonden op de bron ([IAMTech](https://www.iamtech.com/products/shutdown-turnaround-outage-software)), inclusief de GBP-tabellen en de kortingsstaffel (5/10/15/20% bij 2/3/4/5+ locaties). Twee nuances: (a) de totalen $337k (4×) en $396k (5×) zijn **IAMTech's eigen afronding** — 4 × $84k = $336k en 5 × $79k = $395k; het rapport neemt de brontabel correct over, dit is geen rekenfout van de auteur. (b) De individuele-gebruikerstotalen ontbraken in het rapport en zijn: $33k / $62k / $90k / $112k / $135k (iPlanSTO) en $49k / $93k / $132k / $168k / $196k (iPlanUltimate). (c) De iPlanUltimate-site-totalen zijn $165k / $314k / $446k / $560k / $660k. Let op: de prijzen staan **niet** op de `iplan-ultimate`-productpagina (die verwijst alleen naar "book a demo"); alleen de STO-pagina publiceert ze.
...
|---|---|---|
| P6 EPPM cloud, 30 seats | ~~$95.000~~ → **~$100.500** | £220 × 30 × 12 = £79.200 × $1,27/£ = **$100.584**. **[GECORRIGEERD]** — de tabelcel ($95.000) sprak de eigen onderbouwing (≈$100k) tegen. Bij de koers van juli 2026 (~$1,34/£) is het zelfs ~$106.000 |
...
| **Totaal jaar 1, excl. interne FTE** | ~~$414.000–$1.275.000~~ → **$419.500–$1.280.500** | na correctie van de P6-regel |

Ter contextualisering: dat is **0,42–1,28%** van een turnaround van $100M, en **0,10–0,32%** van een turnaround van $400M.

> **[GECORRIGEERD — rekenfout]** De oorspronkelijke tekst zei "0,1–1,3% van $100M" en "0,04–0,3% van $400M". Nagerekend met de eigen totalen: $414k/$100M = **0,41%** (niet 0,1%) en $414k/$400M = **0,10%** (niet 0,04%). Beide ondergrenzen waren een factor ~4 te laag; het lijkt erop dat de $400M-ondergrens per ongeluk in de $100M-regel is gezet. Materieel effect: de softwarekosten zijn **relatief 4× hoger** dan het rapport suggereerde — nog steeds triviaal ten opzichte van de turnaroundkosten, maar het "rounding error"-argument in §3.6 is iets minder sterk dan gepresenteerd.
...
> **[GECORRIGEERD — rekenfout + interne tegenspraak]**
> 1. **Arbeidsbedrag.** 8–20 planners × 12–18 maanden × ~21,7 werkdagen × $600–1.200/dag geeft **$1,25–9,4 miljoen**, niet $1,5–5 miljoen. De bovengrens is bijna een factor 2 te laag. (Realistischer is dat het team gefaseerd op- en afschaalt, maar dan moet dat expliciet als aanname staan; zoals opgeschreven volgt $5 mln niet uit de genoemde parameters.)
> 2. **"Software is 5–20% van de planningskosten" klopt niet met §3.4.** Daar staat software jaar 1 op $414k–$1.275k en interne planners op $700k–$2.500k. Dat geeft een ratio van **17% tot 182%** — de 5–20% geldt alleen als je de duurste arbeidsschatting tegen de goedkoopste softwareschatting zet. De onderliggende boodschap (arbeid domineert) blijft plausibel, maar het percentage is niet houdbaar. Gebruik "software is grofweg een vijfde tot de helft van de directe planningskosten" of laat het getal weg.
...
> **[ONZEKER — fact-check 25-07-2026]** Drie problemen met stap 1:
> 1. **Interne inconsistentie:** de tabel gebruikt 825 raffinaderijen maar telt met 800. Verschil is verwaarloosbaar (2.825 vs. 2.800), maar de optelling is niet reproduceerbaar zoals opgeschreven.
> 2. **De Statista-bron (825, 2024) kon bij hercontrole niet worden opgehaald** (redirect-loop / paywall). Het cijfer is niet onafhankelijk bevestigd; "hoog" in de betrouwbaarheidsbijlage is te stellig. Bovendien telt Statista *raffinaderijen*, terwijl Tier A+B in stap 2 exact 800 sites is — de aanname dat elke raffinaderij Tier A of B is en géén enkele Tier C, is niet onderbouwd.
> 3. **De ~1.500 petrochemie-/gasverwerkingscomplexen zijn de dominante en zwakst onderbouwde term** (54% van de sites). De gegeven onderbouwing ("C&EN top-50 exploiteert elk 10–60 sites") impliceert 500–3.000 sites voor alléén de top 50 — een bandbreedte van factor 6 die het eindgetal ±50% laat schuiven. Deze ene aanname bepaalt de segmentomvang meer dan enige geverifieerde bron in dit rapport.
...
> Bandbreedte $220–420 miljoen. In EUR: **circa € 265 miljoen**.

> **[GECORRIGEERD — verkeerde wisselkoers]** De gebruikte koers van **$1,09/€ was niet het gemiddelde van 2025**. De IRS-jaargemiddelden geven voor 2025 **0,886 EUR per USD = $1,129/€** ([IRS yearly average currency exchange rates](https://www.irs.gov/individuals/international-taxpayers/yearly-average-currency-exchange-rates)); de ECB-referentiekoers stond op 24-07-2026 op **1,1377** ([ECB](https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/eurofxref-graph-usd.en.html)). $300 mln is dus **€ 266 mln** (koers 2025) resp. **€ 264 mln** (koers nu), niet € 275 mln. De opgegeven $1,09 komt dicht bij de koers van *begin* 2025 (~1,03–1,09 in Q1) — dat is geen jaargemiddelde. Bandbreedte in EUR: **€ 195–372 mln**.

**Stap 5 — Kruisvalidatie via leveranciersomzet [SCHATTING]**

| Leverancier | Totale omzet | Toewijsbaar aan O&G-STO-planning |
|---|---|---|
| Prometheus Group | $210–241 mln ([Kona Equity](https://www.konaequity.com/company/prometheus-group-4039240081/)) — **maar GetLatka zegt $18,6 mln (2021); zie §2.3** | 15–25% → ~~$35–60 mln~~ **$32–60 mln** (15% × $210 mln = $31,5 mln, niet $35 mln) |
...
| **Optelling** | | ~~$170–345 mln~~ → **$167–325 mln** |

> **[GECORRIGEERD — rekenfout in de optelling]** De kolom telt op tot **$170–325 mln**, niet $170–345 mln. Nagerekend: ondergrens 35+50+10+10+5+10+50 = **170**; bovengrens 60+90+20+20+15+20+100 = **325**. De $345 mln is 20 te hoog. Met de gecorrigeerde Prometheus-ondergrens ($31,5 i.p.v. $35) wordt het **$167–325 mln**.
>
> **Materieel gevolg voor de kernconclusie:** de bottom-up-schatting van **$300 mln** ligt nu niet meer comfortabel in het midden van de kruisvalidatie maar in de **bovenste 10%** van de band ($167–325 mln); het middelpunt van de kruisvalidatie is **$246 mln**. Het woord "consistent" is te sterk — de twee methodes overlappen, maar de bottom-up zit systematisch aan de hoge kant. Bovendien is de kruisvalidatie **geen onafhankelijke check**: vijf van de zeven regels zijn zelf `[SCHATTING]` van dezelfde auteur, en de enige regel met een gepubliceerd getal (Prometheus) heeft bronnen die een factor 10 uiteenlopen. Verlaag het centrale punt naar **~$250–280 mln** of verbreed de bandbreedte expliciet.

De bottom-up ($300M) en de leveranciers-optelling ($167–325M) overlappen. De $1,12 miljard van Growth Market Reports past alleen als je de complete STO-managementsuite meerekent — uitvoering, permit-to-work, materiaalbeheer, kostenbeheersing, mobiele apps. **Beide definities zijn verdedigbaar; wees expliciet welke je gebruikt.**
...
| Nieuwe raffinaderijen | +181 units gepland tot 2030 **[ONZEKER — bron niet herbevestigd]** | [Statista](https://www.statista.com/statistics/1445314/number-of-oil-refineries-worldwide/) |

> **[GECORRIGEERD — de raffinage-uitgavenreeks is geen turnaround-driver]** De IIR-reeks ($30 → $55 → $135 → $125 mrd) is bevestigd letterlijk aanwezig in de bron, maar de bron beschrijft het als **gecombineerde capital- én maintenance-besteding**. IIR volgt daarnaast **$383,7 mrd aan capital-projecten tegenover $21,6 mrd aan maintenance-projecten** — een verhouding van ~18:1. De reeks meet dus vooral raffinaderij-nieuwbouw en -revamp, niet turnarounds. Gebruik hem als *aanwezigheid van budget in de sector*, niet als bewijs voor een turnaround-golf. **[BEVESTIGD:](https://www.industrialinfo.com/news/article/as-global-refining-slows-producers-look-to-petrochemicals--350673)** de getallen; **[GECORRIGEERD]**: de interpretatie.
>
> **[ONZEKER]** De twee CAGR's in deze tabel (12,7% software, 15,2% APAC, $980 mln APAC-2033) komen **allebei uit dezelfde [ZWAKKE BRON]** (Growth Market Reports). Bij hercontrole bleken de cijfers correct geciteerd, maar de vendorlijst van dat rapport (Hexagon, SAP, Oracle, IBM, AVEVA, Siemens, Honeywell, AspenTech, Bentley, Infor, DNV GL) bevat **geen enkele echte STO-planningsleverancier** — geen Prometheus, geen Cleopatra, geen IAMTech, geen Mobideo, geen Roser. Dat bevestigt de eigen waarschuwing van dit rapport: de $1,12 mrd meet iets anders (EAM/industriële software breed) en de 12,7% CAGR mag **niet** op de $300 mln-schatting worden losgelaten.
...
| **CFIHOS / ISO 15926** | Data-handover-standaard voor procesinstallaties in olie/gas/chemie/nucleair, onder IOGP. Dekt levenscyclus FEED→EPC→operatie, inclusief apparatuur, inkooporders **én "schedule en milestones"**. **[GECORRIGEERD — zie noot]** | [USPI](https://uspi.nl/index.php/cfihos-purpose), [DocsLib ISO 15926/CFIHOS](https://docslib.org/doc/1260962/iso-15926-and-the-data-handover-standard-cfihos-based-on-it) |
...
> **[GECORRIGEERD — CFIHOS ≠ ISO 15926 op dit punt]** De rij hierboven behandelt CFIHOS en ISO 15926 als één ding en schrijft "schedule en milestones" aan beide toe. Bij hercontrole geldt dat citaat **uitsluitend voor ISO 15926**: de bron zegt onder "What is the scope of ISO 15926?" letterlijk *"Data about equipment, but also purchase orders, schedule and milestones, etc."* ([DocsLib](https://docslib.org/doc/1260962/iso-15926-and-the-data-handover-standard-cfihos-based-on-it)). De **CFIHOS-standaard zelf definieert géén schema-/mijlpaaldata**: de v2.0-releasenotes noemen als scope-uitbreidingen GHG-emissieattributen, spares-informatie en afstemming op ISO 14224 — geen planningsdata ([JIP36/CFIHOS](https://www.jip36-cfihos.org/cfihos-standards/)). De USPI-bron gaf bij hercontrole HTTP 500 en kon niet worden nagelezen.
>
> **Gevolg voor §7.2-D:** de conclusie ("IFC is niet de standaard van deze sector, CFIHOS/ISO 15926 wel") blijft overeind, maar het *specifieke* argument dat de sector al een concurrerende schema-uitwisselingsstandaard heeft, is zwakker dan gepresenteerd. CFIHOS — de standaard die in de praktijk daadwerkelijk door operators wordt afgedwongen — raakt planningsdata niet. Dat is eerder een **kans** (er is geen zittende open schemastandaard in procesindustrie) dan een bedreiging.
...
> **[ONZEKER — bronafhankelijkheid]** Twee van de vaakst gebruikte "ontevredenheids"-bronnen in dit rapport zijn **concurrerende leveranciers die hun eigen product verkopen**:
> - **Fabrico** wordt ~8× geciteerd als "STO-softwarevergelijking". Bij hercontrole blijkt Fabrico **zichzelf op #1 te zetten** in de eigen ranglijst (Fabrico → Primavera P6 → MS Project → Roser CONSYS → Prometheus → Clevernet → Smartsheet) en Cleopatra, IAMTech, Mobideo en Hexagon helemaal **niet** te noemen. De P6-kritiek ("purely a planning tool", "very expensive and complex") is bevestigd aanwezig, maar het is verkooptekst, geen analyse. De ranglijst is bovendien te dun om als sectoroverzicht te dienen.
> - **Planera** en **Linarc** zijn eveneens P6-alternatieven die P6-kritiek publiceren als leadgeneratie.
> - **Prometheus'** "30–60 minuten ploegoverdracht" is bevestigd letterlijk aanwezig op hun site, maar is Prometheus' eigen probleemstelling voor het eigen product — geen gemeten sectorcijfer.
>
> Dit verandert de richting van de conclusie niet (de klachten over P6 zijn breed en oud), maar §7.1 leest nu als onafhankelijk bewijs terwijl het grotendeels concurrentie-marketing is. Markeer dat expliciet.
...
| 825 raffinaderijen (2024) | Statista | ~~Hoog~~ → **Onzeker** — bron gaf bij hercontrole een redirect-loop/paywall; niet onafhankelijk bevestigd |
...
| Prometheus omzet $210–241M | Kona Equity / ZoomInfo | ~~Laag-middel~~ → **Zeer laag** — Kona gaf 403; GetLatka noemt $18,6M (2021), factor ~12 verschil. Niet bruikbaar |
| Prometheus waardering $4 mrd+ (jun 2024) | PitchBook | **Zeer laag** — niet herbevestigd; GetLatka noemt $1,5 mrd in 2025 |
| Mijn segmentschatting $300M/jaar | eigen bottom-up model | **[SCHATTING]** — bandbreedte $220–420M. **Bijgesteld:** de kruisvalidatie telt op tot $167–325M (niet $170–345M) en is niet onafhankelijk; $300M zit in de bovenste 10% van die band. Centraal punt realistischer op **$250–280M** |
| IAMTech prijstabellen (alle staffels) | IAMTech website | **Hoog** — volledig geverifieerd 25-07-2026, inclusief GBP en kortingsstaffel |
| AP-Networks statistieken (⅔, 40%, 19%/7%, 1.350+, 60%+, >1 mln manuren, TSI 65%) | AP-Networks whitepaper | **Hoog** — alle zeven letterlijk teruggevonden in de primaire PDF |
| EUR-omrekening $1,09/€ | — | **Onjuist** — 2025-jaargemiddelde is $1,129/€ (IRS); zie §4.2 stap 4 |

---

## Verificatie

**Uitgevoerd:** 25 juli 2026 — adversariële fact-check. Opzet: de belangrijkste falsifieerbare beweringen actief proberen te **weerleggen** met onafhankelijke bronnen, en alle doorgerekende schattingen narekenen. Alle rekenwerk is opnieuw uitgevoerd; alle bereikbare bronnen zijn opnieuw opgehaald.

**Beperking van deze controle:** het WebSearch-budget van de sessie was uitgeput, dus er kon niet naar *nieuwe* tegenbronnen worden gezocht. Alle verificatie is gedaan door (a) de door het rapport zelf opgegeven bron-URL's direct op te halen en te vergelijken, en (b) de rekenkundige ketens onafhankelijk na te rekenen. Waar een bron onbereikbaar was (403/500/redirect-loop) staat dat expliciet als *onzeker* — dat betekent "niet bevestigd", niet "onjuist". Bewering 8 en 12 zijn hierdoor zwakker getoetst dan gewenst.

### Oordelen per bewering

| # | Bewering | Oordeel | Toelichting | Bron |
|---|---|---|---|---|
| 1 | **Kruisvalidatie leveranciersomzet = $170–345 mln, "consistent" met de $300 mln bottom-up** | **gecorrigeerd** | **Rekenfout.** De kolom telt op tot **$170–325 mln** (60+90+20+20+15+20+100 = 325, niet 345). Met de gecorrigeerde Prometheus-ondergrens: **$167–325 mln**. Gevolg: $300 mln ligt in de bovenste 10% van de kruisvalidatieband (middelpunt $246 mln), niet in het midden. "Consistent" is te sterk. Bovendien is de kruisvalidatie niet onafhankelijk: 5 van de 7 regels zijn `[SCHATTING]` van dezelfde auteur. Aanbeveling: centraal punt naar **$250–280 mln**. | eigen herberekening; §4.2 stap 5 |
| 2 | **Bottom-up model: 150×$600k + 650×$150k + 2.000×$30k = $248 mln; +$35 mln aannemers +$20 mln EPC = ~$300 mln** | **bevestigd (rekenkundig)** | Nagerekend: $90,0 + $97,5 + $60,0 = **$247,5 mln** ✓; 0,5–0,8% × $4,92–5,8 mrd = **$24,6–46,4 mln**, midden $35 mln ✓; totaal **$302,5 mln** ✓. De aritmetiek klopt. De *aannames* (tierverdeling, $/site, 0,5–0,8%) zijn ongetoetst en niet uit bronnen afgeleid — het model is intern consistent maar extern onbevestigd. | eigen herberekening |
| 3 | **"circa EUR 275 mln bij $1,09/€, gemiddeld 2025"** | **gecorrigeerd** | **Verkeerde wisselkoers.** IRS-jaargemiddelde 2025 = 0,886 EUR/USD = **$1,129/€**; ECB-referentiekoers 24-07-2026 = **1,1377**. $300 mln = **€ 266 mln** (2025) resp. **€ 264 mln** (nu), niet € 275 mln. $1,09 komt overeen met Q1-2025, niet met het jaargemiddelde. | [IRS yearly average rates](https://www.irs.gov/individuals/international-taxpayers/yearly-average-currency-exchange-rates) · [ECB EUR/USD](https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/eurofxref-graph-usd.en.html) |
| 4 | **Raffinage-uitgaven $30 → $55 → $135 → $125 mrd bewijzen een "enorme turnaround-golf"** | **gecorrigeerd** | De **getallen zijn letterlijk bevestigd**, maar de bron beschrijft ze als **gecombineerde capital- én maintenance-besteding**. Dezelfde bron volgt **$383,7 mrd capital-projecten tegenover slechts $21,6 mrd maintenance-projecten** (~18:1). De reeks meet dus overwegend nieuwbouw/revamp, niet turnarounds, en onderbouwt de "turnaround-golf" niet. Groeirichting blijft opwaarts; de causale koppeling naar STO-planningsbudget vervalt. | [Industrial Info Resources](https://www.industrialinfo.com/news/article/as-global-refining-slows-producers-look-to-petrochemicals--350673) |
| 5 | **Brede definitie $0,7–1,2 mrd, "consistent met de syndicated $1,12 mrd (2024), CAGR 12,7%"** | **bevestigd als citaat, maar de bron is onbruikbaar** | De cijfers staan er letterlijk ($1,12 mrd 2024 → $3,29 mrd 2033, 12,7% CAGR, APAC 15,2%/$980 mln, NA ~$410 mln). **Weerlegging van de bruikbaarheid:** de vendorlijst van het rapport bevat **geen enkele STO-planningsleverancier** — Hexagon, SAP, Oracle, IBM, AVEVA, Siemens, Honeywell, AspenTech, Bentley, Infor, DNV GL; géén Prometheus, Cleopatra, IAMTech, Mobideo of Roser. Het rapport meet dus aantoonbaar iets anders (industriële software/EAM breed). Het eigen `[ZWAKKE BRON]`-label is terecht en zou moeten worden aangescherpt tot "niet gebruiken als validatie". De 12,7%-CAGR mag niet op de $300 mln-schatting worden toegepast. | [Growth Market Reports](https://growthmarketreports.com/report/turnaround-planning-software-for-refineries-market) |
| 6 | **IAMTech publiceert $99.000/site/jaar (iPlanSTO) en $165.000 (iPlanUltimate); $27k–33k per individuele gebruiker** | **bevestigd** | Volledig geverifieerd, inclusief alle staffels, GBP-tabellen (£75k→£60k; £125k→£100k) en kortingspercentages (5/10/15/20%). Twee nuances toegevoegd aan §3.2: de totalen $337k en $396k zijn **IAMTech's eigen afronding** (4×$84k = $336k; 5×$79k = $395k) — géén rekenfout van de auteur; en de prijzen staan alléén op de STO-productpagina, niet op de iPlanUltimate-pagina. | [IAMTech](https://www.iamtech.com/products/shutdown-turnaround-outage-software) |
| 7 | **Prometheus Group: omzet $210–241 mln, waardering $4 mrd+ (juni 2024), marktleider** | **gecorrigeerd / onbruikbaar** | Kona Equity gaf **HTTP 403**. GetLatka — door het rapport zelf als bron opgevoerd — noemt **$18,6 mln omzet (2021)** en **$1,5 mrd waardering in 2025** (plus $1 mrd in 2019). Dat is een verschil van **factor ~12 op omzet** en een tegenspraak op zowel bedrag als jaartal van de waardering. Alleen het personeelsaantal is consistent (~1,1k in 2026 vs. de genoemde 1.194). **Elke financiële uitspraak over Prometheus in dit rapport moet als onbetrouwbaar worden gemarkeerd**, inclusief de "$4 miljard+"-referentie in §3.6 punt 4 en §6.5. De kwalitatieve marktleiderspositie (referenties, overnames) blijft wel overeind. | [GetLatka](https://getlatka.com/companies/prometheus-group) |
| 8 | **Oracle P6 EPPM Cloud £220/gebruiker/maand, minimum 25 gebruikers (G-Cloud 14)** | **onzeker** | Kon niet worden herbevestigd: het G-Cloud-prijsdocument is een PDF achter de Crown Commercial-raamovereenkomstpagina en was met de beschikbare middelen niet op te halen. Het rapport ondermijnt dit cijfer bovendien zelf: een tweede G-Cloud-notering (th3rdcurve, 30-04-2024) geeft **£358 per licentie per jaar** voor P6 EPPM — een factor ~7 lager dan £220/maand (£2.640/jaar). Die twee kunnen niet allebei "de" G-Cloud-prijs zijn. Het afgeleide "£66.000/jaar voordat je één activiteit hebt ingetikt" in de managementsamenvatting rust dus op de duurste van twee tegenstrijdige noteringen. Behandel als **bovengrens**, niet als feit. | [Crown Commercial RM1557.14](https://www.crowncommercial.gov.uk/agreements/RM1557.14) (niet ophaalbaar) |
| 9 | **TCO jaar 1 = $414k–$1.275k = "0,1–1,3% van een $100M-turnaround en 0,04–0,3% van een $400M-turnaround"** | **gecorrigeerd** | **Twee rekenfouten.** (a) De P6-regel stond op $95.000 terwijl de eigen onderbouwing $100k geeft: £220 × 30 × 12 = £79.200 × 1,27 = **$100.584** (bij de koers van juli 2026 zelfs ~$106k). Gecorrigeerd totaal: **$419.500–$1.280.500**. (b) De percentages: $414k/$100M = **0,41%** (niet 0,1%) en $414k/$400M = **0,10%** (niet 0,04%). Beide ondergrenzen waren ~4× te laag — waarschijnlijk is de $400M-ondergrens per ongeluk in de $100M-regel beland. | eigen herberekening; §3.4 |
| 10 | **"$150.000/jaar = circa 1,5 uur productieverlies"** | **gecorrigeerd** | Bij de eigen bandbreedte $1–3M/dag is $150k gelijk aan **1,2 uur** ($3M/dag) tot **3,6 uur** ($1M/dag). "Circa 1,5 uur" veronderstelt stilzwijgend ~$2,4M/dag, de bovenkant. Correct is **1,2–3,6 uur**. Het argument blijft geldig, alleen niet zo scherp. | eigen herberekening; §1.4 |
| 11 | **"Software is 5–20% van de planningskosten"; planningsteam kost $1,5–5 mln** | **gecorrigeerd** | (a) 8–20 planners × 12–18 mnd × ~21,7 werkdagen × $600–1.200/dag = **$1,25–9,4 mln**, niet $1,5–5 mln; de bovengrens is bijna 2× te laag. (b) De 5–20% spreekt §3.4 van het rapport zelf tegen: software $414k–$1.275k tegenover interne planners $700k–$2.500k geeft **17%–182%**. De 5–20% ontstaat alleen door de duurste arbeids- met de goedkoopste softwareschatting te combineren. De strategische conclusie ("arbeid domineert, verkoop productiviteit niet licentiebesparing") blijft plausibel, het percentage niet. | eigen herberekening; §3.4 vs. §3.5 |
| 12 | **~2.800 adresseerbare STO-sites = 825 raffinaderijen + ~1.500 petchem/gas + ~500 upstream** | **onzeker** | (a) De optelling gebruikt **800** waar de tabel **825** zegt (2.800 vs. 2.825) — klein, maar niet reproduceerbaar zoals opgeschreven. (b) De Statista-bron voor 825 gaf een **redirect-loop** en kon niet worden bevestigd; de betrouwbaarheidsbijlage stond op "Hoog" en is bijgesteld naar "Onzeker". (c) De **~1.500 petchem-/gassites vormen 54% van het totaal** en zijn de zwakst onderbouwde term: de gegeven redenering ("C&EN top-50 exploiteert elk 10–60 sites") impliceert 500–3.000 sites voor alléén de top 50 — een factor 6, die het eindantwoord ±50% laat schuiven. Deze ene ongetoetste aanname stuurt de segmentomvang sterker dan enige geverifieerde bron. | [Statista](https://www.statista.com/statistics/1445314/number-of-oil-refineries-worldwide/) (niet ophaalbaar) |
| 13 | **Safran is "de enige aanbieder" met planning + scheduling + EVM + risico in één oplossing** | **gecorrigeerd** | Marketingclaim van Safran zelf, geciteerd via **Emerald Associates — een Safran-reseller**, dus geen onafhankelijke bron (pagina gaf bij hercontrole 403). Weerlegd door concurrenten: **Deltek** levert Open Plan (scheduling) + Cobra (EVM) + Acumen Risk/Fuse (risico en schemadiagnostiek); **Oracle** levert P6 + Primavera EVM + Primavera Risk Analysis (beide in §3.1 van dit rapport zelf). Verdedigbaar is hooguit "één gedeeld datamodel in plaats van een productbundel". | [Deltek Acumen](https://www.deltek.com/en/products/project-and-portfolio-management/acumen) · [Emerald Associates](https://www.emerald-associates.com/software/safran/about-safran.html) (403) |
| 14 | **CFIHOS/ISO 15926 dekt "schedule en milestones" — de sector heeft dus al een concurrerende schemastandaard** | **gecorrigeerd** | Het citaat *"Data about equipment, but also purchase orders, schedule and milestones, etc."* geldt **uitsluitend voor ISO 15926**, niet voor CFIHOS. De CFIHOS-standaard zelf definieert **géén planningsdata**: de v2.0-scope-uitbreidingen zijn GHG-emissieattributen, spares-informatie en ISO 14224-afstemming. De USPI-bron gaf HTTP 500. **Gevolg voor §7.2-D:** de hoofdconclusie ("IFC is hier niet de standaard") blijft staan, maar er is **geen zittende open schema-uitwisselingsstandaard in de procesindustrie** — dat is eerder een kans dan de bedreiging die het rapport ervan maakt. | [JIP36/CFIHOS](https://www.jip36-cfihos.org/cfihos-standards/) · [DocsLib ISO 15926](https://docslib.org/doc/1260962/iso-15926-and-the-data-handover-standard-cfihos-based-on-it) |
| 15 | **AP-Networks-statistieken: >⅔ overschrijdt kosten/tijd >10% of trip; 40% >30%; 19% scopegroei vs. 7% top-kwartiel; 1.350+ observaties; 60%+ High-to-Mega; >1 mln manuren; TSI verklaart 65% variantie bij <0,1%** | **bevestigd** | Alle zeven letterlijk teruggevonden in de primaire PDF. Exacte tekst: *"more than two-thirds of turnarounds exceed their planned cost and schedule by 10 percent or have a trip after startup. Forty percent of turnarounds experience a cost overrun or schedule delay of more than 30 percent."* · *"Industry average scope growth from scope freeze to execution is 19 percent... top quartile performers experience growth of only 7 percent."* · *"the model explains 65 percent of the variance"* (DFL-model: 68%). Eén nuance: de bron zegt "by 10 percent", het rapport schrijft "met meer dan 10%". Dit is het sterkste feitenblok van het rapport. | [AP-Networks whitepaper](https://www.ap-networks.com/wp-content/uploads/2021/11/WhitePaper-Benchmarking-and-Optimizing-Maintenance-Work-Scope-for-Turnarounds.pdf) |
| 16 | **Prometheus-claims: 30–60 min ploegoverdracht, gecontroleerde P6-toegang, klantnamen; STO-kosten $5–500 mln; 18–24 mnd vooruit; 3–12 weken; 20%/30% overschrijding** | **bevestigd, met bronnuance** | Letterlijk bevestigd: *"Generate a complete shift handover report from the live P6 schedule in seconds, instead of 30-60 minutes"*; *"Limit contractor access to Primavera (P6) with configurable permissions"* (het rapport parafraseert dit als "controlled access"); klanten ExxonMobil, Covestro, Marathon, Constellation Energy, BP, Talen Energy, Gunvor, Susquehanna Nuclear. De 20%/30%-cijfers staan **niet** op de STO-oplossingspagina maar op de "What is an STO?"-pagina (*"cost overruns of 20%... schedule overruns of 30%"*, voor high-complexity events). **Nuance:** dit zijn Prometheus' eigen probleemstellingen voor het eigen product, geen onafhankelijke metingen. | [Prometheus STO](https://www.prometheusgroup.com/solutions/shutdown-turnaround-and-outage) · [What is an STO?](https://www.prometheusgroup.com/resources/posts/what-is-a-shutdown-turnaround-and-outage) |
| 17 | **Prometheus rolde de STO-laag op met 6 overnames (Roser, WorkTech, Atonix, Actenum, NiSoft, Webalo)** | **gecorrigeerd (aanvulling)** | Actenum bevestigd op **16 december 2025**; Webalo bevestigd. De lijst is echter **onvolledig**: dezelfde aankondiging noemt ook **Tamarack** (procurement/supply chain). Het zijn er dus minstens 7, niet 6. Het consolidatie-argument wordt hierdoor eerder sterker dan zwakker. | [Prometheus — Acquires Actenum](https://www.prometheusgroup.com/resources/posts/prometheus-group-acquires-actenum) |
| 18 | **P6-zwaktes en sectorontevredenheid (§7.1) als onafhankelijk bewijs** | **onzeker (bronafhankelijkheid)** | De citaten zijn correct overgenomen, maar de belangrijkste bron — **Fabrico, ~8× geciteerd** — is een **concurrerende leverancier die zichzelf op #1 zet** in de eigen ranglijst (Fabrico → P6 → MS Project → Roser → Prometheus → Clevernet → Smartsheet) en Cleopatra, IAMTech, Mobideo en Hexagon niet eens noemt. Idem voor Planera en Linarc (beide P6-alternatieven). Het is verkooptekst, geen sectoranalyse; de ranglijst is bovendien te dun om als "STO-softwarevergelijking" te dienen. De onderliggende klachten over P6 zijn wel breed gedragen, maar §7.1 presenteert marketing als bewijs. | [Fabrico](https://www.fabrico.io/blog/best-shutdown-turnaround-software/) |
| 19 | **Deloitte: tot 1,9 mln onvervulde productiebanen in de VS tegen 2033 (vergrijzingsdriver)** | **bevestigd** | Letterlijk bevestigd: *"up to 1.9 million unfilled manufacturing jobs by 2033"*, uit een studie van Deloitte en The Manufacturing Institute (2024). Ook bevestigd: planning start 18–24 maanden vooraf met budgetgoedkeuring ~2 jaar vooraf, en *"documentation gaps and unverified assumptions are the single largest controllable risk in turnaround planning"*. **Nuance:** het cijfer betreft de **volledige Amerikaanse maakindustrie**, niet raffinageplanners; als driver voor STO-planningssoftware is het indirect. | [Matterport](https://matterport.com/blog/refinery-turnaround-planning) |

### Samenvattend oordeel

**Wat overeind blijft.** Het feitelijke fundament van het rapport is grotendeels solide. De twee belangrijkste harde datapunten — de **AP-Networks-prestatiestatistieken** (bewering 15) en de **IAMTech-prijslijst** (bewering 6) — zijn integraal en letterlijk geverifieerd tegen primaire bronnen. Ook de Prometheus-productclaims, de Deloitte-arbeidsmarktcijfer, de Industrial Info-getallen en de Actenum/Webalo-overnames zijn bevestigd. De kwalitatieve kern (P6 als contractuele standaard, een tweede laag STO-suites erbovenop, hoge betalingsbereidheid, consolidatie door Prometheus, en de aanbeveling om IFC **niet** als sectorargument te gebruiken) is niet weerlegd. Het rapport is bovendien opvallend eerlijk over zijn eigen zwakke bronnen — het `[ZWAKKE BRON]`-label op Growth Market Reports bleek volledig terecht.

**Wat niet overeind blijft.** Vijf rekenfouten, alle in dezelfde richting — **ten gunste van een groter en aantrekkelijker segment**: de kruisvalidatie-optelling ($345 → $325 mln), de EUR-koers (€275 → €266 mln), de TCO-percentages (factor 4 te laag, waardoor software goedkoper leek), de P6-seatkosten ($95k vs. $100,5k) en de "1,5 uur productieverlies" (bovenkant gepresenteerd als middenwaarde). Afzonderlijk zijn het kleine correcties; samen laten ze een **systematische optimistische afronding** zien die in een marktonderzoek gecorrigeerd moet worden voordat er beslissingen op worden gebaseerd.

**Twee bevindingen die de conclusies inhoudelijk raken:**
1. **De $300 mln-schatting is te hoog aan de bovenkant onderbouwd.** De kruisvalidatie telt op tot $167–325 mln met middelpunt $246 mln, is niet onafhankelijk (5 van 7 regels zijn eigen schattingen), en de enige regel met een gepubliceerd omzetcijfer (Prometheus) rust op bronnen die een factor 12 uiteenlopen. Daarbij komt dat 54% van de sitetelling op één ongetoetste aanname berust. **Advies: verlaag het centrale punt naar $250–280 mln en verbreed de onzekerheidsmarge**; de $220–420 mln-bandbreedte is te smal gegeven de gestapelde aannames.
2. **De groeidriver is verkeerd geïnterpreteerd.** De $135 mrd-raffinagepiek in 2026 is overwegend **capital**, niet turnaround-onderhoud (18:1 volgens dezelfde bron). "Sterk opwaarts" is verdedigbaar; "gedreven door een enorme turnaround-golf" is dat niet op basis van deze bron.

**Eén bevinding die in het voordeel van het rapport uitvalt:** CFIHOS — de standaard die operators daadwerkelijk afdwingen — dekt **geen** schema-/mijlpaaldata (alleen ISO 15926 doet dat, en die wordt in de praktijk nauwelijks voor planning gebruikt). Er is dus **geen zittende open schema-uitwisselingsstandaard in de procesindustrie**. Dat maakt het gat dat §7.2-D beschrijft groter dan het rapport zelf durft te claimen.
