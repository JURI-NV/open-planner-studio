...
>
> **Nagekomen: zie de sectie [Verificatie](#verificatie) onderaan.** Een adversariële hercontrole (25 juli 2026) bevestigde alle prijs- en contractclaims regel-voor-regel bij de primaire bron, maar corrigeerde twee rekenfouten en weerlegde de onderbouwing van de segmentomvang in §4. Waar §3.2, §4.1, §4.3 en §4.4 nu afwijken van de oorspronkelijke tekst, staat de correctie in een citaatblok ter plaatse.
...
> **Reikwijdte-nuance na verificatie (V8).** De P6- en .xer-verplichting geldt uitsluitend voor **Level 2 (Standard CPM Schedule)**. Voor **Level 1** staat de spec expliciet meerdere formaten toe: *"Submit a four-week look-ahead schedule identifying planned weekly work activities to the Resident Construction Engineer (RCE) in **Word, Excel, or Primavera P6 format**."* De lock-in is dus reëel maar begrensd tot het contractuele CPM-niveau; het look-ahead-niveau is open. Dat is relevant voor §7.8 en §7.9: het look-ahead-segment is niet contractueel afgesloten voor een alternatief.
>
> Aanvullend uit dezelfde spec, niet eerder vermeld en relevant als functionele eis: activiteitsduren zijn **gemaximeerd op 30 kalenderdagen**; *"The use of activity expected finish dates is prohibited"*; en de verplichte F9-instellingen zijn Retained Logic, "compute start-to-start lag from Early Start", "define critical activities as Longest Path", "Total Float = Late Finish – Early Finish" en "Calendar for scheduling Relationship Lag: Predecessor Activity Calendar". Het contract is een achterstand bij **SVI < −0,10 na de derde termijn**.
...
Volumekortingen: 101–200 gebruikers −10%, 201–500 −15%, 501–1.000 −20%, 1.001+ −25%. **[GECORRIGEERD, V9]** — niet "alle producten": Oracle publiceert deze staffel per productfamilie (P6 EPPM, P6 Progress Reporter, P6 Web Services, Unifier UPC/UFREM, Primavera Cloud, Aconex, Construction Intelligence). Voor de **UK Government Cloud**-diensten, de **Unifier Portal User**, de **EVM-add-on** en **Team for External Collaborators** staat géén kortingstabel in het prijsblad.

**Verzwegen bijkomende post [V9]:** Unifier Project Controls en Unifier Facilities & Real Estate Management vereisen een **AutoVue-prerequisite** waarvan het aantal gebruikers gelijk moet zijn aan het aantal Unifier-gebruikers: AutoVue 2D Professional **£12/gebruiker/maand** (minimum) of AutoVue 3D Professional Advanced **£44/gebruiker/maand**. De effectieve Unifier-prijs is dus £144–176 per gebruiker per maand, niet £132.
...
**Kernverhouding [SCHATTING, eigen afleiding — GECORRIGEERD, zie Verificatie V6]:** de jaarlijkse licentiekosten van een planner (£1.100–£2.700) bedragen circa **1,2% tot 2,9%** van diens volledig belaste jaarkosten (US$ 90.889 salaris + circa 30% werkgeverslasten ≈ US$ 118.000 ≈ £93.000). *(De eerder genoemde bovengrens van 4% was een rekenfout: 4% zou een licentie van circa £3.700 vereisen, hoger dan élke per-seat-prijs in de tabellen hierboven — P6 EPPM à £2.640 is de duurste.)* De software is dus economisch een afrondingsfout ten opzichte van de mens die haar bedient. Dit is de belangrijkste verklaring voor de prijselasticiteit in deze markt: **prijs is bijna nooit de reden om van pakket te wisselen; wél de reden om planners géén licentie te geven** — wat de vraag naar goedkope viewers (ScheduleReader) verklaart.
...
| [Eleco plc FY2025-jaarverslag, citerend FMI](https://ir.eleco.com/regulatory/final-results-8/) | Construction **project management** software (bredere categorie) | **≈ US$ 1,9 mrd** wereldwijd | — | "high single to mid double-digit rates" |

De drie waarden liggen tussen **US$ 1,4 en 2,5 mrd voor 2025**, met een middenwaarde rond **US$ 1,9 mrd**.

> **Correctie na verificatie (zie V1–V2).** De oorspronkelijke formulering — "drie onafhankelijke bronnen convergeren opvallend goed" en "precies het getal dat Eleco noemt" — houdt geen stand:
> - Eleco's letterlijke tekst is: *"Independent research by **FMI** estimates market opportunities of approximately US $1.9bn in **construction project management software**, US $3.4bn in maintenance and facilities management, and around US $6bn in BIM software solutions, all growing at high single to mid double-digit rates."* Het is dus één genoemde analist (FMI), geen anonieme "independent research", en Eleco bevestigt niets zelf — het citeert.
> - Belangrijker: FMI's US$ 1,9 mrd geldt voor **construction project management software**, een categorie die *breder* is dan "CPM-planning + 4D + schedule-analytics in enge zin". Als de bredere categorie US$ 1,9 mrd is, moet de engere deelverzameling **kleiner** zijn. Het cijfer is dus een **plafond** voor de puntschatting, geen bevestiging ervan.
> - De drie bronnen zijn ook niet onderling onafhankelijk qua definitie, en de spreiding 1,44 → 2,45 is een factor 1,7 — dat is de volle breedte van wat twee rapporten toevallig zeggen, geen convergentie.
> - WiseGuy Reports is bovendien intern inconsistent: de eigen deployment-uitsplitsing voor 2024 (cloud 980 + on-premise 770 + hybride 602,7 = 2.352,7 mln) telt niet op tot het eigen totaal van 2.307,4 mln.
...
> **REKENFOUT, gecorrigeerd (zie V3).** De softwarequote van 0,02–0,04% volgt *niet* uit de eigen onderbouwing tussen haakjes. Eén planner per US$ 30–80 mln à US$ 2.000–3.000 licentie geeft:
> US$ 3.000 / US$ 30 mln = **0,010%** (bovengrens) en US$ 2.000 / US$ 80 mln = **0,0025%** (ondergrens).
> De gebruikte quote ligt dus een factor **4 tot 16 boven de eigen basis**. Doorgerekend mét de eigen parameters levert methode A:
> US$ 4,655 bln × 0,0025% = **US$ 0,12 mrd** tot US$ 5,985 bln × 0,010% = **US$ 0,60 mrd**.
> Dat is een orde van grootte *onder* de analistenbandbreedte. **Methode A bevestigt de US$ 1,9 mrd dus niet onafhankelijk** — de uitkomst van US$ 0,9–2,4 mrd ontstond doordat de softwarequote ruim boven haar eigen afleiding werd gezet. De rekenstappen zelf kloppen wél: 13,3 bln × 35–45% = 4,66–5,99 bln ✓, en × 0,02–0,04% = 0,93–2,39 mrd ✓.
> Kanttekening bij de noemer: Oxford Economics' US$ 13,3 bln is uitgedrukt **in prijzen en wisselkoersen van 2017** en komt uit een prognose van vóór de bouwkosteninflatie van 2021–2023. Een reële-2017-noemer combineren met nominale software-omzet in 2025 drukt de berekende quote kunstmatig omhoog.
...
De onderbouwing van de seat-aantallen: Asta Powerproject alléén claimt **meer dan 100.000 professionals wereldwijd** ([Elecosoft, productpagina Asta Powerproject](https://elecosoft.com/us/products/asta/asta-powerproject/)), en Asta is buiten UK/DE/SE/BNL marginaal. Als P6 in de bouwsector 2–3× zo groot is als Asta, kom je op 300.000–400.000 diepe seats. Dat is de basis voor de bandbreedte.

> **ANKER WEERLEGD (zie V4).** De rekenkundige stappen in de tabel hierboven kloppen alle vier (en het totaal US$ 0,8–2,6 mrd is correct), maar het **anker deugt niet**, en daarmee schuift de hele bandbreedte:
> - De claim staat niet op de oorspronkelijk geciteerde `/features/`-pagina maar op de productpagina; letterlijk: *"Asta Powerproject supports more than 100,000 professionals worldwide."* Dat is een **bereikclaim**, geen telling van betaalde seats.
> - Toets tegen de jaarrekening: Eleco plc boekte over FY2025 **£38,8 mln** groepsomzet, waarvan de productgroep "Building Lifecycle" **£31,1 mln** — en die lijn omvat naast Asta ook Bidcon, Staircon, ShireSystem, IconSystem, Pemac en BestOutcome PM3 ([Eleco plc FY2025, noot 2](https://ir.eleco.com/regulatory/final-results-8/)). 100.000 betaalde seats tegen de gepubliceerde G-Cloud-prijs van £1.113 zou **£111 mln** zijn: circa 3× de totale groepsomzet en 3,5× de hele Building-Lifecycle-lijn. Zelfs bij een zwaar gemengd/gediscounteerd tarief van £250 per seat per jaar kom je op £25 mln aan uitsluitend Asta-omzet binnen een lijn van £31,1 mln die zeven producten dekt — onhoudbaar.
> - Realistische orde van grootte voor de **betaalde** Asta-basis: **circa 15.000–30.000 seats**. Het anker overschat de betaalde seat-basis daarmee met grofweg een factor 3–5.
> - Interne inconsistentie bovendien: de tekst leidt zelf "100k Asta + P6 op 2–3× = 300.000–400.000" af, maar de tabel hanteert een ondergrens van **250.000** — lager dan de eigen afleiding toelaat.
> **Gevolg:** methode B is geen onafhankelijke controle. De seat-aantallen en prijspunten zijn zo gekozen dat de uitkomst in de analistenbandbreedte valt; met een realistischer diepe-seat-basis (circa 100.000–200.000) landt methode B eerder op **US$ 0,4–1,2 mrd**.
...
>
> **NA VERIFICATIE BIJ TE STELLEN (V1–V5).** De puntschatting is niet houdbaar zoals onderbouwd, om drie redenen:
> 1. De enige bron die letterlijk US$ 1,9 mrd noemt (FMI, via Eleco) meet een **bredere** categorie — construction *project management* software. Voor de engere definitie die dit rapport hanteert, werkt dat cijfer als **bovengrens**, niet als middenwaarde.
> 2. Methode A levert met haar eigen parameters US$ 0,12–0,60 mrd, niet US$ 0,9–2,4 mrd (rekenfout in de softwarequote, factor 4–16).
> 3. Methode B hangt aan een vendor-bereikclaim die tegen Eleco's eigen jaarrekening niet standhoudt; met een realistische seat-basis komt zij op US$ 0,4–1,2 mrd.
> **Verdedigbare herformulering:** de wereldwijde omzet in bouwplanningssoftware *in enge zin* ligt vermoedelijk in de orde van **US$ 0,8 – 1,9 miljard in 2025**, met US$ 1,4–2,5 mrd als bovengrens zodra men bredere project-managementfunctionaliteit meetelt. Alleen de twee analistencijfers (TBRC US$ 1,44 mrd; WiseGuy US$ 2,45 mrd) zijn extern verifieerbaar; beide eigen methoden zijn dat niet en moeten als illustratie worden gelezen, niet als bevestiging.
>
...
> **Onzeker (V7).** De verhouding zelf rekent kloppend door: 1,9 / (1,9 + 30) = 6,0% en 1,9 / (1,9 + 60) = 3,1%. Maar de onderbouwing wringt: 350.000 planners × US$ 90.000 = US$ 31,5 mrd *vóór* de aangekondigde neerwaartse correctie voor lagelonenlanden, terwijl de "gecorrigeerde" uitkomst als US$ 20–35 mrd wordt gegeven — de bovengrens ligt dus bóven de ongecorrigeerde puntwaarde. Bovendien is het aantal van 350.000 planners hetzelfde onbevestigde seat-getal dat in V4 is weerlegd. De orde van grootte (software = enkele procenten van de totale planningsbestedingen) is aannemelijk en de strategische conclusie blijft overeind; het precieze bereik 3–6% niet. Wie de dienstenlaag efficiënter maakt, vangt meer waarde dan wie de licentie goedkoper maakt.
...
| S4 | ~~1,5–4%~~ → **1,2–2,9%** van de volledig belaste jaarkosten van een planner | £1.100–2.700 licentie tegen US$ 90.889 salaris + ~30% werkgeverslasten — **rekenfout gecorrigeerd (V6)** |
| S5 | Typische jaarlijkse contractwaarden per organisatietype (tabel §3.3) | Gepubliceerde tarieven × geschatte seat-aantallen — onzeker, seat-aantallen niet gevalideerd |
| S6 | ~~US$ 0,9–2,4 mrd~~ → **US$ 0,12–0,60 mrd** met de eigen parameters | Softwarequote 0,02–0,04% volgt niet uit "1 planner per US$ 30–80 mln à US$ 2.000–3.000"; die geeft 0,0025–0,010% — **factor 4–16 te hoog (V3)** |
| S7 | US$ 0,8–2,6 mrd — rekenkundig correct, **anker weerlegd** | Verankerd op Asta's ">100.000 professionals": een bereikclaim, onverenigbaar met Eleco's £38,8 mln groepsomzet — **(V4)** |
| S8 | ~~US$ 1,9 mrd puntschatting~~ → **orde US$ 0,8–1,9 mrd**, bovengrens US$ 1,4–2,5 mrd bij bredere definitie | S6 en S7 vallen weg als onafhankelijke steun; FMI's US$ 1,9 mrd geldt een bredere categorie en is een plafond — **(V1–V5)** |
| S9 | Dienstenlaag rond bouwplanning US$ 30–60 mrd/jaar — **onzeker** | ~350.000 planners (zelf onbevestigd) × gecorrigeerd loon; ongecorrigeerd al US$ 31,5 mrd — **(V7)** |
| S10 | Softwareomzet = 3–6% van de totale bestedingen — **orde van grootte houdbaar, precisie niet** | S8 / S9, beide met grote onzekerheid — **(V7)** |
| S11 | ALICE's US$ 75 mln-drempel sluit >95% van de projecten uit — **onderbouwing ongeldig** | Mordor's 44,38% betreft *software-implementaties*, niet de populatie bouwprojecten; conclusie blijft aannemelijk maar is niet met deze bron te staven — **(V11)** |
...
Adversariële fact-check, uitgevoerd 25 juli 2026. Methode: elke bewering is bij de primaire bron opgezocht (prijs-PDF's uit de UK Digital Marketplace en de SCDOT-specificatie zijn integraal uit de PDF geëxtraheerd, niet uit samenvattingen gelezen), en elke doorgerekende schatting is opnieuw uitgerekend. Oordeel per bewering: **bevestigd** / **gecorrigeerd** / **onzeker**.

### Segmentomvang en de redenering erachter

| # | Bewering | Oordeel | Bevinding | Bron |
|---|---|---|---|---|
| **V1** | Eleco citeert in FY2025 "independent research" op circa US$ 1,9 mrd — "exact de middenwaarde" | **gecorrigeerd** | De letterlijke tekst is: *"Independent research by **FMI** estimates market opportunities of approximately US $1.9bn in **construction project management software**, US $3.4bn in maintenance and facilities management, and around US $6bn in BIM software solutions."* Twee correcties: (1) het is FMI, één met naam genoemde analist, niet een anonieme derde peiling; Eleco bevestigt niets maar citeert. (2) De categorie is *construction project management software* — **breder** dan CPM-planning/4D/analytics in enge zin. Een breder gedefinieerde markt van US$ 1,9 mrd maakt dat cijfer tot **plafond** voor de engere deelmarkt, niet tot middenwaarde ervan. De retoriek "een beursgenoteerde speler die het echt moet weten" is misleidend: Eleco meet niet, het citeert. | [Eleco plc FY2025](https://ir.eleco.com/regulatory/final-results-8/) |
| **V2** | "Drie onafhankelijke analistenbronnen convergeren rond US$ 1,4–2,5 mrd" | **gecorrigeerd** | De onderliggende cijfers kloppen alle drie letterlijk (zie V12–V13), maar "onafhankelijk" en "convergeren" houden geen stand. Bron (c) meet een andere, bredere categorie (V1); de spreiding tussen (a) US$ 1,44 mrd en (b) US$ 2,45 mrd is een factor 1,7 — de volle breedte van wat twee rapporten zeggen, geen convergentie. WiseGuy is bovendien intern inconsistent: de eigen deployment-uitsplitsing 2024 (cloud 980 + on-prem 770 + hybride 602,7 = 2.352,7 mln) telt niet op tot het eigen totaal 2.307,4 mln. | [WiseGuy](https://www.wiseguyreports.com/reports/construction-scheduling-software-market); [Eleco](https://ir.eleco.com/regulatory/final-results-8/) |
| **V3** | Methode A: softwarequote 0,02–0,04% van de bouwwaarde → US$ 0,9–2,4 mrd | **gecorrigeerd (rekenfout)** | De rekenstappen kloppen (13,3 bln × 35–45% = 4,66–5,99 bln ✓; × 0,02–0,04% = 0,93–2,39 mrd ✓), maar de **quote zelf volgt niet uit de eigen onderbouwing**. "Eén planner per US$ 30–80 mln à US$ 2.000–3.000 licentie" geeft 3.000/30 mln = 0,010% tot 2.000/80 mln = 0,0025% — een factor **4 tot 16** onder de gebruikte 0,02–0,04%. Consistent doorgerekend levert methode A **US$ 0,12–0,60 mrd**, een orde van grootte onder de analisten. Methode A bevestigt de US$ 1,9 mrd dus niet; de overeenstemming was ingebouwd. | eigen herberekening |
| **V4** | Methode B, verankerd op "Asta Powerproject >100.000 professionals wereldwijd" → 250.000–400.000 diepe CPM-seats | **gecorrigeerd** | De citaatclaim bestaat — *"Asta Powerproject supports more than 100,000 professionals worldwide"* — maar staat op de productpagina, **niet** op de in het rapport geciteerde `/features/`-URL (die bevat geen enkel gebruikersaantal; URL gecorrigeerd in §2.1 en §4.3). Inhoudelijk is het een **bereikclaim, geen betaalde-seat-telling**, en die valt te weerleggen met Eleco's eigen jaarrekening: groepsomzet FY2025 £38,8 mln, productgroep "Building Lifecycle" £31,1 mln — een lijn die naast Asta óók Bidcon, Staircon, ShireSystem, IconSystem, Pemac en BestOutcome PM3 omvat. 100.000 betaalde seats à de gepubliceerde £1.113 zou £111 mln zijn: ~3× de héle groepsomzet. Realistische betaalde Asta-basis: orde **15.000–30.000 seats**; het anker overschat met circa factor 3–5. Extra interne inconsistentie: de tekst leidt zelf 300.000–400.000 af, de tabel begint bij 250.000. De vier tabelrijen en het totaal US$ 0,8–2,6 mrd zijn rekenkundig wél correct nagerekend. | [Elecosoft productpagina](https://elecosoft.com/us/products/asta/asta-powerproject/); [Eleco FY2025 noot 2](https://ir.eleco.com/regulatory/final-results-8/) |
| **V5** | Puntschatting US$ 1,9 mrd (2025), bandbreedte US$ 1,4–2,5 mrd | **gecorrigeerd** | Beide "eigen bottom-up-methoden" vallen weg als onafhankelijke steun (V3, V4) en de enige bron die letterlijk 1,9 noemt meet een bredere markt (V1). Er resteren twee verifieerbare analistencijfers met een spreiding van factor 1,7. Verdedigbaar: **orde US$ 0,8–1,9 mrd** voor de enge definitie, met US$ 1,4–2,5 mrd als bovengrens bij bredere afbakening. De strategische conclusie ("dit is een kleine markt waarin een nieuwkomer niet op volume wint", §7.9) wordt door de correctie **sterker**, niet zwakker. | eigen herberekening |
| **V6** | Licentie = 1,5–4% van de volledig belaste jaarkosten van een planner | **gecorrigeerd (rekenfout)** | Met de eigen inputs: £1.113 / £93.000 = **1,2%**; £2.640 / £93.000 = **2,8%**. Correct bereik **circa 1,2–2,9%**. Voor 4% zou een licentie van ~£3.700 (US$ 4.720) nodig zijn — hoger dan élke per-seat-prijs in het rapport (P6 EPPM £2.640 is de duurste). De kwalitatieve conclusie (software is een afrondingsfout naast de mens) staat hierdoor juist steviger. | eigen herberekening |
| **V7** | Dienstenlaag US$ 30–60 mrd/jaar; software = 3–6% van de totale bestedingen | **onzeker** | De deling klopt (1,9/31,9 = 6,0%; 1,9/61,9 = 3,1%), maar de basis wringt: 350.000 × US$ 90.000 = US$ 31,5 mrd *vóór* de aangekondigde neerwaartse loonkorting, terwijl de "gecorrigeerde" uitkomst als US$ 20–35 mrd wordt gegeven — bovengrens boven de ongecorrigeerde puntwaarde. Het aantal van 350.000 planners is bovendien hetzelfde in V4 weerlegde seat-getal. Orde van grootte aannemelijk, precisie niet. | eigen herberekening |

### "Verplichte" software en formaten

| # | Bewering | Oordeel | Bevinding | Bron |
|---|---|---|---|---|
| **V8** | SCDOT schrijft Oracle Primavera P6 en .xer dwingend voor; pay item 1080300 LS 60/40; float-eigendom bij het project; 7-daagse kalender voor uitharding/zetting; PDF 11×17 landscape | **bevestigd, met reikwijdte-correctie** | Alle citaten letterlijk teruggevonden in de FHWA-goedgekeurde spec (volledige PDF-tekstextractie): *"Maintain CPM schedules using a currently supported version of Oracle's Primavera P6"*; *"Upload each CPM schedule submission to the SCDOT Construction Extranet site in .xer format"*; *"1080300 CPM PROGRESS SCHEDULE LS"* met 60% bij acceptatie baseline en 40% bij as-built; *"The project owns the float ... Float suppression or sequestration is not allowed"*; *"Cure Periods ... use a 7-day calendar"* en idem voor *"Settlement or Surcharge Periods"*; *"PDF printouts are formatted to 11 inches x 17 inches ... Landscape"*. **Correctie op reikwijdte:** de verplichting geldt alleen voor **Level 2**; Level 1 staat expliciet *"Word, Excel, or Primavera P6 format"* toe. Het look-ahead-niveau is dus níét contractueel dichtgetimmerd — relevant voor §7.8/§7.9. Aanvullend geverifieerd en toegevoegd: duren gemaximeerd op 30 kalenderdagen, expected finish dates verboden, verplichte F9-instellingen, SVI < −0,10 na derde termijn. | [SCDOT Supplemental Specification (01-26)](https://www.scdot.org/content/dam/scdot-legacy/business/technicalpdfs/supspecs/Construction%20Schedules%20Supplemental%20Specification%20(01-26)%20FHWA%20approved.pdf) |

### Prijzen

| # | Bewering | Oordeel | Bevinding | Bron |
|---|---|---|---|---|
| **V9** | Oracle G-Cloud 14-prijstabel (§3.1): P6 EPPM £220/mnd min 25; UK Gov Cloud £439 min 50; Unifier £132 / NEC4 £180; Portal User £2 min 100; OPC Schedule £96 min 5; CIC-databron £799/mnd; non-prod £3.954/mnd; staffelkortingen 10/15/20/25% | **bevestigd, met twee aanvullingen** | Elke regel van de tabel is regel-voor-regel teruggevonden in het originele prijsblad. Ook de afgeleide instapdrempels kloppen: 25 × £220 × 12 = **£66.000** ✓ en 50 × £439 × 12 = **£263.400** ✓, evenals de NEC4-opslag 180/132 = **+36,4%** ✓. Twee correcties: (1) "volumekortingen (alle producten)" is te breed — er staat géén staffel bij de Government Cloud-diensten, de Portal User, de EVM-add-on en Team for External Collaborators. (2) Niet vermeld in het rapport maar wel prijsbepalend: Unifier vereist een **AutoVue-prerequisite** met gebruikersaantal gelijk aan Unifier (2D £12/mnd of 3D £44/mnd), waardoor de effectieve Unifier-prijs £144–176 is in plaats van £132. | [Oracle Primavera Pricing, G-Cloud 14, BD.G14.OCS.002](https://assets.applytosupply.digitalmarketplace.service.gov.uk/g-cloud-14/documents/717959/423103118187025-pricing-document-2024-05-03-0915.pdf) |
| **V10** | Elecosoft-prijzen: £1.113 SaaS/jaar; £950 2-daagse cursus; £500 1-daagse modules incl. NEC; vanaf £360/dag p.p.; professional services vanaf £1.430/dag. Asta is bij 25 seats 2,4× goedkoper dan P6 EPPM | **bevestigd, vergelijking onzeker** | Alle bedragen letterlijk teruggevonden: *"12 Month Asta Powerproject SaaS Subscription: £1,113 (payable upfront)"*, *"£950 per person"*, *"each priced at £500 per delegate"*, *"From £360 per day per person"*, *"rates starting from £1,430 per day"*. De rekensom klopt: 25 × £1.113 = £27.825 tegen £66.000 = **2,37×** ✓. Wél onzeker: het prijsblad noemt géén minimumaantal — "zonder minimumaantal" is een gevolgtrekking uit afwezigheid, geen expliciete toezegging. En de vergelijking is niet like-for-like: een SaaS-abonnement per gebruiker tegenover een enterprise-cloudplatform inclusief hosting. | [Elecosoft G-Cloud 14 pricing](https://assets.applytosupply.digitalmarketplace.service.gov.uk/g-cloud-14/documents/93278/159955281882828-pricing-document-2024-05-07-1230.pdf) |
| **V11** | ALICE: minimaal US$ 75 mln bouwwaarde; tot 17%/14%/12% besparing; geen publieke prijs; onbeperkte gebruikers — en dat sluit >95% van de projecten uit | **bevestigd / onderbouwing gecorrigeerd** | Vendorclaims letterlijk bevestigd: *"They generally use ALICE on projects with a construction value of at least $75M"*, *"Up to a 17% reduction in construction duration"*, 14% arbeid, 12% materieel, unlimited users/data, geen publieke prijs. De afgeleide claim ">95% van de projecten uitgesloten" is echter **niet met de aangevoerde bron te staven**: Mordor's 44,38% betreft het aandeel *software-implementaties* in de klasse US$ 50–500 mln, niet de verdeling van alle bouwprojecten. De conclusie is op zichzelf hoogst aannemelijk (naar aantal is de overgrote meerderheid van bouwprojecten ver onder US$ 75 mln), maar blijft **onzeker** zolang een projectgrootteverdeling ontbreekt. | [ALICE pricing](https://www.alicetechnologies.com/pricing) |
| **V12** | ScheduleReader vanaf US$ 344/jaar; MS Project Professional 2024 US$ 1.129,99 en Standard 2024 US$ 679,99; Plan 1/3/5-prijzen [ONBEVESTIGD] | **bevestigd** | ScheduleReader Standard en Mac staan beide op **$344/year**, PRO op $440/year. Microsoft noemt op de vergelijkingspagina inderdaad alleen *"$679.99 one-time purchase"* (Standard 2024) en *"$1,129.99 one-time purchase"* (Professional 2024); Plan 1/3/5-maandprijzen staan er niet — de [ONBEVESTIGD]-markering in §3.1 is dus terecht en zorgvuldig. | [ScheduleReader pricing](https://schedulereader.com/pricing/); [Microsoft](https://www.microsoft.com/en-us/microsoft-365/project/compare-microsoft-project-management-software) |

### Marktleiderschap en marktcontext

| # | Bewering | Oordeel | Bevinding | Bron |
|---|---|---|---|---|
| **V13** | Mordor: top-5 (Oracle, Autodesk, Procore, Trimble, Bentley) ≈ 45% van de omzet 2025; PM&S 40,91%; GC's 46,72%; cloud 63,83%; APAC 9,43% CAGR; US$ 50–500 mln = 44,38%; markt US$ 11,58 mrd (2026) → 17,81 mrd (2031) @ 8,99% | **bevestigd** | Alle zeven cijfers letterlijk bevestigd bij Mordor. De CAGR is intern consistent: 11,58 × 1,0899⁵ = 17,81 ✓. **Maar** de toegevoegde zin "voor het smallere scheduling-segment ligt de concentratie hoger" is een eigen gevolgtrekking waar Mordor niets over zegt; nu als [SCHATTING] gemarkeerd in §2.3. | [Mordor Intelligence](https://www.mordorintelligence.com/industry-reports/construction-management-software-market) |
| **V14** | TBRC/Research and Markets: US$ 1,31 mrd (2024) → 1,44 mrd (2025), 10,1%; 2,09 mrd (2029), 9,8% | **bevestigd** | Alle vijf waarden letterlijk bevestigd. Let op de definitiebreedte: de scope omvat naast planning ook resource- en risicomanagement en alle organisatiegroottes — dus ruimer dan "diepe CPM". | [GlobeNewswire / Research and Markets](https://www.globenewswire.com/news-release/2025/10/22/3170911/28124/en/Construction-Schedule-Software-Market-Report-2025-Digital-Tools-Drive-Rapid-Growth-Reaching-US-2-09-Billion-by-2029.html) |
| **V15** | Fortune Business Insights: US$ 10,76 mrd (2025) → 11,78 mrd (2026) → 24,72 mrd (2034) @ 9,70%; PM&S US$ 3,43 mrd (2024); Builders & Contractors US$ 4,88 mrd (2024); NA 42,5% / EU 25,4% / APAC 14,0% / MEA 12,3% / LatAm 5,7% | **bevestigd, jaarlabel onzeker** | Alle waarden bevestigd, en de groeipaden zijn intern consistent (10,76 × 1,097⁹ = 24,72 ✓; 11,78 × 1,097⁸ = 24,72 ✓). Eén onzekerheid: Fortune labelt US$ 10,76 mrd op sommige plaatsen als **basisjaar 2024**, terwijl het groeipad naar 11,78 mrd in 2026 wijst op 2025. Materieel verandert er weinig, maar het jaarlabel is niet hard. | [Fortune Business Insights](https://www.fortunebusinessinsights.com/construction-software-market-110155) |
| **V16** | Oxford Economics: wereldwijde bouwproductie US$ 10,7 bln (2020) → 13,3 bln (2025) → 15,2 bln (2030); +42% / US$ 4,5 bln; 3,6% per jaar | **bevestigd, met methodologische kanttekening** | Letterlijk bevestigd, inclusief de 2025-waarde: *"global construction output is expected to reach US$13.3 trillion by 2025 – adding US$2.6 trillion to output in the five years from 2020"*. **Kanttekening die in het rapport ontbrak:** de reeks is uitgedrukt *"in 2017 prices and exchange rates"* en komt uit een prognose van vóór de bouwkosteninflatie 2021–2023. Een reële-2017-noemer combineren met nominale software-omzet 2025 (methode A) vertekent de berekende softwarequote systematisch omhoog. | [Oxford Economics / Marsh McLennan](https://www.oxfordeconomics.com/resource/future-of-construction/) |
| **V17** | Eleco's geografische omzetverdeling FY2025: UK £18,4 mln (47%), overig Europa £7,7 mln (20%), Scandinavië £6,9 mln (18%), Duitsland £3,3 mln (8%), VS £1,5 mln (4%), totaal £38,8 mln — "de VS-positie is verwaarloosbaar" | **bevestigd** | Noot 2 van de jaarrekening geeft exact: UK 18.389; Scandinavië 6.867; Duitsland 3.296; VS 1.480; Rest of Europe 7.650; Rest of World 1.134; totaal 38.816 (£'000). Kleine omissie in het rapport: **Rest of World £1,134 mln (2,9%)** ontbreekt, waardoor de opgesomde aandelen op 97% uitkomen. De VS-omzet daalde bovendien jaar-op-jaar (2024: £1,642 mln) — dat versterkt de conclusie in §6.3. | [Eleco plc FY2025, noot 2](https://ir.eleco.com/regulatory/final-results-8/) |
| **V18** | "P6-prijzen bewegen al jaren nauwelijks" (§1.5, §4.4) | **onzeker** | Niet te verifiëren: er is geen prijstijdreeks opgehaald. Er is alleen één momentopname (G-Cloud 14, mei 2024). De bewering is plausibel maar draagt in §4.4 wél gewicht in het groeiverhaal; behandel als vermoeden. | — |

### Beperkingen van deze verificatie

- Het WebSearch-budget van de sessie was uitgeput; alle controles zijn uitgevoerd met directe ophaling van de primaire bron-URL's. Beweringen waarvoor geen primaire URL beschikbaar was (de reeds als **[ONBEVESTIGD]** gemarkeerde constructionbids.ai-prijzen, de Eastwood Harris-productvergelijkingen, de Capterra/Software Advice-reviewscores, de OpenSpace-vertragingsstatistiek en de DCMA-14-drempelwaarden) zijn **niet** opnieuw getoetst en behouden hun bestaande markering.
- De prijsbladen (Oracle, Elecosoft) en de SCDOT-spec zijn integraal uit de PDF geëxtraheerd; die controles zijn regel-voor-regel en dus het hardst.
- Analistenrapporten (TBRC, WiseGuy, Fortune, Mordor) zijn geverifieerd op **juiste weergave**, niet op **juistheid**. Dat een cijfer correct is overgenomen zegt niets over de deugdelijkheid van de onderliggende methodologie — bij WiseGuy is die methodologie niet openbaar en telt de eigen segmentuitsplitsing niet op (V2).
- Netto-oordeel: het rapport is sterk waar het op primaire documenten steunt (prijzen, contracteisen) en zwak waar het eigen schattingen tot bevestiging promoveert. De hoofdcorrectie zit in §4: de puntschatting van US$ 1,9 mrd was geen convergentie van vijf onafhankelijke methoden maar van twee analistencijfers plus twee schattingen die naar dat antwoord toe waren geparametriseerd.
