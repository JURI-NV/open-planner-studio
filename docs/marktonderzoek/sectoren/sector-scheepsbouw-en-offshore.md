...
1. **Dit is de meest planning-intensieve maakindustrie ter wereld.** Eén cruiseschip bij Meyer Turku telt circa **50.000 planningsactiviteiten** en wordt door **150–200 mensen** dagelijks bijgewerkt, met ~4.000 eigen medewerkers plus ~4.000 onderaannemers op de werf ([Safran case study Meyer Turku](https://www.safran.com/case-studies/meyer-turku)). Dat is een orde van grootte boven een typisch bouwproject.
...
5. **Segmentomvang (SCHATTING, 2025): USD 200–280 miljoen per jaar aan planningssoftware-licenties, en USD 450–650 miljoen inclusief implementatie, integratie, training en project-controls-consultancy.** Redenering in hoofdstuk 5.
...
|---|---|---|
| Activiteiten per cruiseschip-project | ~50.000 | [Safran / Meyer Turku](https://www.safran.com/case-studies/meyer-turku) |
...
| # | Pakket | Rol | Bewijs |
|---|---|---|---|
| 1 | **SAP (ERP + PS/S4HANA)** | Financiële ruggengraat en projectkostenstructuur; **Meyer Group gebruikt SAP S/4 als strategisch projectplatform**, met Safran ernaast voor de eigenlijke planning | [Safran/Meyer](https://www.safran.com/case-studies/meyer-turku) (via zoeksnippet die SAP S/4 noemt); SAP staat bovenaan bij [Floorganise ERP-lijst](https://www.floorganise.com/knowledgebase/technology-knowledgebase/planning-tools-and-software/) |
...
| Actieve werven wereldwijd | ~180 (sept 2024), +17,7% t.o.v. 153 (juni 2022) | Statista via zoeksnippet, zie §10 |
...
- ~180 grote actieve nieuwbouwwerven (Statista) + naval yards + grote reparatie-/conversiewerven → **~400 organisaties wereldwijd die commerciële planningssoftware licentiëren**.
...
De bottom-up ($150–280 mln) en top-down ($150–375 mln) banden overlappen, wat de schatting van **~$200 miljoen software / ~$500 miljoen inclusief diensten** ondersteunt. **Beide zijn eigen schattingen; er is geen analistenrapport gevonden dat "planningssoftware voor scheepsbouw en offshore" als apart segment kwantificeert.**

Voegt men de bredere werf-ERP/MES/digital-shipyard-markt toe ($1,8–2,1 mrd in 2025), dan zit de planningsfunctionaliteit daar deels in verstopt; de bovengrens van "alles wat met werfplanning te maken heeft" ligt dan richting **$0,8–1,0 mrd**.
...
- Arbeidstekort (skilled maritime workers: **15% wereldwijd tekort**, vooral in Europese werven; zoeksnippet) maakt resource-optimalisatie economisch dwingender.

**Negatief / vlak:**
- Offshore olie/gas-EPC groeit nauwelijks: **+1% in 2025** ([Westwood](https://www.westwoodenergy.com/news/westwood-insight-offshore-epc-contracting-activity-to-remain-buoyant-in-2025)).
...
- Verplicht bij Amerikaanse defensiecontracten vanaf **$20 miljoen**; formele compliance-review vanaf **$100 miljoen** (verhoogd van $50M door DoD Class Deviation 2015-O0017, DFARS 234.201(1)(ii)).
...
### SAP (ERP + PS / S/4HANA)
**Voordelen hier:** de financiële en materiaalruggengraat; koppelt inkoop, voorraad, uren en kosten aan projectstructuren; onmisbaar voor kostenzijde van EVM. Meyer Group gebruikt **SAP S/4 als strategisch projectplatform** ([Safran/Meyer](https://www.safran.com/case-studies/meyer-turku)); SAP staat bovenaan in de ERP-lijst voor werven ([Floorganise](https://www.floorganise.com/knowledgebase/technology-knowledgebase/planning-tools-and-software/)).
**Nadelen hier:** SAP PS is geen serieuze CPM-engine — geen volwaardige nivellering, geen risico-simulatie, geen forensisch schema-instrumentarium. Vandaar dat Meyer SAP én Safran draait. Dubbele waarheid en synchronisatieproblemen zijn het gevolg.
...
- Aantal actieve werven wereldwijd (~180, sept 2024; 153 in juni 2022) — Statista, via DuckDuckGo-snippet.
- Werkgelegenheid scheepsbouw (~1,1 mln in 2022, ~70% Azië; ~1,2 mln nu; 15% tekort aan geschoolde maritieme arbeidskrachten) — WorldMetrics / Ship Universe, via snippet.
...
- Meyer Group gebruikt SAP S/4 als strategisch projectplatform — via snippet van de Safran/Meyer-pagina.
- DFARS-drempels ($20M EVMS-conformiteit, $100M compliance review na Class Deviation 2015-O0017) en SUPSHIP-rol — DoD/DFARS-documenten, via snippet.
