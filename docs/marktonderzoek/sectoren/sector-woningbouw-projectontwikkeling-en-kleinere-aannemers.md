...
3. **Betalingsbereidheid is laag in absolute zin, maar niet nul.** De hele suite kost $588–$6.108 per jaar (zie §3). Toegerekend naar het planningsdeel is dat grofweg $150–$1.500 per bedrijf per jaar. Vergelijk: één Primavera P6-seat kost $2.750 eenmalig ([Software Connect](https://www.softwareconnect.com/roundups/best-construction-scheduling-software/)).
...
| **10** | **Gratis/open source: ProjectLibre, GanttProject, OpenProject** | Reële aanwezigheid bij prijsgevoelige gebruikers | ProjectLibre: "8.2 M+ users", "Over 8.200.000 downloads", 193 landen, 20.000+ bedrijven ([ProjectLibre](https://www.projectlibre.com/)); GanttProject: GPL3, MS Project import/export, CSV/Excel/PDF/PNG-export, resources en kosten ([GanttProject](https://www.ganttproject.biz/)) |
| **11** | **Oracle Primavera P6** | Vrijwel afwezig. Alleen waar een woningbouwer ook infra/utiliteit doet, of bij een grote ontwikkelaar met een corporate standaard | $2.750 per gebruiker (perpetual) — "Enterprise-level scheduling" ([Software Connect](https://www.softwareconnect.com/roundups/best-construction-scheduling-software/)) |
...
| **Oracle Primavera P6** | $2.750 per gebruiker (perpetual) | — | — | Enterprise-CPM; buiten bereik van dit segment | [Software Connect](https://www.softwareconnect.com/roundups/best-construction-scheduling-software/) |
...
De verborgen kosten zijn 2–3× de licentiekosten. Dat is waarom "gratis" of "goedkoop" alléén niet wint in dit segment: *tijd tot eerste waarde* is de echte valuta.
...
| Bouwplanningssoftware (scheduling) specifiek, wereldwijd | **USD 3,12 mrd** | 2025 | → **USD 6,78 mrd (2034)**, CAGR **9,25%** (2026–2034) | [Verified Market Reports](https://www.verifiedmarketreports.com/product/construction-scheduling-software-market/) |
...
|---|---|---|---|
| **VS** | **> 919.000 vestigingen**; ~8,0 mln werknemers | Q1 2023 | [AGC](https://www.agc.org/learn/construction-data) |
...
- **VS:** 919.000 vestigingen ([AGC](https://www.agc.org/learn/construction-data)). Vestigingen ≠ bedrijven, en een deel is eenmanszaak. Aanname: ~65% is een bedrijf met personeel → ~600.000. Daarvan woningbouw-/kleinbouw-gerelateerd (residential building + residential specialty trades + kleine GC's): aanname 65% → **~390.000**.
- **EU:** schaal Nederland (17,9 mln inwoners → 36.145 bedrijven met personeel) naar de EU (~449 mln inwoners) = 36.145 × 25,1 ≈ 907.000. Corrigeer neerwaarts voor lagere bedrijfsdichtheid in Zuid- en Oost-Europa: **~700.000**. Daarvan woningbouw-gerelateerd 65% → **~455.000**.
- **VK, Canada, Australië/NZ, Japan, Zuid-Korea samen:** **~250.000** (schatting op basis van bevolkings- en bouwvolume-verhouding tot de VS).
- **Totaal adresseerbaar:** **~1.095.000 bedrijven** wereldwijd in koopkrachtige markten.
...
**De drie routes convergeren.** Ik houd aan:

> ### 🔹 Segmentomvang planningssoftware voor woningbouw, projectontwikkeling en kleinere aannemers
> **USD 200 – 280 miljoen per jaar (2026), middenschatting ≈ USD 235 miljoen.** **[SCHATTING]**
>
...
| **Verplichte leverformaten XER / P6 XML** | **Nul** | Er is in dit segment geen enkele opdrachtgever die een .xer-bestand eist. De de-facto uitwisselformaten zijn **PDF** (de geprinte balkplanning), **Excel/CSV**, en soms **.mpp / MS Project XML**. GanttProject's ondersteuning van "Microsoft Project format (import/export), CSV and Excel exports, PDF and PNG exports" ([GanttProject](https://www.ganttproject.biz/)) dekt exact wat dit segment nodig heeft. |
