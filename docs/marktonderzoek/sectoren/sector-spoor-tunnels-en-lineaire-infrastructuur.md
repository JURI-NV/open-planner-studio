...
4. **De marktleider in die niche verdwijnt.** Trimble TILOS gaat per **1 maart 2026** in End of Maintenance; **11.1 MR4** is de laatste release ([BuildingPoint aankondiging](https://help.buildingpoint.com.au/hc/en-au/articles/55527556493849--Important-Announcement-Tilos-Entering-End-of-Maintenance-on-1-March-2026)). Dat maakt een geïnstalleerde basis dakloos, precies op het moment dat IFC 4.3 (ISO 16739-1:2024) rail-alignment standaardiseert.
...
6. **Segmentomvang [SCHATTING]:** ca. **USD/EUR 200–300 miljoen per jaar** (2026) voor planningssoftware + direct gekoppelde diensten in deze sector; daarvan is de *specialistische lineaire/time-chainage-nichesoftware zelf* slechts ca. **USD 8–15 miljoen per jaar**. Groeirichting: onderliggende bouwmarkt +6–10% CAGR, nichesoftware consolideert/krimpt.
...
- USACE: de master guide specification **UFGS 01 32 01.00 10 Project Schedule** regelt P6-instellingen en native-bestandsuitwisseling; aannemers moeten "request a backup file template (.xer) from the Government" en activity codes op projectniveau houden ([USACE MGS 013201 (PDF)](https://www.usace.army.mil/Portals/44/docs/Engineering/MasterGuideSpecs/013201.pdf); [WBDG UFGS 01 32 01.00 10](https://www.wbdg.org/dod/ufgs/ufgs-01-32-01-00-10)).
...
|---|---|---|---|
| **Primavera P6 Professional** | ca. **USD 3.520** | Perpetueel, per gebruiker | [ProjectManagerTemplate](https://www.projectmanagertemplate.com/post/primavera-p6-cost-understanding-license-vs-subscription-models) |
| **Primavera P6 EPPM** | ca. **USD 2.750** basislicentie + ca. **USD 605/jaar** support | Perpetueel + onderhoud | idem |
| **P6 EPPM Cloud Service (UK G-Cloud 14)** | **GBP 220 per hosted named user per maand**, **minimaal 25 gebruikers** | Abonnement | [Oracle prijsdocument, UK Digital Marketplace (PDF)](https://assets.applytosupply.digitalmarketplace.service.gov.uk/g-cloud-14/documents/717959/423103118187025-pricing-document-2024-05-03-0915.pdf) |
...
*Kruiscontrole:* HS2 kost bruto ca. GBP 4–4,5 mld per jaar (GBP 87,7–102,7 mld gespreid over de resterende looptijd, [NAO](https://www.nao.org.uk/wp-content/uploads/2026/06/high-speed-two-reset-summary.pdf)). Met een plausibele dichtheid van één planner per GBP 8–15 mln jaaromzet in de hele keten geeft dat orde 300–550 planners voor één programma. Bij ca. USD 200 mld gecombineerde jaaromzet in spoor + tunnels (na correctie voor overlap) levert dezelfde dichtheid ca. 10.000–20.000 planners — dezelfde orde van grootte. Ik houd de conservatieve 10.000 aan.
...
10.000 × USD 4.000 = **USD 40 mln per jaar**; bandbreedte **USD 30–70 mln**.
...
- Direct gekoppelde implementatie-, configuratie- en trainingsdiensten: factor **0,5–1,5×**;
- 4D-/AI-laag (SYNCHRO, ALICE, Nodes & Links, Aphex) die in deze sector snel groeit.
→ **USD/EUR 200–300 mln per jaar (2026)**, met een plausibele bandbreedte van **USD 150–400 mln**.
...
→ **Totaal specialistische tijd-weg-tools: USD 8–15 mln per jaar.**
...
Mondiale bouwplanningssoftware: **USD 1,44 mld (2025)** ([TBRC](https://www.thebusinessresearchcompany.com/report/construction-schedule-software-global-market-report)). Spoor/tunnels/lineaire infra is misschien 8–12% van de mondiale bouwproductie, maar bovengemiddeld planner-dicht en licentie-duur (enterprise-P6 in plaats van MS Project). Een aandeel van **12–20%** geeft **USD 175–290 mln** — consistent met de bottom-up USD 200–300 mln. ✅
...
- TILOS uit onderhoud per 1 maart 2026 ([BuildingPoint](https://help.buildingpoint.com.au/hc/en-au/articles/55527556493849--Important-Announcement-Tilos-Entering-End-of-Maintenance-on-1-March-2026));
...
**Netto verwachting [SCHATTING]:** het brede segment groeit met de markt mee (7–10% per jaar), het smalle "tijd-weg-tool"-segment krimpt in aantal aanbieders en gemiddelde prijs terwijl het aantal *gebruikers* stijgt — klassieke commoditisering, met een vacuüm in het premiumsegment door het wegvallen van TILOS.
...
|---|---|---|
| **XER** (Primavera-native backup) | De facto contractueel leveringsformaat | USACE: aannemer vraagt een `.xer`-backuptemplate op bij de opdrachtgever; activity codes moeten op projectniveau staan, niet globaal ([UFGS 01 32 01.00 10 / USACE MGS 013201](https://www.usace.army.mil/Portals/44/docs/Engineering/MasterGuideSpecs/013201.pdf)) |
...
- **EIA-748** is de EVMS-standaard; recente revisie E bracht het aantal richtlijnen terug van 32 naar 27 (via zoekresultaten samengevat; kernbron: [Humphreys & Associates over DOE Guide 413.3-10B](https://www.humphreys-assoc.com/doe-guide-413-3-10b-evms/)).
...
**Nadelen hier**
- **End of Maintenance 1 maart 2026** — het fundamentele nadeel; het product heeft geen toekomst ([BuildingPoint](https://help.buildingpoint.com.au/hc/en-au/articles/55527556493849--Important-Announcement-Tilos-Entering-End-of-Maintenance-on-1-March-2026)).
...
Per **1 maart 2026** gaat de enige volwaardige lineaire planner uit onderhoud ([BuildingPoint](https://help.buildingpoint.com.au/hc/en-au/articles/55527556493849--Important-Announcement-Tilos-Entering-End-of-Maintenance-on-1-March-2026)). De alternatievenmarkt bestaat op dit moment uit:
...
**Er is geen open, onderhouden, volwaardige lineaire planner met eigen CPM-engine.** Dat is een structurele opening, en de klok tikt: bestaande TILOS-projecten met een looptijd tot 2035+ (BBT, Rail Baltica, HS2-scopes) zitten straks op een bevroren product.
...
1. **De contractuele moat van P6 is echt.** Zonder betrouwbare XER-import/-export en P6 XML is een alternatieve planner niet indienbaar. Dat is geen "nice to have", het is de toegangsvoorwaarde. USACE eist zelfs specifieke instellingen en codeniveaus ([UFGS 01 32 01.00 10](https://www.wbdg.org/dod/ufgs/ufgs-01-32-01-00-10)).
2. **De niche is klein in geld.** USD 8–15 mln/jaar aan specialistische lineaire tools **[SCHATTING]** betekent dat een commercieel product hier nooit groot wordt. Voor een open-sourceproject is dat juist het argument: er is geen leverancier die het gat rendabel kan dichten, maar de behoefte is reëel en de gebruikersgroep prestigieus.
