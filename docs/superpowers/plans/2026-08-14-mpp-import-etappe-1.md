...
- [ ] **Stap 4: i18n.** Voeg in `src/i18n/locales/<taal>/common.json` onder `notifications` twee sleutels toe, in **alle 14** talen (`nl, en, fr, de, es, zh, it, pt, pl, tr, ar, ja, ko, fa` — `verify:i18n` eist compleetheid t.o.v. nl). nl:
