...
function getThemeColors() {
  ...
  return {
    bg: v('--theme-bg', '#2A2A32'),
    surface: v('--theme-surface-alt', '#36363E'),
    grid: v('--theme-surface-elevated', '#3E3E48'),
    gridWeekend: v('--theme-input-bg', '#252530'),
    border: v('--theme-border', '#4A4A56'),
    text: v('--theme-text', '#FAFAF9'),
    textSecondary: v('--theme-text-dim', '#A1A1AA'),
    critical: '#DC2626',
    ...
    dependency: '#6B7280',
    today: '#F59E0B',
    headerBg: v('--theme-surface-alt', '#36363E'),
    summary: '#8B5CF6',
  };
}
